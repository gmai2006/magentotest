...
public interface CatalogCategoryProductIndexReplicaService {
  public CatalogCategoryProductIndexReplica find(CatalogCategoryProductIndexReplicaId id);
  /**
   * Select a list of CatalogCategoryProductIndexReplica based on a given maximum number of
   * returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogCategoryProductIndexReplica records.
   */
  public List<CatalogCategoryProductIndexReplica> select(int maxResult);

  /**
   * Select all CatalogCategoryProductIndexReplica.
   *
   * @return all CatalogCategoryProductIndexReplica records.
   */
  public List<CatalogCategoryProductIndexReplica> selectAll();

  /**
   * Create CatalogCategoryProductIndexReplica.
   *
   * @param bean The CatalogCategoryProductIndexReplica.
  ...
  /**
   * Update a CatalogCategoryProductIndexReplica.
   *
   * @param bean - The CatalogCategoryProductIndexReplica.
