...
public interface EavFormFieldsetLabelService {
  public EavFormFieldsetLabel find(EavFormFieldsetLabelId id);
  /**
   * Select a list of EavFormFieldsetLabel based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EavFormFieldsetLabel records.
   */
  public List<EavFormFieldsetLabel> select(int maxResult);

  /**
   * Select all EavFormFieldsetLabel.
   *
   * @return all EavFormFieldsetLabel records.
   */
  public List<EavFormFieldsetLabel> selectAll();

  /**
   * Create EavFormFieldsetLabel.
   *
   * @param bean The EavFormFieldsetLabel.
   * @return The EavFormFieldsetLabel.
   */
  public EavFormFieldsetLabel create(EavFormFieldsetLabel bean);

  /**
   * Update a EavFormFieldsetLabel.
   *
   * @param bean - The EavFormFieldsetLabel.
