...
public interface CatalogProductIndexPriceOptIdxService {
  public CatalogProductIndexPriceOptIdx find(CatalogProductIndexPriceOptIdxId id);
  /**
   * Select a list of CatalogProductIndexPriceOptIdx based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductIndexPriceOptIdx records.
   */
  public List<CatalogProductIndexPriceOptIdx> select(int maxResult);

  /**
   * Select all CatalogProductIndexPriceOptIdx.
   *
   * @return all CatalogProductIndexPriceOptIdx records.
   */
  public List<CatalogProductIndexPriceOptIdx> selectAll();

  /**
   * Create CatalogProductIndexPriceOptIdx.
   *
   * @param bean The CatalogProductIndexPriceOptIdx.
  ...
  /**
   * Update a CatalogProductIndexPriceOptIdx.
   *
   * @param bean - The CatalogProductIndexPriceOptIdx.
