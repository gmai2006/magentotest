...
public interface CustomerAddressEntityVarcharService {
  public CustomerAddressEntityVarchar find(CustomerAddressEntityVarcharId id);
  /**
   * Select a list of CustomerAddressEntityVarchar based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CustomerAddressEntityVarchar records.
   */
  public List<CustomerAddressEntityVarchar> select(int maxResult);

  /**
   * Select all CustomerAddressEntityVarchar.
   *
   * @return all CustomerAddressEntityVarchar records.
   */
  public List<CustomerAddressEntityVarchar> selectAll();

  /**
   * Create CustomerAddressEntityVarchar.
   *
   * @param bean The CustomerAddressEntityVarchar.
   * @return The CustomerAddressEntityVarchar.
   */
  public CustomerAddressEntityVarchar create(CustomerAddressEntityVarchar bean);

  /**
   * Update a CustomerAddressEntityVarchar.
   *
   * @param bean - The CustomerAddressEntityVarchar.
