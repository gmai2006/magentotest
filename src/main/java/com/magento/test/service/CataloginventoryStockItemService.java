...
public interface CataloginventoryStockItemService {
  public CataloginventoryStockItem find(CataloginventoryStockItemId id);
  /**
   * Select a list of CataloginventoryStockItem based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CataloginventoryStockItem records.
   */
  public List<CataloginventoryStockItem> select(int maxResult);

  /**
   * Select all CataloginventoryStockItem.
   *
   * @return all CataloginventoryStockItem records.
   */
  public List<CataloginventoryStockItem> selectAll();

  /**
   * Create CataloginventoryStockItem.
   *
   * @param bean The CataloginventoryStockItem.
   * @return The CataloginventoryStockItem.
   */
  public CataloginventoryStockItem create(CataloginventoryStockItem bean);

  /**
   * Update a CataloginventoryStockItem.
   *
   * @param bean - The CataloginventoryStockItem.
