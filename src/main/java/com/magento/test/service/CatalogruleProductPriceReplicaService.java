...
public interface CatalogruleProductPriceReplicaService {
  public CatalogruleProductPriceReplica find(CatalogruleProductPriceReplicaId id);
  /**
   * Select a list of CatalogruleProductPriceReplica based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogruleProductPriceReplica records.
   */
  public List<CatalogruleProductPriceReplica> select(int maxResult);

  /**
   * Select all CatalogruleProductPriceReplica.
   *
   * @return all CatalogruleProductPriceReplica records.
   */
  public List<CatalogruleProductPriceReplica> selectAll();

  /**
   * Create CatalogruleProductPriceReplica.
   *
   * @param bean The CatalogruleProductPriceReplica.
  ...
  /**
   * Update a CatalogruleProductPriceReplica.
   *
   * @param bean - The CatalogruleProductPriceReplica.
