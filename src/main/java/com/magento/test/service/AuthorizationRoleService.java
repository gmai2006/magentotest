...
public interface AuthorizationRoleService {
  ...
  /**
   * Select a list of AuthorizationRole based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return AuthorizationRole records.
   */
  public List<AuthorizationRole> select(int maxResult);

  /**
   * Select all AuthorizationRole.
   *
   * @return all AuthorizationRole records.
   */
  public List<AuthorizationRole> selectAll();

  /**
   * Create AuthorizationRole.
   *
   * @param bean The AuthorizationRole.
   * @return The AuthorizationRole.
   */
  public AuthorizationRole create(AuthorizationRole bean);

  /**
   * Update a AuthorizationRole.
   *
   * @param bean - The AuthorizationRole.
