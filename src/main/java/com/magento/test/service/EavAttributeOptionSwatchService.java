...
public interface EavAttributeOptionSwatchService {
  public EavAttributeOptionSwatch find(EavAttributeOptionSwatchId id);
  /**
   * Select a list of EavAttributeOptionSwatch based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EavAttributeOptionSwatch records.
   */
  public List<EavAttributeOptionSwatch> select(int maxResult);

  /**
   * Select all EavAttributeOptionSwatch.
   *
   * @return all EavAttributeOptionSwatch records.
   */
  public List<EavAttributeOptionSwatch> selectAll();

  /**
   * Create EavAttributeOptionSwatch.
   *
   * @param bean The EavAttributeOptionSwatch.
   * @return The EavAttributeOptionSwatch.
   */
  public EavAttributeOptionSwatch create(EavAttributeOptionSwatch bean);

  /**
   * Update a EavAttributeOptionSwatch.
   *
   * @param bean - The EavAttributeOptionSwatch.
