...
public interface EmailAutomationService {
  ...
  /**
   * Select a list of EmailAutomation based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EmailAutomation records.
   */
  public List<EmailAutomation> select(int maxResult);

  /**
   * Select all EmailAutomation.
   *
   * @return all EmailAutomation records.
   */
  public List<EmailAutomation> selectAll();

  /**
   * Create EmailAutomation.
   *
   * @param bean The EmailAutomation.
   * @return The EmailAutomation.
   */
  public EmailAutomation create(EmailAutomation bean);

  /**
   * Update a EmailAutomation.
   *
   * @param bean - The EmailAutomation.
