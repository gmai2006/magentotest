...
public interface GoogleoptimizerCodeService {
  public GoogleoptimizerCode find(GoogleoptimizerCodeId id);
  /**
   * Select a list of GoogleoptimizerCode based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return GoogleoptimizerCode records.
   */
  public List<GoogleoptimizerCode> select(int maxResult);

  /**
   * Select all GoogleoptimizerCode.
   *
   * @return all GoogleoptimizerCode records.
   */
  public List<GoogleoptimizerCode> selectAll();

  /**
   * Create GoogleoptimizerCode.
   *
   * @param bean The GoogleoptimizerCode.
   * @return The GoogleoptimizerCode.
   */
  public GoogleoptimizerCode create(GoogleoptimizerCode bean);

  /**
   * Update a GoogleoptimizerCode.
   *
   * @param bean - The GoogleoptimizerCode.
