...
public interface CoreConfigDataService {
  ...
  /**
   * Select a list of CoreConfigData based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CoreConfigData records.
   */
  public List<CoreConfigData> select(int maxResult);

  /**
   * Select all CoreConfigData.
   *
   * @return all CoreConfigData records.
   */
  public List<CoreConfigData> selectAll();

  /**
   * Create CoreConfigData.
   *
   * @param bean The CoreConfigData.
   * @return The CoreConfigData.
   */
  public CoreConfigData create(CoreConfigData bean);

  /**
   * Update a CoreConfigData.
   *
   * @param bean - The CoreConfigData.
