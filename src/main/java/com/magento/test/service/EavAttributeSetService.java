...
public interface EavAttributeSetService {
  public EavAttributeSet find(EavAttributeSetId id);
  /**
   * Select a list of EavAttributeSet based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EavAttributeSet records.
   */
  public List<EavAttributeSet> select(int maxResult);

  /**
   * Select all EavAttributeSet.
   *
   * @return all EavAttributeSet records.
   */
  public List<EavAttributeSet> selectAll();

  /**
   * Create EavAttributeSet.
   *
   * @param bean The EavAttributeSet.
   * @return The EavAttributeSet.
   */
  public EavAttributeSet create(EavAttributeSet bean);

  /**
   * Update a EavAttributeSet.
   *
   * @param bean - The EavAttributeSet.
