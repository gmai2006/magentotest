...
public interface WishlistItemOptionService {
  public WishlistItemOption find(java.lang.Integer id);

  /**
   * Select a list of WishlistItemOption based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return WishlistItemOption records.
   */
  public List<WishlistItemOption> select(int maxResult);

  /**
   * Select all WishlistItemOption.
   *
   * @return all WishlistItemOption records.
   */
  public List<WishlistItemOption> selectAll();

  /**
   * Create WishlistItemOption.
   *
   * @param bean The WishlistItemOption.
   * @return The WishlistItemOption.
   */
  public WishlistItemOption create(WishlistItemOption bean);

  /**
   * Update a WishlistItemOption.
   *
   * @param bean - The WishlistItemOption.
