...
public interface DownloadableSampleTitleService {
  public DownloadableSampleTitle find(DownloadableSampleTitleId id);
  /**
   * Select a list of DownloadableSampleTitle based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return DownloadableSampleTitle records.
   */
  public List<DownloadableSampleTitle> select(int maxResult);

  /**
   * Select all DownloadableSampleTitle.
   *
   * @return all DownloadableSampleTitle records.
   */
  public List<DownloadableSampleTitle> selectAll();

  /**
   * Create DownloadableSampleTitle.
   *
   * @param bean The DownloadableSampleTitle.
   * @return The DownloadableSampleTitle.
   */
  public DownloadableSampleTitle create(DownloadableSampleTitle bean);

  /**
   * Update a DownloadableSampleTitle.
   *
   * @param bean - The DownloadableSampleTitle.
