...
public interface ThemeFileService {
  ...
  /**
   * Select a list of ThemeFile based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return ThemeFile records.
   */
  public List<ThemeFile> select(int maxResult);

  /**
   * Select all ThemeFile.
   *
   * @return all ThemeFile records.
   */
