...
public interface EavEntityIntService {
  public EavEntityInt find(EavEntityIntId id);
  /**
   * Select a list of EavEntityInt based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EavEntityInt records.
   */
  public List<EavEntityInt> select(int maxResult);

  /**
   * Select all EavEntityInt.
   *
   * @return all EavEntityInt records.
   */
