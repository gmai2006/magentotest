...
public interface CatalogProductEntityService {
  public CatalogProductEntity find(java.lang.Integer id);

  /**
   * Select a list of CatalogProductEntity based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductEntity records.
   */
  public List<CatalogProductEntity> select(int maxResult);

  /**
   * Select all CatalogProductEntity.
   *
   * @return all CatalogProductEntity records.
   */
  public List<CatalogProductEntity> selectAll();

  /**
   * Create CatalogProductEntity.
   *
   * @param bean The CatalogProductEntity.
   * @return The CatalogProductEntity.
   */
  public CatalogProductEntity create(CatalogProductEntity bean);

  /**
   * Update a CatalogProductEntity.
   *
   * @param bean - The CatalogProductEntity.
