...
public interface CatalogProductIndexPriceOptAgrTmpService {
  public CatalogProductIndexPriceOptAgrTmp find(CatalogProductIndexPriceOptAgrTmpId id);
  /**
   * Select a list of CatalogProductIndexPriceOptAgrTmp based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductIndexPriceOptAgrTmp records.
   */
  public List<CatalogProductIndexPriceOptAgrTmp> select(int maxResult);

  /**
   * Select all CatalogProductIndexPriceOptAgrTmp.
   *
   * @return all CatalogProductIndexPriceOptAgrTmp records.
   */
  public List<CatalogProductIndexPriceOptAgrTmp> selectAll();

  /**
   * Create CatalogProductIndexPriceOptAgrTmp.
   *
   * @param bean The CatalogProductIndexPriceOptAgrTmp.
  ...
  /**
   * Update a CatalogProductIndexPriceOptAgrTmp.
   *
   * @param bean - The CatalogProductIndexPriceOptAgrTmp.
