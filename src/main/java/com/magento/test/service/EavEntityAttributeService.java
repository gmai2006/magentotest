...
public interface EavEntityAttributeService {
  public EavEntityAttribute find(EavEntityAttributeId id);
  /**
   * Select a list of EavEntityAttribute based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EavEntityAttribute records.
   */
  public List<EavEntityAttribute> select(int maxResult);

  /**
   * Select all EavEntityAttribute.
   *
   * @return all EavEntityAttribute records.
   */
  public List<EavEntityAttribute> selectAll();

  /**
   * Create EavEntityAttribute.
   *
   * @param bean The EavEntityAttribute.
   * @return The EavEntityAttribute.
   */
  public EavEntityAttribute create(EavEntityAttribute bean);

  /**
   * Update a EavEntityAttribute.
   *
   * @param bean - The EavEntityAttribute.
