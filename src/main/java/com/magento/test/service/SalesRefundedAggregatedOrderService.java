...
public interface SalesRefundedAggregatedOrderService {
  public SalesRefundedAggregatedOrder find(SalesRefundedAggregatedOrderId id);
  /**
   * Select a list of SalesRefundedAggregatedOrder based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesRefundedAggregatedOrder records.
   */
  public List<SalesRefundedAggregatedOrder> select(int maxResult);

  /**
   * Select all SalesRefundedAggregatedOrder.
   *
   * @return all SalesRefundedAggregatedOrder records.
   */
  public List<SalesRefundedAggregatedOrder> selectAll();

  /**
   * Create SalesRefundedAggregatedOrder.
   *
   * @param bean The SalesRefundedAggregatedOrder.
   * @return The SalesRefundedAggregatedOrder.
   */
  public SalesRefundedAggregatedOrder create(SalesRefundedAggregatedOrder bean);

  /**
   * Update a SalesRefundedAggregatedOrder.
   *
   * @param bean - The SalesRefundedAggregatedOrder.
