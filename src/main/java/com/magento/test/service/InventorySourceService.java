...
public interface InventorySourceService {
  public InventorySource find(java.lang.String id);

  /**
   * Select a list of InventorySource based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return InventorySource records.
   */
  public List<InventorySource> select(int maxResult);

  /**
   * Select all InventorySource.
   *
   * @return all InventorySource records.
   */
   ...
   *
   * @param bean The InventorySource.
