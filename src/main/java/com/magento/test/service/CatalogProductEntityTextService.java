...
public interface CatalogProductEntityTextService {
  public CatalogProductEntityText find(CatalogProductEntityTextId id);
  /**
   * Select a list of CatalogProductEntityText based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductEntityText records.
   */
  public List<CatalogProductEntityText> select(int maxResult);

  /**
   * Select all CatalogProductEntityText.
   *
   * @return all CatalogProductEntityText records.
   */
  public List<CatalogProductEntityText> selectAll();

  /**
   * Create CatalogProductEntityText.
   *
   * @param bean The CatalogProductEntityText.
   * @return The CatalogProductEntityText.
   */
  public CatalogProductEntityText create(CatalogProductEntityText bean);

  /**
   * Update a CatalogProductEntityText.
   *
   * @param bean - The CatalogProductEntityText.
