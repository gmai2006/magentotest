...
public interface DirectoryCurrencyRateService {
  public DirectoryCurrencyRate find(DirectoryCurrencyRateId id);
  /**
   * Select a list of DirectoryCurrencyRate based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return DirectoryCurrencyRate records.
   */
  public List<DirectoryCurrencyRate> select(int maxResult);

  /**
   * Select all DirectoryCurrencyRate.
   *
   * @return all DirectoryCurrencyRate records.
   */
  public List<DirectoryCurrencyRate> selectAll();

  /**
   * Create DirectoryCurrencyRate.
   *
   * @param bean The DirectoryCurrencyRate.
   * @return The DirectoryCurrencyRate.
   */
  public DirectoryCurrencyRate create(DirectoryCurrencyRate bean);

  /**
   * Update a DirectoryCurrencyRate.
   *
   * @param bean - The DirectoryCurrencyRate.
