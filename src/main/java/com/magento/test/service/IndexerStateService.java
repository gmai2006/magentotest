...
public interface IndexerStateService {
  ...
  /**
   * Select a list of IndexerState based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return IndexerState records.
   */
  public List<IndexerState> select(int maxResult);

  /**
   * Select all IndexerState.
   *
   * @return all IndexerState records.
   */
