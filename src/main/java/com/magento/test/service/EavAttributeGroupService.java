...
public interface EavAttributeGroupService {
  public EavAttributeGroup find(EavAttributeGroupId id);
  /**
   * Select a list of EavAttributeGroup based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EavAttributeGroup records.
   */
  public List<EavAttributeGroup> select(int maxResult);

  /**
   * Select all EavAttributeGroup.
   *
   * @return all EavAttributeGroup records.
   */
  public List<EavAttributeGroup> selectAll();

  /**
   * Create EavAttributeGroup.
   *
   * @param bean The EavAttributeGroup.
   * @return The EavAttributeGroup.
   */
  public EavAttributeGroup create(EavAttributeGroup bean);

  /**
   * Update a EavAttributeGroup.
   *
   * @param bean - The EavAttributeGroup.
