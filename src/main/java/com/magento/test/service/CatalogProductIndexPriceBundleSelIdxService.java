...
public interface CatalogProductIndexPriceBundleSelIdxService {
  public CatalogProductIndexPriceBundleSelIdx find(CatalogProductIndexPriceBundleSelIdxId id);
  /**
   * Select a list of CatalogProductIndexPriceBundleSelIdx based on a given maximum number of
   * returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductIndexPriceBundleSelIdx records.
   */
  public List<CatalogProductIndexPriceBundleSelIdx> select(int maxResult);

  /**
   * Select all CatalogProductIndexPriceBundleSelIdx.
   *
   * @return all CatalogProductIndexPriceBundleSelIdx records.
   */
  public List<CatalogProductIndexPriceBundleSelIdx> selectAll();

  /**
   * Create CatalogProductIndexPriceBundleSelIdx.
   *
   * @param bean The CatalogProductIndexPriceBundleSelIdx.
  ...
  /**
   * Update a CatalogProductIndexPriceBundleSelIdx.
   *
   * @param bean - The CatalogProductIndexPriceBundleSelIdx.
