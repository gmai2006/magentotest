...
public interface SalesruleCouponAggregatedOrderService {
  public SalesruleCouponAggregatedOrder find(SalesruleCouponAggregatedOrderId id);
  /**
   * Select a list of SalesruleCouponAggregatedOrder based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesruleCouponAggregatedOrder records.
   */
  public List<SalesruleCouponAggregatedOrder> select(int maxResult);

  /**
   * Select all SalesruleCouponAggregatedOrder.
   *
   * @return all SalesruleCouponAggregatedOrder records.
   */
  public List<SalesruleCouponAggregatedOrder> selectAll();

  /**
   * Create SalesruleCouponAggregatedOrder.
   *
   * @param bean The SalesruleCouponAggregatedOrder.
  ...
  /**
   * Update a SalesruleCouponAggregatedOrder.
   *
   * @param bean - The SalesruleCouponAggregatedOrder.
