...
public interface CatalogProductLinkAttributeIntService {
  public CatalogProductLinkAttributeInt find(CatalogProductLinkAttributeIntId id);
  /**
   * Select a list of CatalogProductLinkAttributeInt based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductLinkAttributeInt records.
   */
  public List<CatalogProductLinkAttributeInt> select(int maxResult);

  /**
   * Select all CatalogProductLinkAttributeInt.
   *
   * @return all CatalogProductLinkAttributeInt records.
   */
  public List<CatalogProductLinkAttributeInt> selectAll();

  /**
   * Create CatalogProductLinkAttributeInt.
   *
   * @param bean The CatalogProductLinkAttributeInt.
  ...
  /**
   * Update a CatalogProductLinkAttributeInt.
   *
   * @param bean - The CatalogProductLinkAttributeInt.
