...
public interface VaultPaymentTokenService {
  public VaultPaymentToken find(VaultPaymentTokenId id);
  /**
   * Select a list of VaultPaymentToken based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return VaultPaymentToken records.
   */
  public List<VaultPaymentToken> select(int maxResult);

  /**
   * Select all VaultPaymentToken.
   *
   * @return all VaultPaymentToken records.
   */
  public List<VaultPaymentToken> selectAll();

  /**
   * Create VaultPaymentToken.
   *
   * @param bean The VaultPaymentToken.
   * @return The VaultPaymentToken.
   */
  public VaultPaymentToken create(VaultPaymentToken bean);

  /**
   * Update a VaultPaymentToken.
   *
   * @param bean - The VaultPaymentToken.
