...
public interface TaxCalculationRateService {
  public TaxCalculationRate find(java.lang.Integer id);

  /**
   * Select a list of TaxCalculationRate based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return TaxCalculationRate records.
   */
  public List<TaxCalculationRate> select(int maxResult);

  /**
   * Select all TaxCalculationRate.
   *
   * @return all TaxCalculationRate records.
   */
  public List<TaxCalculationRate> selectAll();

  /**
   * Create TaxCalculationRate.
   *
   * @param bean The TaxCalculationRate.
   * @return The TaxCalculationRate.
   */
  public TaxCalculationRate create(TaxCalculationRate bean);

  /**
   * Update a TaxCalculationRate.
   *
   * @param bean - The TaxCalculationRate.
