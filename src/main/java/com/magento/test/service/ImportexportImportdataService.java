...
public interface ImportexportImportdataService {
  public ImportexportImportdata find(java.lang.Integer id);

  /**
   * Select a list of ImportexportImportdata based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return ImportexportImportdata records.
   */
  public List<ImportexportImportdata> select(int maxResult);

  /**
   * Select all ImportexportImportdata.
   *
   * @return all ImportexportImportdata records.
   */
  public List<ImportexportImportdata> selectAll();

  /**
   * Create ImportexportImportdata.
   *
   * @param bean The ImportexportImportdata.
   * @return The ImportexportImportdata.
   */
  public ImportexportImportdata create(ImportexportImportdata bean);

  /**
   * Update a ImportexportImportdata.
   *
   * @param bean - The ImportexportImportdata.
