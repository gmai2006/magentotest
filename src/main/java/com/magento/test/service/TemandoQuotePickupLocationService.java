...
public interface TemandoQuotePickupLocationService {
  public TemandoQuotePickupLocation find(java.lang.Integer id);

  /**
   * Select a list of TemandoQuotePickupLocation based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return TemandoQuotePickupLocation records.
   */
  public List<TemandoQuotePickupLocation> select(int maxResult);

  /**
   * Select all TemandoQuotePickupLocation.
   *
   * @return all TemandoQuotePickupLocation records.
   */
  public List<TemandoQuotePickupLocation> selectAll();

  /**
   * Create TemandoQuotePickupLocation.
   *
   * @param bean The TemandoQuotePickupLocation.
   * @return The TemandoQuotePickupLocation.
   */
  public TemandoQuotePickupLocation create(TemandoQuotePickupLocation bean);

  /**
   * Update a TemandoQuotePickupLocation.
   *
   * @param bean - The TemandoQuotePickupLocation.
