...
public interface SalesOrderTaxService {
  public SalesOrderTax find(java.lang.Integer id);

  /**
   * Select a list of SalesOrderTax based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesOrderTax records.
   */
  public List<SalesOrderTax> select(int maxResult);

  /**
   * Select all SalesOrderTax.
   *
   * @return all SalesOrderTax records.
   */
  public List<SalesOrderTax> selectAll();

  /**
   * Create SalesOrderTax.
   *
   * @param bean The SalesOrderTax.
   * @return The SalesOrderTax.
   */
  public SalesOrderTax create(SalesOrderTax bean);

  /**
   * Update a SalesOrderTax.
   *
   * @param bean - The SalesOrderTax.
