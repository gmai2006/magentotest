...
public interface ReviewStatusService {
  ...
  /**
   * Select a list of ReviewStatus based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return ReviewStatus records.
   */
  public List<ReviewStatus> select(int maxResult);

  /**
   * Select all ReviewStatus.
   *
   * @return all ReviewStatus records.
   */
