...
public interface CustomerFormAttributeService {
  public CustomerFormAttribute find(CustomerFormAttributeId id);
  /**
   * Select a list of CustomerFormAttribute based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CustomerFormAttribute records.
   */
  public List<CustomerFormAttribute> select(int maxResult);

  /**
   * Select all CustomerFormAttribute.
   *
   * @return all CustomerFormAttribute records.
   */
  public List<CustomerFormAttribute> selectAll();

  /**
   * Create CustomerFormAttribute.
   *
   * @param bean The CustomerFormAttribute.
   * @return The CustomerFormAttribute.
   */
  public CustomerFormAttribute create(CustomerFormAttribute bean);

  /**
   * Update a CustomerFormAttribute.
   *
   * @param bean - The CustomerFormAttribute.
