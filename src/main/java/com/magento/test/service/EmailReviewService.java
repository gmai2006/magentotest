...
public interface EmailReviewService {
  ...
  /**
   * Select a list of EmailReview based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EmailReview records.
   */
  public List<EmailReview> select(int maxResult);

  /**
   * Select all EmailReview.
   *
   * @return all EmailReview records.
   */
