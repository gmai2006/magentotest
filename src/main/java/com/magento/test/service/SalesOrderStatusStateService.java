...
public interface SalesOrderStatusStateService {
  public SalesOrderStatusState find(SalesOrderStatusStateId id);
  /**
   * Select a list of SalesOrderStatusState based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesOrderStatusState records.
   */
  public List<SalesOrderStatusState> select(int maxResult);

  /**
   * Select all SalesOrderStatusState.
   *
   * @return all SalesOrderStatusState records.
   */
  public List<SalesOrderStatusState> selectAll();

  /**
   * Create SalesOrderStatusState.
   *
   * @param bean The SalesOrderStatusState.
   * @return The SalesOrderStatusState.
   */
  public SalesOrderStatusState create(SalesOrderStatusState bean);

  /**
   * Update a SalesOrderStatusState.
   *
   * @param bean - The SalesOrderStatusState.
