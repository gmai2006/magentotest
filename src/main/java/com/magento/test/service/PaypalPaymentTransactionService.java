...
public interface PaypalPaymentTransactionService {
  public PaypalPaymentTransaction find(PaypalPaymentTransactionId id);
  /**
   * Select a list of PaypalPaymentTransaction based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return PaypalPaymentTransaction records.
   */
  public List<PaypalPaymentTransaction> select(int maxResult);

  /**
   * Select all PaypalPaymentTransaction.
   *
   * @return all PaypalPaymentTransaction records.
   */
  public List<PaypalPaymentTransaction> selectAll();

  /**
   * Create PaypalPaymentTransaction.
   *
   * @param bean The PaypalPaymentTransaction.
   * @return The PaypalPaymentTransaction.
   */
  public PaypalPaymentTransaction create(PaypalPaymentTransaction bean);

  /**
   * Update a PaypalPaymentTransaction.
   *
   * @param bean - The PaypalPaymentTransaction.
