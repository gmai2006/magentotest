...
public interface LayoutLinkService {
  public LayoutLink find(java.lang.Integer id);

  /**
   * Select a list of LayoutLink based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return LayoutLink records.
   */
  public List<LayoutLink> select(int maxResult);

  /**
   * Select all LayoutLink.
   *
   * @return all LayoutLink records.
   */
