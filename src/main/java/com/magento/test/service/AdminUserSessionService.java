...
public interface AdminUserSessionService {
  ...
  /**
   * Select a list of AdminUserSession based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return AdminUserSession records.
   */
  public List<AdminUserSession> select(int maxResult);

  /**
   * Select all AdminUserSession.
   *
   * @return all AdminUserSession records.
   */
  public List<AdminUserSession> selectAll();

  /**
   * Create AdminUserSession.
   *
   * @param bean The AdminUserSession.
   * @return The AdminUserSession.
   */
  public AdminUserSession create(AdminUserSession bean);

  /**
   * Update a AdminUserSession.
   *
   * @param bean - The AdminUserSession.
