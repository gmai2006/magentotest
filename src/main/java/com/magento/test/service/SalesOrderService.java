...
public interface SalesOrderService {
  ...
  /**
   * Select a list of SalesOrder based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesOrder records.
   */
  public List<SalesOrder> select(int maxResult);

  /**
   * Select all SalesOrder.
   *
   * @return all SalesOrder records.
   */
