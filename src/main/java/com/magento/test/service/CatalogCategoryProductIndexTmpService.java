...
public interface CatalogCategoryProductIndexTmpService {
  public CatalogCategoryProductIndexTmp find(CatalogCategoryProductIndexTmpId id);
  /**
   * Select a list of CatalogCategoryProductIndexTmp based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogCategoryProductIndexTmp records.
   */
  public List<CatalogCategoryProductIndexTmp> select(int maxResult);

  /**
   * Select all CatalogCategoryProductIndexTmp.
   *
   * @return all CatalogCategoryProductIndexTmp records.
   */
  public List<CatalogCategoryProductIndexTmp> selectAll();

  /**
   * Create CatalogCategoryProductIndexTmp.
   *
   * @param bean The CatalogCategoryProductIndexTmp.
  ...
  /**
   * Update a CatalogCategoryProductIndexTmp.
   *
   * @param bean - The CatalogCategoryProductIndexTmp.
