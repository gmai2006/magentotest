...
public interface CatalogCategoryProductIndexService {
  public CatalogCategoryProductIndex find(CatalogCategoryProductIndexId id);
  /**
   * Select a list of CatalogCategoryProductIndex based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogCategoryProductIndex records.
   */
  public List<CatalogCategoryProductIndex> select(int maxResult);

  /**
   * Select all CatalogCategoryProductIndex.
   *
   * @return all CatalogCategoryProductIndex records.
   */
  public List<CatalogCategoryProductIndex> selectAll();

  /**
   * Create CatalogCategoryProductIndex.
   *
   * @param bean The CatalogCategoryProductIndex.
   * @return The CatalogCategoryProductIndex.
   */
  public CatalogCategoryProductIndex create(CatalogCategoryProductIndex bean);

  /**
   * Update a CatalogCategoryProductIndex.
   *
   * @param bean - The CatalogCategoryProductIndex.
