...
public interface MviewStateService {
  public MviewState find(java.lang.Integer id);

  /**
   * Select a list of MviewState based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return MviewState records.
   */
  public List<MviewState> select(int maxResult);

  /**
   * Select all MviewState.
   *
   * @return all MviewState records.
   */
