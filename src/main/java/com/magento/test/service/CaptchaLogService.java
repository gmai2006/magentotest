...
public interface CaptchaLogService {
  public CaptchaLog find(CaptchaLogId id);
  /**
   * Select a list of CaptchaLog based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CaptchaLog records.
   */
  public List<CaptchaLog> select(int maxResult);

  /**
   * Select all CaptchaLog.
   *
   * @return all CaptchaLog records.
   */
