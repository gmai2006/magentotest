...
public interface ReportEventTypesService {
  public ReportEventTypes find(java.lang.Integer id);

  /**
   * Select a list of ReportEventTypes based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return ReportEventTypes records.
   */
  public List<ReportEventTypes> select(int maxResult);

  /**
   * Select all ReportEventTypes.
   *
   * @return all ReportEventTypes records.
   */
  public List<ReportEventTypes> selectAll();

  /**
   * Create ReportEventTypes.
   *
   * @param bean The ReportEventTypes.
   * @return The ReportEventTypes.
   */
  public ReportEventTypes create(ReportEventTypes bean);

  /**
   * Update a ReportEventTypes.
   *
   * @param bean - The ReportEventTypes.
