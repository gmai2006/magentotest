...
public interface SalesShipmentItemService {
  public SalesShipmentItem find(java.lang.Integer id);

  /**
   * Select a list of SalesShipmentItem based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesShipmentItem records.
   */
  public List<SalesShipmentItem> select(int maxResult);

  /**
   * Select all SalesShipmentItem.
   *
   * @return all SalesShipmentItem records.
   */
  public List<SalesShipmentItem> selectAll();

  /**
   * Create SalesShipmentItem.
   *
   * @param bean The SalesShipmentItem.
   * @return The SalesShipmentItem.
   */
  public SalesShipmentItem create(SalesShipmentItem bean);

  /**
   * Update a SalesShipmentItem.
   *
   * @param bean - The SalesShipmentItem.
