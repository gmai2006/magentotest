...
public interface SalesruleCouponService {
  public SalesruleCoupon find(SalesruleCouponId id);
  /**
   * Select a list of SalesruleCoupon based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesruleCoupon records.
   */
  public List<SalesruleCoupon> select(int maxResult);

  /**
   * Select all SalesruleCoupon.
   *
   * @return all SalesruleCoupon records.
   */
  public List<SalesruleCoupon> selectAll();

  /**
   * Create SalesruleCoupon.
   *
   * @param bean The SalesruleCoupon.
   * @return The SalesruleCoupon.
   */
  public SalesruleCoupon create(SalesruleCoupon bean);

  /**
   * Update a SalesruleCoupon.
   *
   * @param bean - The SalesruleCoupon.
