...
public interface CatalogProductIndexPriceFinalIdxService {
  public CatalogProductIndexPriceFinalIdx find(CatalogProductIndexPriceFinalIdxId id);
  /**
   * Select a list of CatalogProductIndexPriceFinalIdx based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductIndexPriceFinalIdx records.
   */
  public List<CatalogProductIndexPriceFinalIdx> select(int maxResult);

  /**
   * Select all CatalogProductIndexPriceFinalIdx.
   *
   * @return all CatalogProductIndexPriceFinalIdx records.
   */
  public List<CatalogProductIndexPriceFinalIdx> selectAll();

  /**
   * Create CatalogProductIndexPriceFinalIdx.
   *
   * @param bean The CatalogProductIndexPriceFinalIdx.
  ...
  /**
   * Update a CatalogProductIndexPriceFinalIdx.
   *
   * @param bean - The CatalogProductIndexPriceFinalIdx.
