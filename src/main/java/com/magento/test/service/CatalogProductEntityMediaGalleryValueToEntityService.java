...
public interface CatalogProductEntityMediaGalleryValueToEntityService {
  public CatalogProductEntityMediaGalleryValueToEntity find(
      CatalogProductEntityMediaGalleryValueToEntityId id);
  /**
   * Select a list of CatalogProductEntityMediaGalleryValueToEntity based on a given maximum number
   * of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductEntityMediaGalleryValueToEntity records.
   */
  public List<CatalogProductEntityMediaGalleryValueToEntity> select(int maxResult);

  /**
   * Select all CatalogProductEntityMediaGalleryValueToEntity.
   *
   * @return all CatalogProductEntityMediaGalleryValueToEntity records.
   */
  public List<CatalogProductEntityMediaGalleryValueToEntity> selectAll();

  /**
   * Create CatalogProductEntityMediaGalleryValueToEntity.
   *
   * @param bean The CatalogProductEntityMediaGalleryValueToEntity.
  ...
  /**
   * Update a CatalogProductEntityMediaGalleryValueToEntity.
   *
   * @param bean - The CatalogProductEntityMediaGalleryValueToEntity.
