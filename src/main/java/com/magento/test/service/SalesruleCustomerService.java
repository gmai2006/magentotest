...
public interface SalesruleCustomerService {
  public SalesruleCustomer find(java.lang.Integer id);

  /**
   * Select a list of SalesruleCustomer based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesruleCustomer records.
   */
  public List<SalesruleCustomer> select(int maxResult);

  /**
   * Select all SalesruleCustomer.
   *
   * @return all SalesruleCustomer records.
   */
  public List<SalesruleCustomer> selectAll();

  /**
   * Create SalesruleCustomer.
   *
   * @param bean The SalesruleCustomer.
   * @return The SalesruleCustomer.
   */
  public SalesruleCustomer create(SalesruleCustomer bean);

  /**
   * Update a SalesruleCustomer.
   *
   * @param bean - The SalesruleCustomer.
