...
public interface CronScheduleService {
  ...
  /**
   * Select a list of CronSchedule based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CronSchedule records.
   */
  public List<CronSchedule> select(int maxResult);

  /**
   * Select all CronSchedule.
   *
   * @return all CronSchedule records.
   */
