...
public interface DirectoryCountryRegionService {
  public DirectoryCountryRegion find(java.lang.Integer id);

  /**
   * Select a list of DirectoryCountryRegion based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return DirectoryCountryRegion records.
   */
  public List<DirectoryCountryRegion> select(int maxResult);

  /**
   * Select all DirectoryCountryRegion.
   *
   * @return all DirectoryCountryRegion records.
   */
  public List<DirectoryCountryRegion> selectAll();

  /**
   * Create DirectoryCountryRegion.
   *
   * @param bean The DirectoryCountryRegion.
   * @return The DirectoryCountryRegion.
   */
  public DirectoryCountryRegion create(DirectoryCountryRegion bean);

  /**
   * Update a DirectoryCountryRegion.
   *
   * @param bean - The DirectoryCountryRegion.
