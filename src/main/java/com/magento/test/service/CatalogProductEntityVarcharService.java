...
public interface CatalogProductEntityVarcharService {
  public CatalogProductEntityVarchar find(CatalogProductEntityVarcharId id);
  /**
   * Select a list of CatalogProductEntityVarchar based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductEntityVarchar records.
   */
  public List<CatalogProductEntityVarchar> select(int maxResult);

  /**
   * Select all CatalogProductEntityVarchar.
   *
   * @return all CatalogProductEntityVarchar records.
   */
  public List<CatalogProductEntityVarchar> selectAll();

  /**
   * Create CatalogProductEntityVarchar.
   *
   * @param bean The CatalogProductEntityVarchar.
   * @return The CatalogProductEntityVarchar.
   */
  public CatalogProductEntityVarchar create(CatalogProductEntityVarchar bean);

  /**
   * Update a CatalogProductEntityVarchar.
   *
   * @param bean - The CatalogProductEntityVarchar.
