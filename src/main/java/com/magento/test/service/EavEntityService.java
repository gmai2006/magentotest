...
public interface EavEntityService {
  ...
  /**
   * Select a list of EavEntity based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EavEntity records.
   */
  public List<EavEntity> select(int maxResult);

  /**
   * Select all EavEntity.
   *
   * @return all EavEntity records.
   */
