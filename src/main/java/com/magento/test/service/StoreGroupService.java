...
public interface StoreGroupService {
  ...
  /**
   * Select a list of StoreGroup based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return StoreGroup records.
   */
  public List<StoreGroup> select(int maxResult);

  /**
   * Select all StoreGroup.
   *
   * @return all StoreGroup records.
   */
