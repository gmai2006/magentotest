...
public interface NewsletterQueueStoreLinkService {
  public NewsletterQueueStoreLink find(NewsletterQueueStoreLinkId id);
  /**
   * Select a list of NewsletterQueueStoreLink based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return NewsletterQueueStoreLink records.
   */
  public List<NewsletterQueueStoreLink> select(int maxResult);

  /**
   * Select all NewsletterQueueStoreLink.
   *
   * @return all NewsletterQueueStoreLink records.
   */
  public List<NewsletterQueueStoreLink> selectAll();

  /**
   * Create NewsletterQueueStoreLink.
   *
   * @param bean The NewsletterQueueStoreLink.
   * @return The NewsletterQueueStoreLink.
   */
  public NewsletterQueueStoreLink create(NewsletterQueueStoreLink bean);

  /**
   * Update a NewsletterQueueStoreLink.
   *
   * @param bean - The NewsletterQueueStoreLink.
