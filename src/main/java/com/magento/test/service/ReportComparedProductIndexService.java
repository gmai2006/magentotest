...
public interface ReportComparedProductIndexService {
  public ReportComparedProductIndex find(ReportComparedProductIndexId id);
  /**
   * Select a list of ReportComparedProductIndex based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return ReportComparedProductIndex records.
   */
  public List<ReportComparedProductIndex> select(int maxResult);

  /**
   * Select all ReportComparedProductIndex.
   *
   * @return all ReportComparedProductIndex records.
   */
  public List<ReportComparedProductIndex> selectAll();

  /**
   * Create ReportComparedProductIndex.
   *
   * @param bean The ReportComparedProductIndex.
   * @return The ReportComparedProductIndex.
   */
  public ReportComparedProductIndex create(ReportComparedProductIndex bean);

  /**
   * Update a ReportComparedProductIndex.
   *
   * @param bean - The ReportComparedProductIndex.
