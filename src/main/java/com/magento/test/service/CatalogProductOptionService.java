...
public interface CatalogProductOptionService {
  public CatalogProductOption find(java.lang.Integer id);

  /**
   * Select a list of CatalogProductOption based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductOption records.
   */
  public List<CatalogProductOption> select(int maxResult);

  /**
   * Select all CatalogProductOption.
   *
   * @return all CatalogProductOption records.
   */
  public List<CatalogProductOption> selectAll();

  /**
   * Create CatalogProductOption.
   *
   * @param bean The CatalogProductOption.
   * @return The CatalogProductOption.
   */
  public CatalogProductOption create(CatalogProductOption bean);

  /**
   * Update a CatalogProductOption.
   *
   * @param bean - The CatalogProductOption.
