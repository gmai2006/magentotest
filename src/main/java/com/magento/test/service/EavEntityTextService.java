...
public interface EavEntityTextService {
  public EavEntityText find(EavEntityTextId id);
  /**
   * Select a list of EavEntityText based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EavEntityText records.
   */
  public List<EavEntityText> select(int maxResult);

  /**
   * Select all EavEntityText.
   *
   * @return all EavEntityText records.
   */
  public List<EavEntityText> selectAll();

  /**
   * Create EavEntityText.
   *
   * @param bean The EavEntityText.
   * @return The EavEntityText.
   */
  public EavEntityText create(EavEntityText bean);

  /**
   * Update a EavEntityText.
   *
   * @param bean - The EavEntityText.
