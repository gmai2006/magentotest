...
public interface InventoryLowStockNotificationConfigurationService {
  public InventoryLowStockNotificationConfiguration find(
      InventoryLowStockNotificationConfigurationId id);
  /**
   * Select a list of InventoryLowStockNotificationConfiguration based on a given maximum number of
   * returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return InventoryLowStockNotificationConfiguration records.
   */
  public List<InventoryLowStockNotificationConfiguration> select(int maxResult);

  /**
   * Select all InventoryLowStockNotificationConfiguration.
   *
   * @return all InventoryLowStockNotificationConfiguration records.
   */
  public List<InventoryLowStockNotificationConfiguration> selectAll();

  /**
   * Create InventoryLowStockNotificationConfiguration.
   *
   * @param bean The InventoryLowStockNotificationConfiguration.
  ...
  /**
   * Update a InventoryLowStockNotificationConfiguration.
   *
   * @param bean - The InventoryLowStockNotificationConfiguration.
