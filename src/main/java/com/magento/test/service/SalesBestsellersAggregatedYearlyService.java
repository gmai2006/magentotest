...
public interface SalesBestsellersAggregatedYearlyService {
  public SalesBestsellersAggregatedYearly find(SalesBestsellersAggregatedYearlyId id);
  /**
   * Select a list of SalesBestsellersAggregatedYearly based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesBestsellersAggregatedYearly records.
   */
  public List<SalesBestsellersAggregatedYearly> select(int maxResult);

  /**
   * Select all SalesBestsellersAggregatedYearly.
   *
   * @return all SalesBestsellersAggregatedYearly records.
   */
  public List<SalesBestsellersAggregatedYearly> selectAll();

  /**
   * Create SalesBestsellersAggregatedYearly.
   *
   * @param bean The SalesBestsellersAggregatedYearly.
  ...
  /**
   * Update a SalesBestsellersAggregatedYearly.
   *
   * @param bean - The SalesBestsellersAggregatedYearly.
