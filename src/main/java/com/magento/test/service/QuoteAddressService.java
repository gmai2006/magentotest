...
public interface QuoteAddressService {
  ...
  /**
   * Select a list of QuoteAddress based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return QuoteAddress records.
   */
  public List<QuoteAddress> select(int maxResult);

  /**
   * Select all QuoteAddress.
   *
   * @return all QuoteAddress records.
   */
