...
public interface CatalogProductEntityTierPriceService {
  public CatalogProductEntityTierPrice find(CatalogProductEntityTierPriceId id);
  /**
   * Select a list of CatalogProductEntityTierPrice based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductEntityTierPrice records.
   */
  public List<CatalogProductEntityTierPrice> select(int maxResult);

  /**
   * Select all CatalogProductEntityTierPrice.
   *
   * @return all CatalogProductEntityTierPrice records.
   */
  public List<CatalogProductEntityTierPrice> selectAll();

  /**
   * Create CatalogProductEntityTierPrice.
   *
   * @param bean The CatalogProductEntityTierPrice.
   * @return The CatalogProductEntityTierPrice.
   */
  public CatalogProductEntityTierPrice create(CatalogProductEntityTierPrice bean);

  /**
   * Update a CatalogProductEntityTierPrice.
   *
   * @param bean - The CatalogProductEntityTierPrice.
