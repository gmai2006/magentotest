...
public interface ReportingUsersService {
  public ReportingUsers find(java.lang.Integer id);

  /**
   * Select a list of ReportingUsers based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return ReportingUsers records.
   */
  public List<ReportingUsers> select(int maxResult);

  /**
   * Select all ReportingUsers.
   *
   * @return all ReportingUsers records.
   */
  public List<ReportingUsers> selectAll();

  /**
   * Create ReportingUsers.
   *
   * @param bean The ReportingUsers.
   * @return The ReportingUsers.
   */
  public ReportingUsers create(ReportingUsers bean);

  /**
   * Update a ReportingUsers.
   *
   * @param bean - The ReportingUsers.
