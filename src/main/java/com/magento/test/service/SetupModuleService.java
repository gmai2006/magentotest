...
public interface SetupModuleService {
  public SetupModule find(java.lang.String id);

  /**
   * Select a list of SetupModule based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SetupModule records.
   */
  public List<SetupModule> select(int maxResult);

  /**
   * Select all SetupModule.
   *
   * @return all SetupModule records.
   */
