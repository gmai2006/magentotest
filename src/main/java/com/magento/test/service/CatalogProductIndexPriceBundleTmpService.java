...
public interface CatalogProductIndexPriceBundleTmpService {
  public CatalogProductIndexPriceBundleTmp find(CatalogProductIndexPriceBundleTmpId id);
  /**
   * Select a list of CatalogProductIndexPriceBundleTmp based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductIndexPriceBundleTmp records.
   */
  public List<CatalogProductIndexPriceBundleTmp> select(int maxResult);

  /**
   * Select all CatalogProductIndexPriceBundleTmp.
   *
   * @return all CatalogProductIndexPriceBundleTmp records.
   */
  public List<CatalogProductIndexPriceBundleTmp> selectAll();

  /**
   * Create CatalogProductIndexPriceBundleTmp.
   *
   * @param bean The CatalogProductIndexPriceBundleTmp.
  ...
  /**
   * Update a CatalogProductIndexPriceBundleTmp.
   *
   * @param bean - The CatalogProductIndexPriceBundleTmp.
