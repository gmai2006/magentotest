...
public interface CustomerGroupService {
  ...
  /**
   * Select a list of CustomerGroup based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CustomerGroup records.
   */
  public List<CustomerGroup> select(int maxResult);

  /**
   * Select all CustomerGroup.
   *
   * @return all CustomerGroup records.
   */
