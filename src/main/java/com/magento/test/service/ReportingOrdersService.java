...
public interface ReportingOrdersService {
  ...
  /**
   * Select a list of ReportingOrders based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return ReportingOrders records.
   */
  public List<ReportingOrders> select(int maxResult);

  /**
   * Select all ReportingOrders.
   *
   * @return all ReportingOrders records.
   */
  public List<ReportingOrders> selectAll();

  /**
   * Create ReportingOrders.
   *
   * @param bean The ReportingOrders.
   * @return The ReportingOrders.
   */
  public ReportingOrders create(ReportingOrders bean);

  /**
   * Update a ReportingOrders.
   *
   * @param bean - The ReportingOrders.
