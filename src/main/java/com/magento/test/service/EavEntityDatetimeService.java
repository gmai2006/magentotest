...
public interface EavEntityDatetimeService {
  public EavEntityDatetime find(EavEntityDatetimeId id);
  /**
   * Select a list of EavEntityDatetime based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EavEntityDatetime records.
   */
  public List<EavEntityDatetime> select(int maxResult);

  /**
   * Select all EavEntityDatetime.
   *
   * @return all EavEntityDatetime records.
   */
  public List<EavEntityDatetime> selectAll();

  /**
   * Create EavEntityDatetime.
   *
   * @param bean The EavEntityDatetime.
   * @return The EavEntityDatetime.
   */
  public EavEntityDatetime create(EavEntityDatetime bean);

  /**
   * Update a EavEntityDatetime.
   *
   * @param bean - The EavEntityDatetime.
