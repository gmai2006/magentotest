...
public interface InventoryStockSalesChannelService {
  public InventoryStockSalesChannel find(InventoryStockSalesChannelId id);
  /**
   * Select a list of InventoryStockSalesChannel based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return InventoryStockSalesChannel records.
   */
  public List<InventoryStockSalesChannel> select(int maxResult);

  /**
   * Select all InventoryStockSalesChannel.
   *
   * @return all InventoryStockSalesChannel records.
   */
  public List<InventoryStockSalesChannel> selectAll();

  /**
   * Create InventoryStockSalesChannel.
   *
   * @param bean The InventoryStockSalesChannel.
   * @return The InventoryStockSalesChannel.
   */
  public InventoryStockSalesChannel create(InventoryStockSalesChannel bean);

  /**
   * Update a InventoryStockSalesChannel.
   *
   * @param bean - The InventoryStockSalesChannel.
