...
public interface ShippingTablerateService {
  public ShippingTablerate find(ShippingTablerateId id);
  /**
   * Select a list of ShippingTablerate based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return ShippingTablerate records.
   */
  public List<ShippingTablerate> select(int maxResult);

  /**
   * Select all ShippingTablerate.
   *
   * @return all ShippingTablerate records.
   */
  public List<ShippingTablerate> selectAll();

  /**
   * Create ShippingTablerate.
   *
   * @param bean The ShippingTablerate.
   * @return The ShippingTablerate.
   */
  public ShippingTablerate create(ShippingTablerate bean);

  /**
   * Update a ShippingTablerate.
   *
   * @param bean - The ShippingTablerate.
