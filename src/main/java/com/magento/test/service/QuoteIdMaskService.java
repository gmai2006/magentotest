...
public interface QuoteIdMaskService {
  public QuoteIdMask find(QuoteIdMaskId id);
  /**
   * Select a list of QuoteIdMask based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return QuoteIdMask records.
   */
  public List<QuoteIdMask> select(int maxResult);

  /**
   * Select all QuoteIdMask.
   *
   * @return all QuoteIdMask records.
   */
