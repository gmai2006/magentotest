...
public interface CataloginventoryStockStatusIdxService {
  public CataloginventoryStockStatusIdx find(CataloginventoryStockStatusIdxId id);
  /**
   * Select a list of CataloginventoryStockStatusIdx based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CataloginventoryStockStatusIdx records.
   */
  public List<CataloginventoryStockStatusIdx> select(int maxResult);

  /**
   * Select all CataloginventoryStockStatusIdx.
   *
   * @return all CataloginventoryStockStatusIdx records.
   */
  public List<CataloginventoryStockStatusIdx> selectAll();

  /**
   * Create CataloginventoryStockStatusIdx.
   *
   * @param bean The CataloginventoryStockStatusIdx.
  ...
  /**
   * Update a CataloginventoryStockStatusIdx.
   *
   * @param bean - The CataloginventoryStockStatusIdx.
