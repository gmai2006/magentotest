...
public interface QuoteAddressItemService {
  public QuoteAddressItem find(java.lang.Integer id);

  /**
   * Select a list of QuoteAddressItem based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return QuoteAddressItem records.
   */
  public List<QuoteAddressItem> select(int maxResult);

  /**
   * Select all QuoteAddressItem.
   *
   * @return all QuoteAddressItem records.
   */
  public List<QuoteAddressItem> selectAll();

  /**
   * Create QuoteAddressItem.
   *
   * @param bean The QuoteAddressItem.
   * @return The QuoteAddressItem.
   */
  public QuoteAddressItem create(QuoteAddressItem bean);

  /**
   * Update a QuoteAddressItem.
   *
   * @param bean - The QuoteAddressItem.
