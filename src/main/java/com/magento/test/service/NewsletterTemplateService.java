...
public interface NewsletterTemplateService {
  ...
  /**
   * Select a list of NewsletterTemplate based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return NewsletterTemplate records.
   */
  public List<NewsletterTemplate> select(int maxResult);

  /**
   * Select all NewsletterTemplate.
   *
   * @return all NewsletterTemplate records.
   */
