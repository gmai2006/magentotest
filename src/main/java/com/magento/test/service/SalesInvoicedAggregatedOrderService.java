...
public interface SalesInvoicedAggregatedOrderService {
  public SalesInvoicedAggregatedOrder find(SalesInvoicedAggregatedOrderId id);
  /**
   * Select a list of SalesInvoicedAggregatedOrder based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesInvoicedAggregatedOrder records.
   */
  public List<SalesInvoicedAggregatedOrder> select(int maxResult);

  /**
   * Select all SalesInvoicedAggregatedOrder.
   *
   * @return all SalesInvoicedAggregatedOrder records.
   */
  public List<SalesInvoicedAggregatedOrder> selectAll();

  /**
   * Create SalesInvoicedAggregatedOrder.
   *
   * @param bean The SalesInvoicedAggregatedOrder.
   * @return The SalesInvoicedAggregatedOrder.
   */
  public SalesInvoicedAggregatedOrder create(SalesInvoicedAggregatedOrder bean);

  /**
   * Update a SalesInvoicedAggregatedOrder.
   *
   * @param bean - The SalesInvoicedAggregatedOrder.
