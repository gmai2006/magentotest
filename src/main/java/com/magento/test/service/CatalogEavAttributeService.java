...
public interface CatalogEavAttributeService {
  public CatalogEavAttribute find(java.lang.Integer id);

  /**
   * Select a list of CatalogEavAttribute based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogEavAttribute records.
   */
  public List<CatalogEavAttribute> select(int maxResult);

  /**
   * Select all CatalogEavAttribute.
   *
   * @return all CatalogEavAttribute records.
   */
  public List<CatalogEavAttribute> selectAll();

  /**
   * Create CatalogEavAttribute.
   *
   * @param bean The CatalogEavAttribute.
   * @return The CatalogEavAttribute.
   */
  public CatalogEavAttribute create(CatalogEavAttribute bean);

  /**
   * Update a CatalogEavAttribute.
   *
   * @param bean - The CatalogEavAttribute.
