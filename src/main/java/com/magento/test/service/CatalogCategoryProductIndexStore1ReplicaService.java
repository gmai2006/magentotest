...
public interface CatalogCategoryProductIndexStore1ReplicaService {
  public CatalogCategoryProductIndexStore1Replica find(
      CatalogCategoryProductIndexStore1ReplicaId id);
  /**
   * Select a list of CatalogCategoryProductIndexStore1Replica based on a given maximum number of
   * returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogCategoryProductIndexStore1Replica records.
   */
  public List<CatalogCategoryProductIndexStore1Replica> select(int maxResult);

  /**
   * Select all CatalogCategoryProductIndexStore1Replica.
   *
   * @return all CatalogCategoryProductIndexStore1Replica records.
   */
  public List<CatalogCategoryProductIndexStore1Replica> selectAll();

  /**
   * Create CatalogCategoryProductIndexStore1Replica.
   *
   * @param bean The CatalogCategoryProductIndexStore1Replica.
  ...
  /**
   * Update a CatalogCategoryProductIndexStore1Replica.
   *
   * @param bean - The CatalogCategoryProductIndexStore1Replica.
