...
public interface SalesInvoiceItemService {
  ...
  /**
   * Select a list of SalesInvoiceItem based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesInvoiceItem records.
   */
  public List<SalesInvoiceItem> select(int maxResult);

  /**
   * Select all SalesInvoiceItem.
   *
   * @return all SalesInvoiceItem records.
   */
