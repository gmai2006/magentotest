...
public interface GiftMessageService {
  public GiftMessage find(java.lang.Integer id);

  /**
   * Select a list of GiftMessage based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return GiftMessage records.
   */
  public List<GiftMessage> select(int maxResult);

  /**
   * Select all GiftMessage.
   *
   * @return all GiftMessage records.
   */
