...
public interface CatalogsearchFulltextScope1Service {
  public CatalogsearchFulltextScope1 find(CatalogsearchFulltextScope1Id id);
  /**
   * Select a list of CatalogsearchFulltextScope1 based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogsearchFulltextScope1 records.
   */
  public List<CatalogsearchFulltextScope1> select(int maxResult);

  /**
   * Select all CatalogsearchFulltextScope1.
   *
   * @return all CatalogsearchFulltextScope1 records.
   */
  public List<CatalogsearchFulltextScope1> selectAll();

  /**
   * Create CatalogsearchFulltextScope1.
   *
   * @param bean The CatalogsearchFulltextScope1.
   * @return The CatalogsearchFulltextScope1.
   */
  public CatalogsearchFulltextScope1 create(CatalogsearchFulltextScope1 bean);

  /**
   * Update a CatalogsearchFulltextScope1.
   *
   * @param bean - The CatalogsearchFulltextScope1.
