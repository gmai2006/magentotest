...
public interface DesignChangeService {
  public DesignChange find(java.lang.Integer id);

  /**
   * Select a list of DesignChange based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return DesignChange records.
   */
  public List<DesignChange> select(int maxResult);

  /**
   * Select all DesignChange.
   *
   * @return all DesignChange records.
   */
