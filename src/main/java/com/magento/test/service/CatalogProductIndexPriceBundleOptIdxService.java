...
public interface CatalogProductIndexPriceBundleOptIdxService {
  public CatalogProductIndexPriceBundleOptIdx find(CatalogProductIndexPriceBundleOptIdxId id);
  /**
   * Select a list of CatalogProductIndexPriceBundleOptIdx based on a given maximum number of
   * returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductIndexPriceBundleOptIdx records.
   */
  public List<CatalogProductIndexPriceBundleOptIdx> select(int maxResult);

  /**
   * Select all CatalogProductIndexPriceBundleOptIdx.
   *
   * @return all CatalogProductIndexPriceBundleOptIdx records.
   */
  public List<CatalogProductIndexPriceBundleOptIdx> selectAll();

  /**
   * Create CatalogProductIndexPriceBundleOptIdx.
   *
   * @param bean The CatalogProductIndexPriceBundleOptIdx.
  ...
  /**
   * Update a CatalogProductIndexPriceBundleOptIdx.
   *
   * @param bean - The CatalogProductIndexPriceBundleOptIdx.
