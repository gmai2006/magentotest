...
public interface ReviewDetailService {
  ...
  /**
   * Select a list of ReviewDetail based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return ReviewDetail records.
   */
  public List<ReviewDetail> select(int maxResult);

  /**
   * Select all ReviewDetail.
   *
   * @return all ReviewDetail records.
   */
