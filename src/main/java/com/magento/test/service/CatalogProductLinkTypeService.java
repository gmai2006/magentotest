...
public interface CatalogProductLinkTypeService {
  public CatalogProductLinkType find(java.lang.Integer id);

  /**
   * Select a list of CatalogProductLinkType based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductLinkType records.
   */
  public List<CatalogProductLinkType> select(int maxResult);

  /**
   * Select all CatalogProductLinkType.
   *
   * @return all CatalogProductLinkType records.
   */
  public List<CatalogProductLinkType> selectAll();

  /**
   * Create CatalogProductLinkType.
   *
   * @param bean The CatalogProductLinkType.
   * @return The CatalogProductLinkType.
   */
  public CatalogProductLinkType create(CatalogProductLinkType bean);

  /**
   * Update a CatalogProductLinkType.
   *
   * @param bean - The CatalogProductLinkType.
