...
public interface DownloadableLinkTitleService {
  public DownloadableLinkTitle find(DownloadableLinkTitleId id);
  /**
   * Select a list of DownloadableLinkTitle based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return DownloadableLinkTitle records.
   */
  public List<DownloadableLinkTitle> select(int maxResult);

  /**
   * Select all DownloadableLinkTitle.
   *
   * @return all DownloadableLinkTitle records.
   */
  public List<DownloadableLinkTitle> selectAll();

  /**
   * Create DownloadableLinkTitle.
   *
   * @param bean The DownloadableLinkTitle.
   * @return The DownloadableLinkTitle.
   */
  public DownloadableLinkTitle create(DownloadableLinkTitle bean);

  /**
   * Update a DownloadableLinkTitle.
   *
   * @param bean - The DownloadableLinkTitle.
