...
public interface EmailOrderService {
  public EmailOrder find(java.lang.Integer id);

  /**
   * Select a list of EmailOrder based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EmailOrder records.
   */
  public List<EmailOrder> select(int maxResult);

  /**
   * Select all EmailOrder.
   *
   * @return all EmailOrder records.
   */
