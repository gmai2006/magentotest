...
public interface WishlistItemService {
  ...
  /**
   * Select a list of WishlistItem based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return WishlistItem records.
   */
  public List<WishlistItem> select(int maxResult);

  /**
   * Select all WishlistItem.
   *
   * @return all WishlistItem records.
   */
