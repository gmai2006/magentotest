...
public interface SalesCreditmemoGridService {
  public SalesCreditmemoGrid find(SalesCreditmemoGridId id);
  /**
   * Select a list of SalesCreditmemoGrid based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesCreditmemoGrid records.
   */
  public List<SalesCreditmemoGrid> select(int maxResult);

  /**
   * Select all SalesCreditmemoGrid.
   *
   * @return all SalesCreditmemoGrid records.
   */
  public List<SalesCreditmemoGrid> selectAll();

  /**
   * Create SalesCreditmemoGrid.
   *
   * @param bean The SalesCreditmemoGrid.
   * @return The SalesCreditmemoGrid.
   */
  public SalesCreditmemoGrid create(SalesCreditmemoGrid bean);

  /**
   * Update a SalesCreditmemoGrid.
   *
   * @param bean - The SalesCreditmemoGrid.
