...
public interface EavEntityTypeService {
  public EavEntityType find(java.lang.Integer id);

  /**
   * Select a list of EavEntityType based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EavEntityType records.
   */
  public List<EavEntityType> select(int maxResult);

  /**
   * Select all EavEntityType.
   *
   * @return all EavEntityType records.
   */
  public List<EavEntityType> selectAll();

  /**
   * Create EavEntityType.
   *
   * @param bean The EavEntityType.
   * @return The EavEntityType.
   */
  public EavEntityType create(EavEntityType bean);

  /**
   * Update a EavEntityType.
   *
   * @param bean - The EavEntityType.
