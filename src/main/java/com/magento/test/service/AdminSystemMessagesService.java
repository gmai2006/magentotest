...
public interface AdminSystemMessagesService {
  ...
  /**
   * Select a list of AdminSystemMessages based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return AdminSystemMessages records.
   */
  public List<AdminSystemMessages> select(int maxResult);

  /**
   * Select all AdminSystemMessages.
   *
   * @return all AdminSystemMessages records.
   */
  public List<AdminSystemMessages> selectAll();

  /**
   * Create AdminSystemMessages.
   *
   * @param bean The AdminSystemMessages.
   * @return The AdminSystemMessages.
   */
  public AdminSystemMessages create(AdminSystemMessages bean);

  /**
   * Update a AdminSystemMessages.
   *
   * @param bean - The AdminSystemMessages.
