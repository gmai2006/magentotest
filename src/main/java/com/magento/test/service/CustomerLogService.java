...
public interface CustomerLogService {
  ...
  /**
   * Select a list of CustomerLog based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CustomerLog records.
   */
  public List<CustomerLog> select(int maxResult);

  /**
   * Select all CustomerLog.
   *
   * @return all CustomerLog records.
   */
