...
public interface SalesOrderAggregatedCreatedService {
  public SalesOrderAggregatedCreated find(SalesOrderAggregatedCreatedId id);
  /**
   * Select a list of SalesOrderAggregatedCreated based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesOrderAggregatedCreated records.
   */
  public List<SalesOrderAggregatedCreated> select(int maxResult);

  /**
   * Select all SalesOrderAggregatedCreated.
   *
   * @return all SalesOrderAggregatedCreated records.
   */
  public List<SalesOrderAggregatedCreated> selectAll();

  /**
   * Create SalesOrderAggregatedCreated.
   *
   * @param bean The SalesOrderAggregatedCreated.
   * @return The SalesOrderAggregatedCreated.
   */
  public SalesOrderAggregatedCreated create(SalesOrderAggregatedCreated bean);

  /**
   * Update a SalesOrderAggregatedCreated.
   *
   * @param bean - The SalesOrderAggregatedCreated.
