...
public interface SalesCreditmemoService {
  ...
  /**
   * Select a list of SalesCreditmemo based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesCreditmemo records.
   */
  public List<SalesCreditmemo> select(int maxResult);

  /**
   * Select all SalesCreditmemo.
   *
   * @return all SalesCreditmemo records.
   */
