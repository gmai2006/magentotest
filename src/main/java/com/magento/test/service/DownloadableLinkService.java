...
public interface DownloadableLinkService {
  public DownloadableLink find(java.lang.Integer id);

  /**
   * Select a list of DownloadableLink based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return DownloadableLink records.
   */
  public List<DownloadableLink> select(int maxResult);

  /**
   * Select all DownloadableLink.
   *
   * @return all DownloadableLink records.
   */
  public List<DownloadableLink> selectAll();

  /**
   * Create DownloadableLink.
   *
   * @param bean The DownloadableLink.
   * @return The DownloadableLink.
   */
  public DownloadableLink create(DownloadableLink bean);

  /**
   * Update a DownloadableLink.
   *
   * @param bean - The DownloadableLink.
