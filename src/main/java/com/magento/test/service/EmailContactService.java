...
public interface EmailContactService {
  ...
  /**
   * Select a list of EmailContact based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EmailContact records.
   */
  public List<EmailContact> select(int maxResult);

  /**
   * Select all EmailContact.
   *
   * @return all EmailContact records.
   */
