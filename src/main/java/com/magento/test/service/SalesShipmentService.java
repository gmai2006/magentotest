...
public interface SalesShipmentService {
  public SalesShipment find(SalesShipmentId id);
  /**
   * Select a list of SalesShipment based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesShipment records.
   */
  public List<SalesShipment> select(int maxResult);

  /**
   * Select all SalesShipment.
   *
   * @return all SalesShipment records.
   */
  public List<SalesShipment> selectAll();

  /**
   * Create SalesShipment.
   *
   * @param bean The SalesShipment.
   * @return The SalesShipment.
   */
  public SalesShipment create(SalesShipment bean);

  /**
   * Update a SalesShipment.
   *
   * @param bean - The SalesShipment.
