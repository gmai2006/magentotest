...
public interface CatalogProductFrontendActionService {
  public CatalogProductFrontendAction find(CatalogProductFrontendActionId id);
  /**
   * Select a list of CatalogProductFrontendAction based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductFrontendAction records.
   */
  public List<CatalogProductFrontendAction> select(int maxResult);

  /**
   * Select all CatalogProductFrontendAction.
   *
   * @return all CatalogProductFrontendAction records.
   */
  public List<CatalogProductFrontendAction> selectAll();

  /**
   * Create CatalogProductFrontendAction.
   *
   * @param bean The CatalogProductFrontendAction.
   * @return The CatalogProductFrontendAction.
   */
  public CatalogProductFrontendAction create(CatalogProductFrontendAction bean);

  /**
   * Update a CatalogProductFrontendAction.
   *
   * @param bean - The CatalogProductFrontendAction.
