...
public interface SalesCreditmemoItemService {
  public SalesCreditmemoItem find(java.lang.Integer id);

  /**
   * Select a list of SalesCreditmemoItem based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesCreditmemoItem records.
   */
  public List<SalesCreditmemoItem> select(int maxResult);

  /**
   * Select all SalesCreditmemoItem.
   *
   * @return all SalesCreditmemoItem records.
   */
  public List<SalesCreditmemoItem> selectAll();

  /**
   * Create SalesCreditmemoItem.
   *
   * @param bean The SalesCreditmemoItem.
   * @return The SalesCreditmemoItem.
   */
  public SalesCreditmemoItem create(SalesCreditmemoItem bean);

  /**
   * Update a SalesCreditmemoItem.
   *
   * @param bean - The SalesCreditmemoItem.
