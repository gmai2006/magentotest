...
public interface CatalogProductIndexPriceCfgOptAgrTmpService {
  public CatalogProductIndexPriceCfgOptAgrTmp find(CatalogProductIndexPriceCfgOptAgrTmpId id);
  /**
   * Select a list of CatalogProductIndexPriceCfgOptAgrTmp based on a given maximum number of
   * returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductIndexPriceCfgOptAgrTmp records.
   */
  public List<CatalogProductIndexPriceCfgOptAgrTmp> select(int maxResult);

  /**
   * Select all CatalogProductIndexPriceCfgOptAgrTmp.
   *
   * @return all CatalogProductIndexPriceCfgOptAgrTmp records.
   */
  public List<CatalogProductIndexPriceCfgOptAgrTmp> selectAll();

  /**
   * Create CatalogProductIndexPriceCfgOptAgrTmp.
   *
   * @param bean The CatalogProductIndexPriceCfgOptAgrTmp.
  ...
  /**
   * Update a CatalogProductIndexPriceCfgOptAgrTmp.
   *
   * @param bean - The CatalogProductIndexPriceCfgOptAgrTmp.
