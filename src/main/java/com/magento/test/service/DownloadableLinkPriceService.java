...
public interface DownloadableLinkPriceService {
  public DownloadableLinkPrice find(java.lang.Integer id);

  /**
   * Select a list of DownloadableLinkPrice based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return DownloadableLinkPrice records.
   */
  public List<DownloadableLinkPrice> select(int maxResult);

  /**
   * Select all DownloadableLinkPrice.
   *
   * @return all DownloadableLinkPrice records.
   */
  public List<DownloadableLinkPrice> selectAll();

  /**
   * Create DownloadableLinkPrice.
   *
   * @param bean The DownloadableLinkPrice.
   * @return The DownloadableLinkPrice.
   */
  public DownloadableLinkPrice create(DownloadableLinkPrice bean);

  /**
   * Update a DownloadableLinkPrice.
   *
   * @param bean - The DownloadableLinkPrice.
