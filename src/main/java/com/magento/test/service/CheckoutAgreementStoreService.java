...
public interface CheckoutAgreementStoreService {
  public CheckoutAgreementStore find(CheckoutAgreementStoreId id);
  /**
   * Select a list of CheckoutAgreementStore based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CheckoutAgreementStore records.
   */
  public List<CheckoutAgreementStore> select(int maxResult);

  /**
   * Select all CheckoutAgreementStore.
   *
   * @return all CheckoutAgreementStore records.
   */
  public List<CheckoutAgreementStore> selectAll();

  /**
   * Create CheckoutAgreementStore.
   *
   * @param bean The CheckoutAgreementStore.
   * @return The CheckoutAgreementStore.
   */
  public CheckoutAgreementStore create(CheckoutAgreementStore bean);

  /**
   * Update a CheckoutAgreementStore.
   *
   * @param bean - The CheckoutAgreementStore.
