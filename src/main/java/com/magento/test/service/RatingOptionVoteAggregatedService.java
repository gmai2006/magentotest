...
public interface RatingOptionVoteAggregatedService {
  public RatingOptionVoteAggregated find(java.lang.Integer id);

  /**
   * Select a list of RatingOptionVoteAggregated based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return RatingOptionVoteAggregated records.
   */
  public List<RatingOptionVoteAggregated> select(int maxResult);

  /**
   * Select all RatingOptionVoteAggregated.
   *
   * @return all RatingOptionVoteAggregated records.
   */
  public List<RatingOptionVoteAggregated> selectAll();

  /**
   * Create RatingOptionVoteAggregated.
   *
   * @param bean The RatingOptionVoteAggregated.
   * @return The RatingOptionVoteAggregated.
   */
  public RatingOptionVoteAggregated create(RatingOptionVoteAggregated bean);

  /**
   * Update a RatingOptionVoteAggregated.
   *
   * @param bean - The RatingOptionVoteAggregated.
