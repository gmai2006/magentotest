...
public interface CatalogProductIndexEavIdxService {
  public CatalogProductIndexEavIdx find(CatalogProductIndexEavIdxId id);
  /**
   * Select a list of CatalogProductIndexEavIdx based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductIndexEavIdx records.
   */
  public List<CatalogProductIndexEavIdx> select(int maxResult);

  /**
   * Select all CatalogProductIndexEavIdx.
   *
   * @return all CatalogProductIndexEavIdx records.
   */
  public List<CatalogProductIndexEavIdx> selectAll();

  /**
   * Create CatalogProductIndexEavIdx.
   *
   * @param bean The CatalogProductIndexEavIdx.
   * @return The CatalogProductIndexEavIdx.
   */
  public CatalogProductIndexEavIdx create(CatalogProductIndexEavIdx bean);

  /**
   * Update a CatalogProductIndexEavIdx.
   *
   * @param bean - The CatalogProductIndexEavIdx.
