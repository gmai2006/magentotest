...
public interface CatalogProductIndexEavDecimalIdxService {
  public CatalogProductIndexEavDecimalIdx find(CatalogProductIndexEavDecimalIdxId id);
  /**
   * Select a list of CatalogProductIndexEavDecimalIdx based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductIndexEavDecimalIdx records.
   */
  public List<CatalogProductIndexEavDecimalIdx> select(int maxResult);

  /**
   * Select all CatalogProductIndexEavDecimalIdx.
   *
   * @return all CatalogProductIndexEavDecimalIdx records.
   */
  public List<CatalogProductIndexEavDecimalIdx> selectAll();

  /**
   * Create CatalogProductIndexEavDecimalIdx.
   *
   * @param bean The CatalogProductIndexEavDecimalIdx.
  ...
  /**
   * Update a CatalogProductIndexEavDecimalIdx.
   *
   * @param bean - The CatalogProductIndexEavDecimalIdx.
