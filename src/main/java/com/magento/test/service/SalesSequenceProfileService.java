...
public interface SalesSequenceProfileService {
  public SalesSequenceProfile find(SalesSequenceProfileId id);
  /**
   * Select a list of SalesSequenceProfile based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesSequenceProfile records.
   */
  public List<SalesSequenceProfile> select(int maxResult);

  /**
   * Select all SalesSequenceProfile.
   *
   * @return all SalesSequenceProfile records.
   */
  public List<SalesSequenceProfile> selectAll();

  /**
   * Create SalesSequenceProfile.
   *
   * @param bean The SalesSequenceProfile.
   * @return The SalesSequenceProfile.
   */
  public SalesSequenceProfile create(SalesSequenceProfile bean);

  /**
   * Update a SalesSequenceProfile.
   *
   * @param bean - The SalesSequenceProfile.
