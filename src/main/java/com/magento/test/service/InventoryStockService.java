...
public interface InventoryStockService {
  ...
  /**
   * Select a list of InventoryStock based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return InventoryStock records.
   */
  public List<InventoryStock> select(int maxResult);

  /**
   * Select all InventoryStock.
   *
   * @return all InventoryStock records.
   */
