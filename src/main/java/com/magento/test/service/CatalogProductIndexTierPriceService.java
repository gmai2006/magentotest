...
public interface CatalogProductIndexTierPriceService {
  public CatalogProductIndexTierPrice find(CatalogProductIndexTierPriceId id);
  /**
   * Select a list of CatalogProductIndexTierPrice based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductIndexTierPrice records.
   */
  public List<CatalogProductIndexTierPrice> select(int maxResult);

  /**
   * Select all CatalogProductIndexTierPrice.
   *
   * @return all CatalogProductIndexTierPrice records.
   */
  public List<CatalogProductIndexTierPrice> selectAll();

  /**
   * Create CatalogProductIndexTierPrice.
   *
   * @param bean The CatalogProductIndexTierPrice.
   * @return The CatalogProductIndexTierPrice.
   */
  public CatalogProductIndexTierPrice create(CatalogProductIndexTierPrice bean);

  /**
   * Update a CatalogProductIndexTierPrice.
   *
   * @param bean - The CatalogProductIndexTierPrice.
