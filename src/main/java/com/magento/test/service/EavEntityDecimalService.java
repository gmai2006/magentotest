...
public interface EavEntityDecimalService {
  public EavEntityDecimal find(EavEntityDecimalId id);
  /**
   * Select a list of EavEntityDecimal based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EavEntityDecimal records.
   */
  public List<EavEntityDecimal> select(int maxResult);

  /**
   * Select all EavEntityDecimal.
   *
   * @return all EavEntityDecimal records.
   */
  public List<EavEntityDecimal> selectAll();

  /**
   * Create EavEntityDecimal.
   *
   * @param bean The EavEntityDecimal.
   * @return The EavEntityDecimal.
   */
  public EavEntityDecimal create(EavEntityDecimal bean);

  /**
   * Update a EavEntityDecimal.
   *
   * @param bean - The EavEntityDecimal.
