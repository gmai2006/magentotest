...
public interface SalesShipmentGridService {
  public SalesShipmentGrid find(SalesShipmentGridId id);
  /**
   * Select a list of SalesShipmentGrid based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesShipmentGrid records.
   */
  public List<SalesShipmentGrid> select(int maxResult);

  /**
   * Select all SalesShipmentGrid.
   *
   * @return all SalesShipmentGrid records.
   */
  public List<SalesShipmentGrid> selectAll();

  /**
   * Create SalesShipmentGrid.
   *
   * @param bean The SalesShipmentGrid.
   * @return The SalesShipmentGrid.
   */
  public SalesShipmentGrid create(SalesShipmentGrid bean);

  /**
   * Update a SalesShipmentGrid.
   *
   * @param bean - The SalesShipmentGrid.
