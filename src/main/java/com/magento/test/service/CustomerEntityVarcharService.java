...
public interface CustomerEntityVarcharService {
  public CustomerEntityVarchar find(CustomerEntityVarcharId id);
  /**
   * Select a list of CustomerEntityVarchar based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CustomerEntityVarchar records.
   */
  public List<CustomerEntityVarchar> select(int maxResult);

  /**
   * Select all CustomerEntityVarchar.
   *
   * @return all CustomerEntityVarchar records.
   */
  public List<CustomerEntityVarchar> selectAll();

  /**
   * Create CustomerEntityVarchar.
   *
   * @param bean The CustomerEntityVarchar.
   * @return The CustomerEntityVarchar.
   */
  public CustomerEntityVarchar create(CustomerEntityVarchar bean);

  /**
   * Update a CustomerEntityVarchar.
   *
   * @param bean - The CustomerEntityVarchar.
