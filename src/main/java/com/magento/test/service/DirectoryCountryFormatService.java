...
public interface DirectoryCountryFormatService {
  public DirectoryCountryFormat find(DirectoryCountryFormatId id);
  /**
   * Select a list of DirectoryCountryFormat based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return DirectoryCountryFormat records.
   */
  public List<DirectoryCountryFormat> select(int maxResult);

  /**
   * Select all DirectoryCountryFormat.
   *
   * @return all DirectoryCountryFormat records.
   */
  public List<DirectoryCountryFormat> selectAll();

  /**
   * Create DirectoryCountryFormat.
   *
   * @param bean The DirectoryCountryFormat.
   * @return The DirectoryCountryFormat.
   */
  public DirectoryCountryFormat create(DirectoryCountryFormat bean);

  /**
   * Update a DirectoryCountryFormat.
   *
   * @param bean - The DirectoryCountryFormat.
