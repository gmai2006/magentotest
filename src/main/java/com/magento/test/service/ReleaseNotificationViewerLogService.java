...
public interface ReleaseNotificationViewerLogService {
  public ReleaseNotificationViewerLog find(ReleaseNotificationViewerLogId id);
  /**
   * Select a list of ReleaseNotificationViewerLog based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return ReleaseNotificationViewerLog records.
   */
  public List<ReleaseNotificationViewerLog> select(int maxResult);

  /**
   * Select all ReleaseNotificationViewerLog.
   *
   * @return all ReleaseNotificationViewerLog records.
   */
  public List<ReleaseNotificationViewerLog> selectAll();

  /**
   * Create ReleaseNotificationViewerLog.
   *
   * @param bean The ReleaseNotificationViewerLog.
   * @return The ReleaseNotificationViewerLog.
   */
  public ReleaseNotificationViewerLog create(ReleaseNotificationViewerLog bean);

  /**
   * Update a ReleaseNotificationViewerLog.
   *
   * @param bean - The ReleaseNotificationViewerLog.
