...
public interface CatalogProductIndexEavDecimalTmpService {
  public CatalogProductIndexEavDecimalTmp find(CatalogProductIndexEavDecimalTmpId id);
  /**
   * Select a list of CatalogProductIndexEavDecimalTmp based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductIndexEavDecimalTmp records.
   */
  public List<CatalogProductIndexEavDecimalTmp> select(int maxResult);

  /**
   * Select all CatalogProductIndexEavDecimalTmp.
   *
   * @return all CatalogProductIndexEavDecimalTmp records.
   */
  public List<CatalogProductIndexEavDecimalTmp> selectAll();

  /**
   * Create CatalogProductIndexEavDecimalTmp.
   *
   * @param bean The CatalogProductIndexEavDecimalTmp.
  ...
  /**
   * Update a CatalogProductIndexEavDecimalTmp.
   *
   * @param bean - The CatalogProductIndexEavDecimalTmp.
