...
public interface CustomerEntityDecimalService {
  public CustomerEntityDecimal find(CustomerEntityDecimalId id);
  /**
   * Select a list of CustomerEntityDecimal based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CustomerEntityDecimal records.
   */
  public List<CustomerEntityDecimal> select(int maxResult);

  /**
   * Select all CustomerEntityDecimal.
   *
   * @return all CustomerEntityDecimal records.
   */
  public List<CustomerEntityDecimal> selectAll();

  /**
   * Create CustomerEntityDecimal.
   *
   * @param bean The CustomerEntityDecimal.
   * @return The CustomerEntityDecimal.
   */
  public CustomerEntityDecimal create(CustomerEntityDecimal bean);

  /**
   * Update a CustomerEntityDecimal.
   *
   * @param bean - The CustomerEntityDecimal.
