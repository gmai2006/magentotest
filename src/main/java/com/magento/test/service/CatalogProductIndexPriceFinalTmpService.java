...
public interface CatalogProductIndexPriceFinalTmpService {
  public CatalogProductIndexPriceFinalTmp find(CatalogProductIndexPriceFinalTmpId id);
  /**
   * Select a list of CatalogProductIndexPriceFinalTmp based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductIndexPriceFinalTmp records.
   */
  public List<CatalogProductIndexPriceFinalTmp> select(int maxResult);

  /**
   * Select all CatalogProductIndexPriceFinalTmp.
   *
   * @return all CatalogProductIndexPriceFinalTmp records.
   */
  public List<CatalogProductIndexPriceFinalTmp> selectAll();

  /**
   * Create CatalogProductIndexPriceFinalTmp.
   *
   * @param bean The CatalogProductIndexPriceFinalTmp.
  ...
  /**
   * Update a CatalogProductIndexPriceFinalTmp.
   *
   * @param bean - The CatalogProductIndexPriceFinalTmp.
