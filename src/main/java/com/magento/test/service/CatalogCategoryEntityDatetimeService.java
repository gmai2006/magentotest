...
public interface CatalogCategoryEntityDatetimeService {
  public CatalogCategoryEntityDatetime find(CatalogCategoryEntityDatetimeId id);
  /**
   * Select a list of CatalogCategoryEntityDatetime based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogCategoryEntityDatetime records.
   */
  public List<CatalogCategoryEntityDatetime> select(int maxResult);

  /**
   * Select all CatalogCategoryEntityDatetime.
   *
   * @return all CatalogCategoryEntityDatetime records.
   */
  public List<CatalogCategoryEntityDatetime> selectAll();

  /**
   * Create CatalogCategoryEntityDatetime.
   *
   * @param bean The CatalogCategoryEntityDatetime.
   * @return The CatalogCategoryEntityDatetime.
   */
  public CatalogCategoryEntityDatetime create(CatalogCategoryEntityDatetime bean);

  /**
   * Update a CatalogCategoryEntityDatetime.
   *
   * @param bean - The CatalogCategoryEntityDatetime.
