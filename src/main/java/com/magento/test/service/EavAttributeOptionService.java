...
public interface EavAttributeOptionService {
  public EavAttributeOption find(java.lang.Integer id);

  /**
   * Select a list of EavAttributeOption based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EavAttributeOption records.
   */
  public List<EavAttributeOption> select(int maxResult);

  /**
   * Select all EavAttributeOption.
   *
   * @return all EavAttributeOption records.
   */
  public List<EavAttributeOption> selectAll();

  /**
   * Create EavAttributeOption.
   *
   * @param bean The EavAttributeOption.
   * @return The EavAttributeOption.
   */
  public EavAttributeOption create(EavAttributeOption bean);

  /**
   * Update a EavAttributeOption.
   *
   * @param bean - The EavAttributeOption.
