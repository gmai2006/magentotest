...
public interface OauthTokenService {
  ...
  /**
   * Select a list of OauthToken based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return OauthToken records.
   */
  public List<OauthToken> select(int maxResult);

  /**
   * Select all OauthToken.
   *
   * @return all OauthToken records.
   */
