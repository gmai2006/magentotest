...
public interface CatalogProductLinkService {
  public CatalogProductLink find(CatalogProductLinkId id);
  /**
   * Select a list of CatalogProductLink based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductLink records.
   */
  public List<CatalogProductLink> select(int maxResult);

  /**
   * Select all CatalogProductLink.
   *
   * @return all CatalogProductLink records.
   */
  public List<CatalogProductLink> selectAll();

  /**
   * Create CatalogProductLink.
   *
   * @param bean The CatalogProductLink.
   * @return The CatalogProductLink.
   */
  public CatalogProductLink create(CatalogProductLink bean);

  /**
   * Update a CatalogProductLink.
   *
   * @param bean - The CatalogProductLink.
