...
public interface AmazonSalesOrderService {
  public AmazonSalesOrder find(AmazonSalesOrderId id);
  /**
   * Select a list of AmazonSalesOrder based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return AmazonSalesOrder records.
   */
  public List<AmazonSalesOrder> select(int maxResult);

  /**
   * Select all AmazonSalesOrder.
   *
   * @return all AmazonSalesOrder records.
   */
  public List<AmazonSalesOrder> selectAll();

  /**
   * Create AmazonSalesOrder.
   *
   * @param bean The AmazonSalesOrder.
   * @return The AmazonSalesOrder.
   */
  public AmazonSalesOrder create(AmazonSalesOrder bean);

  /**
   * Update a AmazonSalesOrder.
   *
   * @param bean - The AmazonSalesOrder.
