...
public interface TaxOrderAggregatedCreatedService {
  public TaxOrderAggregatedCreated find(TaxOrderAggregatedCreatedId id);
  /**
   * Select a list of TaxOrderAggregatedCreated based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return TaxOrderAggregatedCreated records.
   */
  public List<TaxOrderAggregatedCreated> select(int maxResult);

  /**
   * Select all TaxOrderAggregatedCreated.
   *
   * @return all TaxOrderAggregatedCreated records.
   */
  public List<TaxOrderAggregatedCreated> selectAll();

  /**
   * Create TaxOrderAggregatedCreated.
   *
   * @param bean The TaxOrderAggregatedCreated.
   * @return The TaxOrderAggregatedCreated.
   */
  public TaxOrderAggregatedCreated create(TaxOrderAggregatedCreated bean);

  /**
   * Update a TaxOrderAggregatedCreated.
   *
   * @param bean - The TaxOrderAggregatedCreated.
