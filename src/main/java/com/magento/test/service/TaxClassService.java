...
public interface TaxClassService {
  ...
  /**
   * Select a list of TaxClass based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return TaxClass records.
   */
