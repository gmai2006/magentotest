...
public interface CataloginventoryStockService {
  public CataloginventoryStock find(java.lang.Integer id);

  /**
   * Select a list of CataloginventoryStock based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CataloginventoryStock records.
   */
  public List<CataloginventoryStock> select(int maxResult);

  /**
   * Select all CataloginventoryStock.
   *
   * @return all CataloginventoryStock records.
   */
  public List<CataloginventoryStock> selectAll();

  /**
   * Create CataloginventoryStock.
   *
   * @param bean The CataloginventoryStock.
   * @return The CataloginventoryStock.
   */
  public CataloginventoryStock create(CataloginventoryStock bean);

  /**
   * Update a CataloginventoryStock.
   *
   * @param bean - The CataloginventoryStock.
