...
public interface SalesOrderPaymentService {
  ...
  /**
   * Select a list of SalesOrderPayment based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesOrderPayment records.
   */
  public List<SalesOrderPayment> select(int maxResult);

  /**
   * Select all SalesOrderPayment.
   *
   * @return all SalesOrderPayment records.
   */
  public List<SalesOrderPayment> selectAll();

  /**
   * Create SalesOrderPayment.
   *
   * @param bean The SalesOrderPayment.
   * @return The SalesOrderPayment.
   */
  public SalesOrderPayment create(SalesOrderPayment bean);

  /**
   * Update a SalesOrderPayment.
   *
   * @param bean - The SalesOrderPayment.
