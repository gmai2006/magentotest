...
public interface SalesOrderStatusService {
  ...
  /**
   * Select a list of SalesOrderStatus based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesOrderStatus records.
   */
  public List<SalesOrderStatus> select(int maxResult);

  /**
   * Select all SalesOrderStatus.
   *
   * @return all SalesOrderStatus records.
   */
  public List<SalesOrderStatus> selectAll();

  /**
   * Create SalesOrderStatus.
   *
   * @param bean The SalesOrderStatus.
   * @return The SalesOrderStatus.
   */
  public SalesOrderStatus create(SalesOrderStatus bean);

  /**
   * Update a SalesOrderStatus.
   *
   * @param bean - The SalesOrderStatus.
