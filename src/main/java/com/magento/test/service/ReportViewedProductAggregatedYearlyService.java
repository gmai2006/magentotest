...
public interface ReportViewedProductAggregatedYearlyService {
  public ReportViewedProductAggregatedYearly find(ReportViewedProductAggregatedYearlyId id);
  /**
   * Select a list of ReportViewedProductAggregatedYearly based on a given maximum number of
   * returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return ReportViewedProductAggregatedYearly records.
   */
  public List<ReportViewedProductAggregatedYearly> select(int maxResult);

  /**
   * Select all ReportViewedProductAggregatedYearly.
   *
   * @return all ReportViewedProductAggregatedYearly records.
   */
  public List<ReportViewedProductAggregatedYearly> selectAll();

  /**
   * Create ReportViewedProductAggregatedYearly.
   *
   * @param bean The ReportViewedProductAggregatedYearly.
  ...
  /**
   * Update a ReportViewedProductAggregatedYearly.
   *
   * @param bean - The ReportViewedProductAggregatedYearly.
