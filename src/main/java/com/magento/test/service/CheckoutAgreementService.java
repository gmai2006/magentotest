...
public interface CheckoutAgreementService {
  public CheckoutAgreement find(java.lang.Integer id);

  /**
   * Select a list of CheckoutAgreement based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CheckoutAgreement records.
   */
  public List<CheckoutAgreement> select(int maxResult);

  /**
   * Select all CheckoutAgreement.
   *
   * @return all CheckoutAgreement records.
   */
  public List<CheckoutAgreement> selectAll();

  /**
   * Create CheckoutAgreement.
   *
   * @param bean The CheckoutAgreement.
   * @return The CheckoutAgreement.
   */
  public CheckoutAgreement create(CheckoutAgreement bean);

  /**
   * Update a CheckoutAgreement.
   *
   * @param bean - The CheckoutAgreement.
