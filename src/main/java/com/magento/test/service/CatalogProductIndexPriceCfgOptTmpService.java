...
public interface CatalogProductIndexPriceCfgOptTmpService {
  public CatalogProductIndexPriceCfgOptTmp find(CatalogProductIndexPriceCfgOptTmpId id);
  /**
   * Select a list of CatalogProductIndexPriceCfgOptTmp based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductIndexPriceCfgOptTmp records.
   */
  public List<CatalogProductIndexPriceCfgOptTmp> select(int maxResult);

  /**
   * Select all CatalogProductIndexPriceCfgOptTmp.
   *
   * @return all CatalogProductIndexPriceCfgOptTmp records.
   */
  public List<CatalogProductIndexPriceCfgOptTmp> selectAll();

  /**
   * Create CatalogProductIndexPriceCfgOptTmp.
   *
   * @param bean The CatalogProductIndexPriceCfgOptTmp.
  ...
  /**
   * Update a CatalogProductIndexPriceCfgOptTmp.
   *
   * @param bean - The CatalogProductIndexPriceCfgOptTmp.
