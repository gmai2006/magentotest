...
public interface TemandoCollectionPointSearchService {
  public TemandoCollectionPointSearch find(java.lang.Integer id);

  /**
   * Select a list of TemandoCollectionPointSearch based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return TemandoCollectionPointSearch records.
   */
  public List<TemandoCollectionPointSearch> select(int maxResult);

  /**
   * Select all TemandoCollectionPointSearch.
   *
   * @return all TemandoCollectionPointSearch records.
   */
  public List<TemandoCollectionPointSearch> selectAll();

  /**
   * Create TemandoCollectionPointSearch.
   *
   * @param bean The TemandoCollectionPointSearch.
   * @return The TemandoCollectionPointSearch.
   */
  public TemandoCollectionPointSearch create(TemandoCollectionPointSearch bean);

  /**
   * Update a TemandoCollectionPointSearch.
   *
   * @param bean - The TemandoCollectionPointSearch.
