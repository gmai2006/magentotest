...
public interface EmailWishlistService {
  public EmailWishlist find(java.lang.Integer id);

  /**
   * Select a list of EmailWishlist based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return EmailWishlist records.
   */
  public List<EmailWishlist> select(int maxResult);

  /**
   * Select all EmailWishlist.
   *
   * @return all EmailWishlist records.
   */
  public List<EmailWishlist> selectAll();

  /**
   * Create EmailWishlist.
   *
   * @param bean The EmailWishlist.
   * @return The EmailWishlist.
   */
  public EmailWishlist create(EmailWishlist bean);

  /**
   * Update a EmailWishlist.
   *
   * @param bean - The EmailWishlist.
