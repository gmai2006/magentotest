...
public interface CatalogProductSuperAttributeLabelService {
  public CatalogProductSuperAttributeLabel find(CatalogProductSuperAttributeLabelId id);
  /**
   * Select a list of CatalogProductSuperAttributeLabel based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductSuperAttributeLabel records.
   */
  public List<CatalogProductSuperAttributeLabel> select(int maxResult);

  /**
   * Select all CatalogProductSuperAttributeLabel.
   *
   * @return all CatalogProductSuperAttributeLabel records.
   */
  public List<CatalogProductSuperAttributeLabel> selectAll();

  /**
   * Create CatalogProductSuperAttributeLabel.
   *
   * @param bean The CatalogProductSuperAttributeLabel.
  ...
  /**
   * Update a CatalogProductSuperAttributeLabel.
   *
   * @param bean - The CatalogProductSuperAttributeLabel.
