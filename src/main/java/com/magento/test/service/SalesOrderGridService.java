...
public interface SalesOrderGridService {
  public SalesOrderGrid find(SalesOrderGridId id);
  /**
   * Select a list of SalesOrderGrid based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesOrderGrid records.
   */
  public List<SalesOrderGrid> select(int maxResult);

  /**
   * Select all SalesOrderGrid.
   *
   * @return all SalesOrderGrid records.
   */
  public List<SalesOrderGrid> selectAll();

  /**
   * Create SalesOrderGrid.
   *
   * @param bean The SalesOrderGrid.
   * @return The SalesOrderGrid.
   */
  public SalesOrderGrid create(SalesOrderGrid bean);

  /**
   * Update a SalesOrderGrid.
   *
   * @param bean - The SalesOrderGrid.
