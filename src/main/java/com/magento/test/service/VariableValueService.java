...
public interface VariableValueService {
  public VariableValue find(VariableValueId id);
  /**
   * Select a list of VariableValue based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return VariableValue records.
   */
  public List<VariableValue> select(int maxResult);

  /**
   * Select all VariableValue.
   *
   * @return all VariableValue records.
   */
  public List<VariableValue> selectAll();

  /**
   * Create VariableValue.
   *
   * @param bean The VariableValue.
   * @return The VariableValue.
   */
  public VariableValue create(VariableValue bean);

  /**
   * Update a VariableValue.
   *
   * @param bean - The VariableValue.
