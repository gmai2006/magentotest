...
public interface AdminPasswordsService {
  public AdminPasswords find(java.lang.Integer id);

  /**
   * Select a list of AdminPasswords based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return AdminPasswords records.
   */
  public List<AdminPasswords> select(int maxResult);

  /**
   * Select all AdminPasswords.
   *
   * @return all AdminPasswords records.
   */
  public List<AdminPasswords> selectAll();

  /**
   * Create AdminPasswords.
   *
   * @param bean The AdminPasswords.
   * @return The AdminPasswords.
   */
  public AdminPasswords create(AdminPasswords bean);

  /**
   * Update a AdminPasswords.
   *
   * @param bean - The AdminPasswords.
