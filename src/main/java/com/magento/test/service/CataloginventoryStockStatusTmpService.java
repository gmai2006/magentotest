...
public interface CataloginventoryStockStatusTmpService {
  public CataloginventoryStockStatusTmp find(CataloginventoryStockStatusTmpId id);
  /**
   * Select a list of CataloginventoryStockStatusTmp based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CataloginventoryStockStatusTmp records.
   */
  public List<CataloginventoryStockStatusTmp> select(int maxResult);

  /**
   * Select all CataloginventoryStockStatusTmp.
   *
   * @return all CataloginventoryStockStatusTmp records.
   */
  public List<CataloginventoryStockStatusTmp> selectAll();

  /**
   * Create CataloginventoryStockStatusTmp.
   *
   * @param bean The CataloginventoryStockStatusTmp.
  ...
  /**
   * Update a CataloginventoryStockStatusTmp.
   *
   * @param bean - The CataloginventoryStockStatusTmp.
