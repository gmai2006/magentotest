...
public interface SalesOrderStatusHistoryService {
  public SalesOrderStatusHistory find(java.lang.Integer id);

  /**
   * Select a list of SalesOrderStatusHistory based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesOrderStatusHistory records.
   */
  public List<SalesOrderStatusHistory> select(int maxResult);

  /**
   * Select all SalesOrderStatusHistory.
   *
   * @return all SalesOrderStatusHistory records.
   */
  public List<SalesOrderStatusHistory> selectAll();

  /**
   * Create SalesOrderStatusHistory.
   *
   * @param bean The SalesOrderStatusHistory.
   * @return The SalesOrderStatusHistory.
   */
  public SalesOrderStatusHistory create(SalesOrderStatusHistory bean);

  /**
   * Update a SalesOrderStatusHistory.
   *
   * @param bean - The SalesOrderStatusHistory.
