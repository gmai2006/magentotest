...
public interface DownloadableSampleService {
  public DownloadableSample find(java.lang.Integer id);

  /**
   * Select a list of DownloadableSample based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return DownloadableSample records.
   */
  public List<DownloadableSample> select(int maxResult);

  /**
   * Select all DownloadableSample.
   *
   * @return all DownloadableSample records.
   */
  public List<DownloadableSample> selectAll();

  /**
   * Create DownloadableSample.
   *
   * @param bean The DownloadableSample.
   * @return The DownloadableSample.
   */
  public DownloadableSample create(DownloadableSample bean);

  /**
   * Update a DownloadableSample.
   *
   * @param bean - The DownloadableSample.
