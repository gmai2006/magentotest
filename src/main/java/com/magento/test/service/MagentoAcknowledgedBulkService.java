...
public interface MagentoAcknowledgedBulkService {
  public MagentoAcknowledgedBulk find(MagentoAcknowledgedBulkId id);
  /**
   * Select a list of MagentoAcknowledgedBulk based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return MagentoAcknowledgedBulk records.
   */
  public List<MagentoAcknowledgedBulk> select(int maxResult);

  /**
   * Select all MagentoAcknowledgedBulk.
   *
   * @return all MagentoAcknowledgedBulk records.
   */
  public List<MagentoAcknowledgedBulk> selectAll();

  /**
   * Create MagentoAcknowledgedBulk.
   *
   * @param bean The MagentoAcknowledgedBulk.
   * @return The MagentoAcknowledgedBulk.
   */
  public MagentoAcknowledgedBulk create(MagentoAcknowledgedBulk bean);

  /**
   * Update a MagentoAcknowledgedBulk.
   *
   * @param bean - The MagentoAcknowledgedBulk.
