...
public interface SignifydCaseService {
  public SignifydCase find(SignifydCaseId id);
  /**
   * Select a list of SignifydCase based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SignifydCase records.
   */
  public List<SignifydCase> select(int maxResult);

  /**
   * Select all SignifydCase.
   *
   * @return all SignifydCase records.
   */
