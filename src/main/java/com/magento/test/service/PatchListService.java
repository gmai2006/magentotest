...
public interface PatchListService {
  public PatchList find(java.lang.Integer id);

  /**
   * Select a list of PatchList based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return PatchList records.
   */
  public List<PatchList> select(int maxResult);

  /**
   * Select all PatchList.
   *
   * @return all PatchList records.
   */
