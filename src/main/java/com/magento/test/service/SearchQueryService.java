...
public interface SearchQueryService {
  ...
  /**
   * Select a list of SearchQuery based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SearchQuery records.
   */
  public List<SearchQuery> select(int maxResult);

  /**
   * Select all SearchQuery.
   *
   * @return all SearchQuery records.
   */
