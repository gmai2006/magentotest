...
public interface SalesruleCouponUsageService {
  public SalesruleCouponUsage find(SalesruleCouponUsageId id);
  /**
   * Select a list of SalesruleCouponUsage based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesruleCouponUsage records.
   */
  public List<SalesruleCouponUsage> select(int maxResult);

  /**
   * Select all SalesruleCouponUsage.
   *
   * @return all SalesruleCouponUsage records.
   */
  public List<SalesruleCouponUsage> selectAll();

  /**
   * Create SalesruleCouponUsage.
   *
   * @param bean The SalesruleCouponUsage.
   * @return The SalesruleCouponUsage.
   */
  public SalesruleCouponUsage create(SalesruleCouponUsage bean);

  /**
   * Update a SalesruleCouponUsage.
   *
   * @param bean - The SalesruleCouponUsage.
