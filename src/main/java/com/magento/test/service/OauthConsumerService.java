...
public interface OauthConsumerService {
  ...
  /**
   * Select a list of OauthConsumer based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return OauthConsumer records.
   */
  public List<OauthConsumer> select(int maxResult);

  /**
   * Select all OauthConsumer.
   *
   * @return all OauthConsumer records.
   */
