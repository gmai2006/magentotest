...
public interface CatalogCategoryEntityVarcharService {
  public CatalogCategoryEntityVarchar find(CatalogCategoryEntityVarcharId id);
  /**
   * Select a list of CatalogCategoryEntityVarchar based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogCategoryEntityVarchar records.
   */
  public List<CatalogCategoryEntityVarchar> select(int maxResult);

  /**
   * Select all CatalogCategoryEntityVarchar.
   *
   * @return all CatalogCategoryEntityVarchar records.
   */
  public List<CatalogCategoryEntityVarchar> selectAll();

  /**
   * Create CatalogCategoryEntityVarchar.
   *
   * @param bean The CatalogCategoryEntityVarchar.
   * @return The CatalogCategoryEntityVarchar.
   */
  public CatalogCategoryEntityVarchar create(CatalogCategoryEntityVarchar bean);

  /**
   * Update a CatalogCategoryEntityVarchar.
   *
   * @param bean - The CatalogCategoryEntityVarchar.
