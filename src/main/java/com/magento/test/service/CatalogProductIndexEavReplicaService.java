...
public interface CatalogProductIndexEavReplicaService {
  public CatalogProductIndexEavReplica find(CatalogProductIndexEavReplicaId id);
  /**
   * Select a list of CatalogProductIndexEavReplica based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductIndexEavReplica records.
   */
  public List<CatalogProductIndexEavReplica> select(int maxResult);

  /**
   * Select all CatalogProductIndexEavReplica.
   *
   * @return all CatalogProductIndexEavReplica records.
   */
  public List<CatalogProductIndexEavReplica> selectAll();

  /**
   * Create CatalogProductIndexEavReplica.
   *
   * @param bean The CatalogProductIndexEavReplica.
   * @return The CatalogProductIndexEavReplica.
   */
  public CatalogProductIndexEavReplica create(CatalogProductIndexEavReplica bean);

  /**
   * Update a CatalogProductIndexEavReplica.
   *
   * @param bean - The CatalogProductIndexEavReplica.
