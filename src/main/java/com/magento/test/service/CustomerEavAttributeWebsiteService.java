...
public interface CustomerEavAttributeWebsiteService {
  public CustomerEavAttributeWebsite find(CustomerEavAttributeWebsiteId id);
  /**
   * Select a list of CustomerEavAttributeWebsite based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CustomerEavAttributeWebsite records.
   */
  public List<CustomerEavAttributeWebsite> select(int maxResult);

  /**
   * Select all CustomerEavAttributeWebsite.
   *
   * @return all CustomerEavAttributeWebsite records.
   */
  public List<CustomerEavAttributeWebsite> selectAll();

  /**
   * Create CustomerEavAttributeWebsite.
   *
   * @param bean The CustomerEavAttributeWebsite.
   * @return The CustomerEavAttributeWebsite.
   */
  public CustomerEavAttributeWebsite create(CustomerEavAttributeWebsite bean);

  /**
   * Update a CustomerEavAttributeWebsite.
   *
   * @param bean - The CustomerEavAttributeWebsite.
