...
public interface CustomerAddressEntityService {
  public CustomerAddressEntity find(java.lang.Integer id);

  /**
   * Select a list of CustomerAddressEntity based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CustomerAddressEntity records.
   */
  public List<CustomerAddressEntity> select(int maxResult);

  /**
   * Select all CustomerAddressEntity.
   *
   * @return all CustomerAddressEntity records.
   */
  public List<CustomerAddressEntity> selectAll();

  /**
   * Create CustomerAddressEntity.
   *
   * @param bean The CustomerAddressEntity.
   * @return The CustomerAddressEntity.
   */
  public CustomerAddressEntity create(CustomerAddressEntity bean);

  /**
   * Update a CustomerAddressEntity.
   *
   * @param bean - The CustomerAddressEntity.
