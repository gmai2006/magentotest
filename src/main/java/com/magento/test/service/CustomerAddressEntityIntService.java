...
public interface CustomerAddressEntityIntService {
  public CustomerAddressEntityInt find(CustomerAddressEntityIntId id);
  /**
   * Select a list of CustomerAddressEntityInt based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CustomerAddressEntityInt records.
   */
  public List<CustomerAddressEntityInt> select(int maxResult);

  /**
   * Select all CustomerAddressEntityInt.
   *
   * @return all CustomerAddressEntityInt records.
   */
  public List<CustomerAddressEntityInt> selectAll();

  /**
   * Create CustomerAddressEntityInt.
   *
   * @param bean The CustomerAddressEntityInt.
   * @return The CustomerAddressEntityInt.
   */
  public CustomerAddressEntityInt create(CustomerAddressEntityInt bean);

  /**
   * Update a CustomerAddressEntityInt.
   *
   * @param bean - The CustomerAddressEntityInt.
