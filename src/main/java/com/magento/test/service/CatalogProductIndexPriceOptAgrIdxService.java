...
public interface CatalogProductIndexPriceOptAgrIdxService {
  public CatalogProductIndexPriceOptAgrIdx find(CatalogProductIndexPriceOptAgrIdxId id);
  /**
   * Select a list of CatalogProductIndexPriceOptAgrIdx based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductIndexPriceOptAgrIdx records.
   */
  public List<CatalogProductIndexPriceOptAgrIdx> select(int maxResult);

  /**
   * Select all CatalogProductIndexPriceOptAgrIdx.
   *
   * @return all CatalogProductIndexPriceOptAgrIdx records.
   */
  public List<CatalogProductIndexPriceOptAgrIdx> selectAll();

  /**
   * Create CatalogProductIndexPriceOptAgrIdx.
   *
   * @param bean The CatalogProductIndexPriceOptAgrIdx.
  ...
  /**
   * Update a CatalogProductIndexPriceOptAgrIdx.
   *
   * @param bean - The CatalogProductIndexPriceOptAgrIdx.
