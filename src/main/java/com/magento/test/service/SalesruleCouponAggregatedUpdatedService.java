...
public interface SalesruleCouponAggregatedUpdatedService {
  public SalesruleCouponAggregatedUpdated find(SalesruleCouponAggregatedUpdatedId id);
  /**
   * Select a list of SalesruleCouponAggregatedUpdated based on a given maximum number of returning
   * records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return SalesruleCouponAggregatedUpdated records.
   */
  public List<SalesruleCouponAggregatedUpdated> select(int maxResult);

  /**
   * Select all SalesruleCouponAggregatedUpdated.
   *
   * @return all SalesruleCouponAggregatedUpdated records.
   */
  public List<SalesruleCouponAggregatedUpdated> selectAll();

  /**
   * Create SalesruleCouponAggregatedUpdated.
   *
   * @param bean The SalesruleCouponAggregatedUpdated.
  ...
  /**
   * Update a SalesruleCouponAggregatedUpdated.
   *
   * @param bean - The SalesruleCouponAggregatedUpdated.
