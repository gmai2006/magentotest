...
public interface CacheTagService {
  ...
  /**
   * Select a list of CacheTag based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CacheTag records.
   */
