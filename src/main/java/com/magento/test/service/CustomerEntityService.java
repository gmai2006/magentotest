...
public interface CustomerEntityService {
  ...
  /**
   * Select a list of CustomerEntity based on a given maximum number of returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CustomerEntity records.
   */
  public List<CustomerEntity> select(int maxResult);

  /**
   * Select all CustomerEntity.
   *
   * @return all CustomerEntity records.
   */
