...
public interface CatalogProductIndexPriceBundleSelTmpService {
  public CatalogProductIndexPriceBundleSelTmp find(CatalogProductIndexPriceBundleSelTmpId id);
  /**
   * Select a list of CatalogProductIndexPriceBundleSelTmp based on a given maximum number of
   * returning records.
   *
   * @param maxResult : a specified maximum number of returned records.
   * @return CatalogProductIndexPriceBundleSelTmp records.
   */
  public List<CatalogProductIndexPriceBundleSelTmp> select(int maxResult);

  /**
   * Select all CatalogProductIndexPriceBundleSelTmp.
   *
   * @return all CatalogProductIndexPriceBundleSelTmp records.
   */
  public List<CatalogProductIndexPriceBundleSelTmp> selectAll();

  /**
   * Create CatalogProductIndexPriceBundleSelTmp.
   *
   * @param bean The CatalogProductIndexPriceBundleSelTmp.
  ...
  /**
   * Update a CatalogProductIndexPriceBundleSelTmp.
   *
   * @param bean - The CatalogProductIndexPriceBundleSelTmp.
