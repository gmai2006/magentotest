...
// @Stateless
@Named("SalesBestsellersAggregatedYearlyHandler")
public class SalesBestsellersAggregatedYearlyHandler
    extends DelimiterFileHandler<SalesBestsellersAggregatedYearly> {

  @Inject
  @Named("DefaultJpaDao")
  public SalesBestsellersAggregatedYearlyHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected SalesBestsellersAggregatedYearly parseLine(List<String> headers, List<String> tokens) {
    SalesBestsellersAggregatedYearly record = new SalesBestsellersAggregatedYearly();
