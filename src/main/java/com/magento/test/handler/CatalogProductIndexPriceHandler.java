...
// @Stateless
@Named("CatalogProductIndexPriceHandler")
public class CatalogProductIndexPriceHandler
    extends DelimiterFileHandler<CatalogProductIndexPrice> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductIndexPriceHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductIndexPrice parseLine(List<String> headers, List<String> tokens) {
    CatalogProductIndexPrice record = new CatalogProductIndexPrice();
