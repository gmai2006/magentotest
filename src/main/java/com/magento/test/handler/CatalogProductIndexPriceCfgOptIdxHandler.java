...
// @Stateless
@Named("CatalogProductIndexPriceCfgOptIdxHandler")
public class CatalogProductIndexPriceCfgOptIdxHandler
    extends DelimiterFileHandler<CatalogProductIndexPriceCfgOptIdx> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductIndexPriceCfgOptIdxHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductIndexPriceCfgOptIdx parseLine(List<String> headers, List<String> tokens) {
    CatalogProductIndexPriceCfgOptIdx record = new CatalogProductIndexPriceCfgOptIdx();
