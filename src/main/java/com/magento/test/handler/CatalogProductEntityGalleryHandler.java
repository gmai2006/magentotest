...
// @Stateless
@Named("CatalogProductEntityGalleryHandler")
public class CatalogProductEntityGalleryHandler
    extends DelimiterFileHandler<CatalogProductEntityGallery> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductEntityGalleryHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductEntityGallery parseLine(List<String> headers, List<String> tokens) {
    CatalogProductEntityGallery record = new CatalogProductEntityGallery();
