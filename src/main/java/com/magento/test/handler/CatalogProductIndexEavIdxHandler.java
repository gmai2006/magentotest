...
// @Stateless
@Named("CatalogProductIndexEavIdxHandler")
public class CatalogProductIndexEavIdxHandler
    extends DelimiterFileHandler<CatalogProductIndexEavIdx> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductIndexEavIdxHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductIndexEavIdx parseLine(List<String> headers, List<String> tokens) {
    CatalogProductIndexEavIdx record = new CatalogProductIndexEavIdx();
