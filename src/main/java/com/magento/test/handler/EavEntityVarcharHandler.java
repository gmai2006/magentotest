...
// @Stateless
@Named("EavEntityVarcharHandler")
public class EavEntityVarcharHandler extends DelimiterFileHandler<EavEntityVarchar> {

  @Inject
  @Named("DefaultJpaDao")
  public EavEntityVarcharHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected EavEntityVarchar parseLine(List<String> headers, List<String> tokens) {
    EavEntityVarchar record = new EavEntityVarchar();
