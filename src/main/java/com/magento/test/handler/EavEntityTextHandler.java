...
// @Stateless
@Named("EavEntityTextHandler")
public class EavEntityTextHandler extends DelimiterFileHandler<EavEntityText> {

  @Inject
  @Named("DefaultJpaDao")
  public EavEntityTextHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected EavEntityText parseLine(List<String> headers, List<String> tokens) {
    EavEntityText record = new EavEntityText();
