...
// @Stateless
@Named("CatalogProductIndexEavHandler")
public class CatalogProductIndexEavHandler extends DelimiterFileHandler<CatalogProductIndexEav> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductIndexEavHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductIndexEav parseLine(List<String> headers, List<String> tokens) {
    CatalogProductIndexEav record = new CatalogProductIndexEav();
