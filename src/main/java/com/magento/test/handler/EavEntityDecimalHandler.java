...
// @Stateless
@Named("EavEntityDecimalHandler")
public class EavEntityDecimalHandler extends DelimiterFileHandler<EavEntityDecimal> {

  @Inject
  @Named("DefaultJpaDao")
  public EavEntityDecimalHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected EavEntityDecimal parseLine(List<String> headers, List<String> tokens) {
    EavEntityDecimal record = new EavEntityDecimal();
