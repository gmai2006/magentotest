...
// @Stateless
@Named("CatalogProductEntityIntHandler")
public class CatalogProductEntityIntHandler extends DelimiterFileHandler<CatalogProductEntityInt> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductEntityIntHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductEntityInt parseLine(List<String> headers, List<String> tokens) {
    CatalogProductEntityInt record = new CatalogProductEntityInt();
