...
// @Stateless
@Named("CatalogProductIndexPriceDownlodIdxHandler")
public class CatalogProductIndexPriceDownlodIdxHandler
    extends DelimiterFileHandler<CatalogProductIndexPriceDownlodIdx> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductIndexPriceDownlodIdxHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductIndexPriceDownlodIdx parseLine(
      List<String> headers, List<String> tokens) {
    CatalogProductIndexPriceDownlodIdx record = new CatalogProductIndexPriceDownlodIdx();
