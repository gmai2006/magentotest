...
// @Stateless
@Named("CatalogruleProductReplicaHandler")
public class CatalogruleProductReplicaHandler
    extends DelimiterFileHandler<CatalogruleProductReplica> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogruleProductReplicaHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogruleProductReplica parseLine(List<String> headers, List<String> tokens) {
    CatalogruleProductReplica record = new CatalogruleProductReplica();
