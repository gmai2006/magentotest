...
// @Stateless
@Named("CatalogProductIndexPriceOptIdxHandler")
public class CatalogProductIndexPriceOptIdxHandler
    extends DelimiterFileHandler<CatalogProductIndexPriceOptIdx> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductIndexPriceOptIdxHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductIndexPriceOptIdx parseLine(List<String> headers, List<String> tokens) {
    CatalogProductIndexPriceOptIdx record = new CatalogProductIndexPriceOptIdx();
