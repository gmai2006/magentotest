...
// @Stateless
@Named("TemandoOrderPickupLocationHandler")
public class TemandoOrderPickupLocationHandler
    extends DelimiterFileHandler<TemandoOrderPickupLocation> {

  @Inject
  @Named("DefaultJpaDao")
  public TemandoOrderPickupLocationHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected TemandoOrderPickupLocation parseLine(List<String> headers, List<String> tokens) {
    TemandoOrderPickupLocation record = new TemandoOrderPickupLocation();
