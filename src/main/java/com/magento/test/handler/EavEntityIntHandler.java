...
// @Stateless
@Named("EavEntityIntHandler")
public class EavEntityIntHandler extends DelimiterFileHandler<EavEntityInt> {

  @Inject
  @Named("DefaultJpaDao")
  public EavEntityIntHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected EavEntityInt parseLine(List<String> headers, List<String> tokens) {
    EavEntityInt record = new EavEntityInt();
