...
// @Stateless
@Named("AdminUserSessionHandler")
public class AdminUserSessionHandler extends DelimiterFileHandler<AdminUserSession> {

  @Inject
  @Named("DefaultJpaDao")
  public AdminUserSessionHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected AdminUserSession parseLine(List<String> headers, List<String> tokens) {
    AdminUserSession record = new AdminUserSession();
