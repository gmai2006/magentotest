...
// @Stateless
@Named("CatalogProductIndexPriceCfgOptTmpHandler")
public class CatalogProductIndexPriceCfgOptTmpHandler
    extends DelimiterFileHandler<CatalogProductIndexPriceCfgOptTmp> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductIndexPriceCfgOptTmpHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductIndexPriceCfgOptTmp parseLine(List<String> headers, List<String> tokens) {
    CatalogProductIndexPriceCfgOptTmp record = new CatalogProductIndexPriceCfgOptTmp();
