...
// @Stateless
@Named("CatalogCategoryEntityHandler")
public class CatalogCategoryEntityHandler extends DelimiterFileHandler<CatalogCategoryEntity> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogCategoryEntityHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogCategoryEntity parseLine(List<String> headers, List<String> tokens) {
    CatalogCategoryEntity record = new CatalogCategoryEntity();
    for (int i = 0; i < tokens.size(); i++) {
      switch (headers.get(i)) {
        ...
        case "position":
          ...
          break;
        case "level":
          record.setLevel(java.lang.Integer.valueOf((tokens.get(i))));
          break;
        case "childrenCount":
          record.setChildrenCount(java.lang.Integer.valueOf((tokens.get(i))));
          break;
