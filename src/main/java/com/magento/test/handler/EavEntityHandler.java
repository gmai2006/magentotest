...
// @Stateless
@Named("EavEntityHandler")
public class EavEntityHandler extends DelimiterFileHandler<EavEntity> {

  @Inject
  @Named("DefaultJpaDao")
  public EavEntityHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected EavEntity parseLine(List<String> headers, List<String> tokens) {
    EavEntity record = new EavEntity();
