...
// @Stateless
@Named("SalesInvoiceGridHandler")
public class SalesInvoiceGridHandler extends DelimiterFileHandler<SalesInvoiceGrid> {

  @Inject
  @Named("DefaultJpaDao")
  public SalesInvoiceGridHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected SalesInvoiceGrid parseLine(List<String> headers, List<String> tokens) {
    SalesInvoiceGrid record = new SalesInvoiceGrid();
