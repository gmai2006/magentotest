...
// @Stateless
@Named("CatalogProductIndexPriceReplicaHandler")
public class CatalogProductIndexPriceReplicaHandler
    extends DelimiterFileHandler<CatalogProductIndexPriceReplica> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductIndexPriceReplicaHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductIndexPriceReplica parseLine(List<String> headers, List<String> tokens) {
    CatalogProductIndexPriceReplica record = new CatalogProductIndexPriceReplica();
