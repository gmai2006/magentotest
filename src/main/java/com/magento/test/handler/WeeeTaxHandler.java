...
// @Stateless
@Named("WeeeTaxHandler")
public class WeeeTaxHandler extends DelimiterFileHandler<WeeeTax> {

  @Inject
  @Named("DefaultJpaDao")
  public WeeeTaxHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected WeeeTax parseLine(List<String> headers, List<String> tokens) {
    WeeeTax record = new WeeeTax();
