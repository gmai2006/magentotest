...
// @Stateless
@Named("CatalogProductIndexPriceFinalIdxHandler")
public class CatalogProductIndexPriceFinalIdxHandler
    extends DelimiterFileHandler<CatalogProductIndexPriceFinalIdx> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductIndexPriceFinalIdxHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductIndexPriceFinalIdx parseLine(List<String> headers, List<String> tokens) {
    CatalogProductIndexPriceFinalIdx record = new CatalogProductIndexPriceFinalIdx();
