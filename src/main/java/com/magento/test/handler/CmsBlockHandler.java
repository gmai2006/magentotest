...
// @Stateless
@Named("CmsBlockHandler")
public class CmsBlockHandler extends DelimiterFileHandler<CmsBlock> {

  @Inject
  @Named("DefaultJpaDao")
  public CmsBlockHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CmsBlock parseLine(List<String> headers, List<String> tokens) {
    CmsBlock record = new CmsBlock();
