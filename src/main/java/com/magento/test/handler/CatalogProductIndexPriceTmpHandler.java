...
// @Stateless
@Named("CatalogProductIndexPriceTmpHandler")
public class CatalogProductIndexPriceTmpHandler
    extends DelimiterFileHandler<CatalogProductIndexPriceTmp> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductIndexPriceTmpHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductIndexPriceTmp parseLine(List<String> headers, List<String> tokens) {
    CatalogProductIndexPriceTmp record = new CatalogProductIndexPriceTmp();
