...
// @Stateless
@Named("CatalogCategoryEntityIntHandler")
public class CatalogCategoryEntityIntHandler
    extends DelimiterFileHandler<CatalogCategoryEntityInt> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogCategoryEntityIntHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogCategoryEntityInt parseLine(List<String> headers, List<String> tokens) {
    CatalogCategoryEntityInt record = new CatalogCategoryEntityInt();
