...
// @Stateless
@Named("SalesCreditmemoItemHandler")
public class SalesCreditmemoItemHandler extends DelimiterFileHandler<SalesCreditmemoItem> {

  @Inject
  @Named("DefaultJpaDao")
  public SalesCreditmemoItemHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected SalesCreditmemoItem parseLine(List<String> headers, List<String> tokens) {
    SalesCreditmemoItem record = new SalesCreditmemoItem();
