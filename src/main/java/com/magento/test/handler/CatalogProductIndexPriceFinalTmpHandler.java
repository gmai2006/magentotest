...
// @Stateless
@Named("CatalogProductIndexPriceFinalTmpHandler")
public class CatalogProductIndexPriceFinalTmpHandler
    extends DelimiterFileHandler<CatalogProductIndexPriceFinalTmp> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductIndexPriceFinalTmpHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductIndexPriceFinalTmp parseLine(List<String> headers, List<String> tokens) {
    CatalogProductIndexPriceFinalTmp record = new CatalogProductIndexPriceFinalTmp();
