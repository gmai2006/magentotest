...
// @Stateless
@Named("CatalogProductIndexPriceBundleSelIdxHandler")
public class CatalogProductIndexPriceBundleSelIdxHandler
    extends DelimiterFileHandler<CatalogProductIndexPriceBundleSelIdx> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductIndexPriceBundleSelIdxHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductIndexPriceBundleSelIdx parseLine(
      List<String> headers, List<String> tokens) {
    CatalogProductIndexPriceBundleSelIdx record = new CatalogProductIndexPriceBundleSelIdx();
