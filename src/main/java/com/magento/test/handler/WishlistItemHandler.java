...
// @Stateless
@Named("WishlistItemHandler")
public class WishlistItemHandler extends DelimiterFileHandler<WishlistItem> {

  @Inject
  @Named("DefaultJpaDao")
  public WishlistItemHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected WishlistItem parseLine(List<String> headers, List<String> tokens) {
