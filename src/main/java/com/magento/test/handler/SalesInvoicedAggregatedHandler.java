...
// @Stateless
@Named("SalesInvoicedAggregatedHandler")
public class SalesInvoicedAggregatedHandler extends DelimiterFileHandler<SalesInvoicedAggregated> {

  @Inject
  @Named("DefaultJpaDao")
  public SalesInvoicedAggregatedHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected SalesInvoicedAggregated parseLine(List<String> headers, List<String> tokens) {
    SalesInvoicedAggregated record = new SalesInvoicedAggregated();
