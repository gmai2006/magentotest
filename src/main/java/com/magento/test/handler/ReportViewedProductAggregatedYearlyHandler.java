...
// @Stateless
@Named("ReportViewedProductAggregatedYearlyHandler")
public class ReportViewedProductAggregatedYearlyHandler
    extends DelimiterFileHandler<ReportViewedProductAggregatedYearly> {

  @Inject
  @Named("DefaultJpaDao")
  public ReportViewedProductAggregatedYearlyHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected ReportViewedProductAggregatedYearly parseLine(
      List<String> headers, List<String> tokens) {
    ReportViewedProductAggregatedYearly record = new ReportViewedProductAggregatedYearly();
