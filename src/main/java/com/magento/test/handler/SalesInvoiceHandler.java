...
// @Stateless
@Named("SalesInvoiceHandler")
public class SalesInvoiceHandler extends DelimiterFileHandler<SalesInvoice> {

  @Inject
  @Named("DefaultJpaDao")
  public SalesInvoiceHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected SalesInvoice parseLine(List<String> headers, List<String> tokens) {
    ...
    for (int i = 0; i < tokens.size(); i++) {
      switch (headers.get(i)) {
        ...
        case "billingAddressId":
          ...
          break;
        case "isUsedForRefund":
          record.setIsUsedForRefund(java.lang.Integer.valueOf((tokens.get(i))));
          break;
        case "orderId":
        ...
        case "sendEmail":
          ...
          break;
        case "canVoidFlag":
          record.setCanVoidFlag(java.lang.Integer.valueOf((tokens.get(i))));
          break;
        case "state":
