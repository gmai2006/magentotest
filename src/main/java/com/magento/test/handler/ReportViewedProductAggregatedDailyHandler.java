...
// @Stateless
@Named("ReportViewedProductAggregatedDailyHandler")
public class ReportViewedProductAggregatedDailyHandler
    extends DelimiterFileHandler<ReportViewedProductAggregatedDaily> {

  @Inject
  @Named("DefaultJpaDao")
  public ReportViewedProductAggregatedDailyHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected ReportViewedProductAggregatedDaily parseLine(
      List<String> headers, List<String> tokens) {
    ReportViewedProductAggregatedDaily record = new ReportViewedProductAggregatedDaily();
