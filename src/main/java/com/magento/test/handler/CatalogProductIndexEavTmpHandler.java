...
// @Stateless
@Named("CatalogProductIndexEavTmpHandler")
public class CatalogProductIndexEavTmpHandler
    extends DelimiterFileHandler<CatalogProductIndexEavTmp> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductIndexEavTmpHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductIndexEavTmp parseLine(List<String> headers, List<String> tokens) {
    CatalogProductIndexEavTmp record = new CatalogProductIndexEavTmp();
