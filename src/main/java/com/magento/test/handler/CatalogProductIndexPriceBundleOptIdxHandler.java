...
// @Stateless
@Named("CatalogProductIndexPriceBundleOptIdxHandler")
public class CatalogProductIndexPriceBundleOptIdxHandler
    extends DelimiterFileHandler<CatalogProductIndexPriceBundleOptIdx> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductIndexPriceBundleOptIdxHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductIndexPriceBundleOptIdx parseLine(
      List<String> headers, List<String> tokens) {
    CatalogProductIndexPriceBundleOptIdx record = new CatalogProductIndexPriceBundleOptIdx();
