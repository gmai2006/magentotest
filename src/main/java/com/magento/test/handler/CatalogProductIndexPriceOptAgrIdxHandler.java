...
// @Stateless
@Named("CatalogProductIndexPriceOptAgrIdxHandler")
public class CatalogProductIndexPriceOptAgrIdxHandler
    extends DelimiterFileHandler<CatalogProductIndexPriceOptAgrIdx> {

  @Inject
  @Named("DefaultJpaDao")
  public CatalogProductIndexPriceOptAgrIdxHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CatalogProductIndexPriceOptAgrIdx parseLine(List<String> headers, List<String> tokens) {
    CatalogProductIndexPriceOptAgrIdx record = new CatalogProductIndexPriceOptAgrIdx();
