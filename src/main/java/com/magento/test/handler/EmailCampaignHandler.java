...
// @Stateless
@Named("EmailCampaignHandler")
public class EmailCampaignHandler extends DelimiterFileHandler<EmailCampaign> {

  @Inject
  @Named("DefaultJpaDao")
  public EmailCampaignHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected EmailCampaign parseLine(List<String> headers, List<String> tokens) {
    EmailCampaign record = new EmailCampaign();
    for (int i = 0; i < tokens.size(); i++) {
      switch (headers.get(i)) {
        case "id":
          ...
          break;
        case "campaignId":
          record.setCampaignId(java.lang.Integer.valueOf((tokens.get(i))));
          break;
        case "email":
        ...
        case "customerId":
          ...
          break;
        case "sentAt":
          record.setSentAt(new java.sql.Timestamp(parseTime(tokens.get(i))));
          break;
        ...
        case "storeId":
          ...
          break;
        case "eventName":
          record.setEventName(tokens.get(i));
          break;

        case "sendId":
          record.setSendId(tokens.get(i));
          break;

        case "sendStatus":
          record.setSendStatus(java.lang.Integer.valueOf((tokens.get(i))));
          break;
        case "createdAt":
