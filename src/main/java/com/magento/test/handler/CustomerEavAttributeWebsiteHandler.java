...
// @Stateless
@Named("CustomerEavAttributeWebsiteHandler")
public class CustomerEavAttributeWebsiteHandler
    extends DelimiterFileHandler<CustomerEavAttributeWebsite> {

  @Inject
  @Named("DefaultJpaDao")
  public CustomerEavAttributeWebsiteHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected CustomerEavAttributeWebsite parseLine(List<String> headers, List<String> tokens) {
    CustomerEavAttributeWebsite record = new CustomerEavAttributeWebsite();
