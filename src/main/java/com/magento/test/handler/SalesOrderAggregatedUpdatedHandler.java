...
// @Stateless
@Named("SalesOrderAggregatedUpdatedHandler")
public class SalesOrderAggregatedUpdatedHandler
    extends DelimiterFileHandler<SalesOrderAggregatedUpdated> {

  @Inject
  @Named("DefaultJpaDao")
  public SalesOrderAggregatedUpdatedHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected SalesOrderAggregatedUpdated parseLine(List<String> headers, List<String> tokens) {
    SalesOrderAggregatedUpdated record = new SalesOrderAggregatedUpdated();
