...
public interface InventoryStockSalesChannelDao {
  /**
   * Retrieve all records InventoryStockSalesChannel.
   *
   * @param maxResult a maximum number of returned records.
   * @return A list of InventoryStockSalesChannel
   */
   ...
   * Find an entity.
   *
   * @param id An InventoryStockSalesChannel id.
   * @return The same InventoryStockSalesChannel.
   */
  public InventoryStockSalesChannel find(InventoryStockSalesChannelId id);
  /**
   * Create an InventoryStockSalesChannel.
   *
   * @param e the InventoryStockSalesChannel.
   * @return The same InventoryStockSalesChannel.
   */
  public InventoryStockSalesChannel create(InventoryStockSalesChannel e);

  /**
   * Update the InventoryStockSalesChannel.
   *
   * @param e the InventoryStockSalesChannel.
   * @return The same InventoryStockSalesChannel.
   */
