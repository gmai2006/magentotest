...
public class DefaultCatalogProductIndexPriceOptAgrIdxDao
    implements CatalogProductIndexPriceOptAgrIdxDao {
  ...
  @Inject
  @Named("DefaultJpaDao")
  public DefaultCatalogProductIndexPriceOptAgrIdxDao(JpaDao dao) {
    this.dao = dao;
  }

  public DefaultCatalogProductIndexPriceOptAgrIdxDao() {}

  /** {@inheritDoc} */
  @Override
  public CatalogProductIndexPriceOptAgrIdx find(CatalogProductIndexPriceOptAgrIdxId id) {
    final EntityManager em = dao.getEntityManager();
    return em.find(CatalogProductIndexPriceOptAgrIdx.class, id);
  }

  /** {@inheritDoc} */
  @Override
  public List<CatalogProductIndexPriceOptAgrIdx> select(int max) {
    return dao.select(
        "select a from CatalogProductIndexPriceOptAgrIdx a",
        CatalogProductIndexPriceOptAgrIdx.class,
        max);
  }
