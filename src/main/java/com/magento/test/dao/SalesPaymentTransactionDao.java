...
public interface SalesPaymentTransactionDao {
  /**
   * Retrieve all records SalesPaymentTransaction.
   *
   * @param maxResult a maximum number of returned records.
   * @return A list of SalesPaymentTransaction
   */
   ...
   * Find an entity.
   *
   * @param id An SalesPaymentTransaction id.
   * @return The same SalesPaymentTransaction.
   */
  public SalesPaymentTransaction find(SalesPaymentTransactionId id);
  /**
   * Create an SalesPaymentTransaction.
   *
   * @param e the SalesPaymentTransaction.
   * @return The same SalesPaymentTransaction.
   */
  public SalesPaymentTransaction create(SalesPaymentTransaction e);

  /**
   * Update the SalesPaymentTransaction.
   *
   * @param e the SalesPaymentTransaction.
   * @return The same SalesPaymentTransaction.
   */
