...
public interface SequenceShipment0Dao {
  /**
   * Retrieve all records SequenceShipment0.
   *
   * @param maxResult a maximum number of returned records.
   * @return A list of SequenceShipment0
   */
   ...
   * Find an entity.
   *
   * @param id An SequenceShipment0 id.
   * @return The same SequenceShipment0.
   */
  public SequenceShipment0 find(java.lang.Integer id);

  /**
   * Create an SequenceShipment0.
   *
   * @param e the SequenceShipment0.
   * @return The same SequenceShipment0.
   */
  public SequenceShipment0 create(SequenceShipment0 e);

  /**
   * Update the SequenceShipment0.
   *
   * @param e the SequenceShipment0.
   * @return The same SequenceShipment0.
   */
