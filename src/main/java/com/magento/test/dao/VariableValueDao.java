...
public interface VariableValueDao {
  /**
   * Retrieve all records VariableValue.
   *
   ...
   * Find an entity.
   *
   * @param id An VariableValue id.
   * @return The same VariableValue.
   */
  public VariableValue find(VariableValueId id);
  /**
   * Create an VariableValue.
   *
   * @param e the VariableValue.
   * @return The same VariableValue.
   */
  public VariableValue create(VariableValue e);

  /**
   * Update the VariableValue.
   *
   * @param e the VariableValue.
   * @return The same VariableValue.
   */
