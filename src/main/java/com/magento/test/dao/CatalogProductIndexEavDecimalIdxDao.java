...
public interface CatalogProductIndexEavDecimalIdxDao {
  /**
   * Retrieve all records CatalogProductIndexEavDecimalIdx.
   *
   * @param maxResult a maximum number of returned records.
   * @return A list of CatalogProductIndexEavDecimalIdx
   */
   ...
   * Find an entity.
   *
   * @param id An CatalogProductIndexEavDecimalIdx id.
   * @return The same CatalogProductIndexEavDecimalIdx.
   */
  public CatalogProductIndexEavDecimalIdx find(CatalogProductIndexEavDecimalIdxId id);
  /**
   * Create an CatalogProductIndexEavDecimalIdx.
   *
   * @param e the CatalogProductIndexEavDecimalIdx.
   * @return The same CatalogProductIndexEavDecimalIdx.
   */
  public CatalogProductIndexEavDecimalIdx create(CatalogProductIndexEavDecimalIdx e);

  /**
   * Update the CatalogProductIndexEavDecimalIdx.
   *
   * @param e the CatalogProductIndexEavDecimalIdx.
   * @return The same CatalogProductIndexEavDecimalIdx.
   */
