...
public class DefaultTranslationDao implements TranslationDao {
  ...
  @Inject
  @Named("DefaultJpaDao")
  public DefaultTranslationDao(JpaDao dao) {
    this.dao = dao;
  }

  public DefaultTranslationDao() {}
  ...
  /** {@inheritDoc} */
  @Override
  public List<Translation> select(int max) {
    return dao.select("select a from Translation a", Translation.class, max);
  }

  /** {@inheritDoc} */
  @Override
  public List<Translation> selectAll() {
    return dao.selectAll("select a from Translation a", Translation.class);
  }
