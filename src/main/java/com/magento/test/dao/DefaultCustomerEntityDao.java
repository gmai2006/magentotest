...
public class DefaultCustomerEntityDao implements CustomerEntityDao {
  ...
  @Inject
  @Named("DefaultJpaDao")
  public DefaultCustomerEntityDao(JpaDao dao) {
    this.dao = dao;
  }

  public DefaultCustomerEntityDao() {}
  ...
  /** {@inheritDoc} */
  @Override
  public List<CustomerEntity> select(int max) {
    return dao.select("select a from CustomerEntity a", CustomerEntity.class, max);
  }

  /** {@inheritDoc} */
  @Override
  public List<CustomerEntity> selectAll() {
    return dao.selectAll("select a from CustomerEntity a", CustomerEntity.class);
  }
