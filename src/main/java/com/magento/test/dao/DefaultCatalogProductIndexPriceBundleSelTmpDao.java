...
public class DefaultCatalogProductIndexPriceBundleSelTmpDao
    implements CatalogProductIndexPriceBundleSelTmpDao {
  ...
  @Inject
  @Named("DefaultJpaDao")
  public DefaultCatalogProductIndexPriceBundleSelTmpDao(JpaDao dao) {
    this.dao = dao;
  }

  public DefaultCatalogProductIndexPriceBundleSelTmpDao() {}

  /** {@inheritDoc} */
  @Override
  public CatalogProductIndexPriceBundleSelTmp find(CatalogProductIndexPriceBundleSelTmpId id) {
    final EntityManager em = dao.getEntityManager();
    return em.find(CatalogProductIndexPriceBundleSelTmp.class, id);
  }

  /** {@inheritDoc} */
  @Override
  public List<CatalogProductIndexPriceBundleSelTmp> select(int max) {
    return dao.select(
        "select a from CatalogProductIndexPriceBundleSelTmp a",
        CatalogProductIndexPriceBundleSelTmp.class,
        max);
  }
