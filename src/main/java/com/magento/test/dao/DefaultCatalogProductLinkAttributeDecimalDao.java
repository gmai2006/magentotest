...
public class DefaultCatalogProductLinkAttributeDecimalDao
    implements CatalogProductLinkAttributeDecimalDao {
  ...
  @Inject
  @Named("DefaultJpaDao")
  public DefaultCatalogProductLinkAttributeDecimalDao(JpaDao dao) {
    this.dao = dao;
  }

  public DefaultCatalogProductLinkAttributeDecimalDao() {}

  /** {@inheritDoc} */
  @Override
  public CatalogProductLinkAttributeDecimal find(CatalogProductLinkAttributeDecimalId id) {
    final EntityManager em = dao.getEntityManager();
    return em.find(CatalogProductLinkAttributeDecimal.class, id);
  }

  /** {@inheritDoc} */
  @Override
  public List<CatalogProductLinkAttributeDecimal> select(int max) {
    return dao.select(
        "select a from CatalogProductLinkAttributeDecimal a",
        CatalogProductLinkAttributeDecimal.class,
        max);
  }
