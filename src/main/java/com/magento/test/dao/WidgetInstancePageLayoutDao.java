...
public interface WidgetInstancePageLayoutDao {
  /**
   * Retrieve all records WidgetInstancePageLayout.
   *
   * @param maxResult a maximum number of returned records.
   * @return A list of WidgetInstancePageLayout
   */
   ...
   * Find an entity.
   *
   * @param id An WidgetInstancePageLayout id.
   * @return The same WidgetInstancePageLayout.
   */
  public WidgetInstancePageLayout find(WidgetInstancePageLayoutId id);
  /**
   * Create an WidgetInstancePageLayout.
   *
   * @param e the WidgetInstancePageLayout.
   * @return The same WidgetInstancePageLayout.
   */
  public WidgetInstancePageLayout create(WidgetInstancePageLayout e);

  /**
   * Update the WidgetInstancePageLayout.
   *
   * @param e the WidgetInstancePageLayout.
   * @return The same WidgetInstancePageLayout.
   */
