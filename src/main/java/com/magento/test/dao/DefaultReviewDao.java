...
public class DefaultReviewDao implements ReviewDao {
  ...
  @Inject
  @Named("DefaultJpaDao")
  public DefaultReviewDao(JpaDao dao) {
    this.dao = dao;
  }
  ...
  /** {@inheritDoc} */
  @Override
  public List<Review> select(int max) {
    return dao.select("select a from Review a", Review.class, max);
  }

  /** {@inheritDoc} */
  @Override
  public List<Review> selectAll() {
    return dao.selectAll("select a from Review a", Review.class);
  }
