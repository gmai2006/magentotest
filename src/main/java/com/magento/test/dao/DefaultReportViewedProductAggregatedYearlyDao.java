...
public class DefaultReportViewedProductAggregatedYearlyDao
    implements ReportViewedProductAggregatedYearlyDao {
  ...
  @Inject
  @Named("DefaultJpaDao")
  public DefaultReportViewedProductAggregatedYearlyDao(JpaDao dao) {
    this.dao = dao;
  }

  public DefaultReportViewedProductAggregatedYearlyDao() {}

  /** {@inheritDoc} */
  @Override
  public ReportViewedProductAggregatedYearly find(ReportViewedProductAggregatedYearlyId id) {
    final EntityManager em = dao.getEntityManager();
    return em.find(ReportViewedProductAggregatedYearly.class, id);
  }

  /** {@inheritDoc} */
  @Override
  public List<ReportViewedProductAggregatedYearly> select(int max) {
    return dao.select(
        "select a from ReportViewedProductAggregatedYearly a",
        ReportViewedProductAggregatedYearly.class,
        max);
  }
