...
public interface CatalogCategoryEntityTextDao {
  /**
   * Retrieve all records CatalogCategoryEntityText.
   *
   * @param maxResult a maximum number of returned records.
   * @return A list of CatalogCategoryEntityText
   */
   ...
   * Find an entity.
   *
   * @param id An CatalogCategoryEntityText id.
   * @return The same CatalogCategoryEntityText.
   */
  public CatalogCategoryEntityText find(CatalogCategoryEntityTextId id);
  /**
   * Create an CatalogCategoryEntityText.
   *
   * @param e the CatalogCategoryEntityText.
   * @return The same CatalogCategoryEntityText.
   */
  public CatalogCategoryEntityText create(CatalogCategoryEntityText e);

  /**
   * Update the CatalogCategoryEntityText.
   *
   * @param e the CatalogCategoryEntityText.
   * @return The same CatalogCategoryEntityText.
   */
