...
public class DefaultCatalogCategoryProductIndexStore1Dao
    implements CatalogCategoryProductIndexStore1Dao {
  ...
  @Inject
  @Named("DefaultJpaDao")
  public DefaultCatalogCategoryProductIndexStore1Dao(JpaDao dao) {
    this.dao = dao;
  }

  public DefaultCatalogCategoryProductIndexStore1Dao() {}

  /** {@inheritDoc} */
  @Override
  public CatalogCategoryProductIndexStore1 find(CatalogCategoryProductIndexStore1Id id) {
    final EntityManager em = dao.getEntityManager();
    return em.find(CatalogCategoryProductIndexStore1.class, id);
  }

  /** {@inheritDoc} */
  @Override
  public List<CatalogCategoryProductIndexStore1> select(int max) {
    return dao.select(
        "select a from CatalogCategoryProductIndexStore1 a",
        CatalogCategoryProductIndexStore1.class,
        max);
  }
