...
public interface StoreGroupDao {
  /**
   * Retrieve all records StoreGroup.
   *
   * @param maxResult a maximum number of returned records.
   * @return A list of StoreGroup
   */
   ...
   * Find an entity.
   *
   * @param id An StoreGroup id.
   * @return The same StoreGroup.
   */
  public StoreGroup find(StoreGroupId id);
  /**
   * Create an StoreGroup.
   *
   * @param e the StoreGroup.
   * @return The same StoreGroup.
   */
