...
public interface CatalogCategoryProductIndexStore1ReplicaDao {
  /**
   * Retrieve all records CatalogCategoryProductIndexStore1Replica.
   *
   * @param maxResult a maximum number of returned records.
   * @return A list of CatalogCategoryProductIndexStore1Replica
   */
   ...
   * Find an entity.
   *
   * @param id An CatalogCategoryProductIndexStore1Replica id.
   * @return The same CatalogCategoryProductIndexStore1Replica.
   */
  public CatalogCategoryProductIndexStore1Replica find(
      CatalogCategoryProductIndexStore1ReplicaId id);
  /**
   * Create an CatalogCategoryProductIndexStore1Replica.
   *
   * @param e the CatalogCategoryProductIndexStore1Replica.
   * @return The same CatalogCategoryProductIndexStore1Replica.
   */
  ...
  /**
   * Update the CatalogCategoryProductIndexStore1Replica.
   *
   * @param e the CatalogCategoryProductIndexStore1Replica.
   * @return The same CatalogCategoryProductIndexStore1Replica.
   */
