...
public class DefaultVertexSalesCreditmemoItemVertexTaxCodeDao
    implements VertexSalesCreditmemoItemVertexTaxCodeDao {
  ...
  @Inject
  @Named("DefaultJpaDao")
  public DefaultVertexSalesCreditmemoItemVertexTaxCodeDao(JpaDao dao) {
    this.dao = dao;
  }

  public DefaultVertexSalesCreditmemoItemVertexTaxCodeDao() {}

  /** {@inheritDoc} */
  @Override
  public VertexSalesCreditmemoItemVertexTaxCode find(VertexSalesCreditmemoItemVertexTaxCodeId id) {
    final EntityManager em = dao.getEntityManager();
    return em.find(VertexSalesCreditmemoItemVertexTaxCode.class, id);
  }

  /** {@inheritDoc} */
  @Override
  public List<VertexSalesCreditmemoItemVertexTaxCode> select(int max) {
    return dao.select(
        "select a from VertexSalesCreditmemoItemVertexTaxCode a",
        VertexSalesCreditmemoItemVertexTaxCode.class,
        max);
  }
