...
import com.magento.test.service.FlagService;
...
public class FlagResource {
  ...
  @Inject private FlagService service;
  ...
  /**
   * InIdempotent method. Update existing Flag.
   *
  ...
  public Response selectAll() {
    List<Flag> result = service.selectAll();
