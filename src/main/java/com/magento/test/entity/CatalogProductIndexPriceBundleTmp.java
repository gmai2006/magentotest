...
@Entity
@IdClass(CatalogProductIndexPriceBundleTmpId.class)
@Table(name = "catalog_product_index_price_bundle_tmp")
public class CatalogProductIndexPriceBundleTmp implements Serializable {
  private static final long serialVersionUID = 16344509040425064L;
