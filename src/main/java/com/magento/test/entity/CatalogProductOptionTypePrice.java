...
public class CatalogProductOptionTypePrice implements Serializable {
  ...
  /** Description: option_type_price_id. */
  @javax.validation.constraints.NotNull
  @javax.persistence.Id
  ...
  @javax.validation.constraints.NotNull
  @Basic
  @Column(name = "price_type", length = 7)
