...
@Entity
@Table(name = "sequence_order_0")
public class SequenceOrder0 implements Serializable {
  private static final long serialVersionUID = 163445090688098590L;
