...
@Entity
@Table(name = "sequence_creditmemo_0")
public class SequenceCreditmemo0 implements Serializable {
  private static final long serialVersionUID = 163445090687092862L;
