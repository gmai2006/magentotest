...
@Entity
@IdClass(SalesruleCouponAggregatedOrderId.class)
@Table(name = "salesrule_coupon_aggregated_order")
public class SalesruleCouponAggregatedOrder implements Serializable {
  private static final long serialVersionUID = 163445090680151774L;
  ...
  public SalesruleCouponAggregatedOrder() {}
