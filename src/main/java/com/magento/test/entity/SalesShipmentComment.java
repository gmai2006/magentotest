...
@Entity
@Table(name = "sales_shipment_comment")
public class SalesShipmentComment implements Serializable {
  private static final long serialVersionUID = 163445090671394846L;
