...
@Entity
@IdClass(CatalogProductIndexPriceCfgOptTmpId.class)
@Table(name = "catalog_product_index_price_cfg_opt_tmp")
public class CatalogProductIndexPriceCfgOptTmp implements Serializable {
  private static final long serialVersionUID = 163445090409988442L;
