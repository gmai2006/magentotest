...
@Entity
@IdClass(CatalogsearchFulltextScope1Id.class)
@Table(name = "catalogsearch_fulltext_scope1")
public class CatalogsearchFulltextScope1 implements Serializable {
  private static final long serialVersionUID = 163445090470015123L;
  ...
  @Basic
  @Column(name = "data_index", length = 0)
  private java.lang.String dataIndex;

  public CatalogsearchFulltextScope1() {}
