...
@Entity
@IdClass(CatalogProductEntityIntId.class)
@Table(name = "catalog_product_entity_int")
public class CatalogProductEntityInt implements Serializable {
  private static final long serialVersionUID = 163445090369329944L;
