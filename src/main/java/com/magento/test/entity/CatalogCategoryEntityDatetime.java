...
@Entity
@IdClass(CatalogCategoryEntityDatetimeId.class)
@Table(name = "catalog_category_entity_datetime")
public class CatalogCategoryEntityDatetime implements Serializable {
  private static final long serialVersionUID = 163445090335529527L;
