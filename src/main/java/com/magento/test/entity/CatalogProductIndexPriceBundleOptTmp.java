...
@Entity
@IdClass(CatalogProductIndexPriceBundleOptTmpId.class)
@Table(name = "catalog_product_index_price_bundle_opt_tmp")
public class CatalogProductIndexPriceBundleOptTmp implements Serializable {
  private static final long serialVersionUID = 163445090398953502L;
