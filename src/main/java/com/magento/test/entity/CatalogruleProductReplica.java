...
@Entity
@IdClass(CatalogruleProductReplicaId.class)
@Table(name = "catalogrule_product_replica")
public class CatalogruleProductReplica implements Serializable {
  private static final long serialVersionUID = 163445090467044190L;
  ...
  public CatalogruleProductReplica() {}
