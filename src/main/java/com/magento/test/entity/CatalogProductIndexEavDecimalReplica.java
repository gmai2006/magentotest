...
@Entity
@IdClass(CatalogProductIndexEavDecimalReplicaId.class)
@Table(name = "catalog_product_index_eav_decimal_replica")
public class CatalogProductIndexEavDecimalReplica implements Serializable {
  private static final long serialVersionUID = 163445090386195913L;
  ...
  public CatalogProductIndexEavDecimalReplica() {}
