...
@Entity
@IdClass(CatalogProductEntityTextId.class)
@Table(name = "catalog_product_entity_text")
public class CatalogProductEntityText implements Serializable {
  private static final long serialVersionUID = 163445090374834558L;
