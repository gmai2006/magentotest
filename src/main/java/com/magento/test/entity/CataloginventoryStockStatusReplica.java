...
@Entity
@IdClass(CataloginventoryStockStatusReplicaId.class)
@Table(name = "cataloginventory_stock_status_replica")
public class CataloginventoryStockStatusReplica implements Serializable {
  private static final long serialVersionUID = 163445090454113703L;
  ...
  public CataloginventoryStockStatusReplica() {}
