...
@Entity
@IdClass(SalesOrderAggregatedCreatedId.class)
@Table(name = "sales_order_aggregated_created")
public class SalesOrderAggregatedCreated implements Serializable {
  private static final long serialVersionUID = 163445090647465938L;
