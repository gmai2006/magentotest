...
@Entity
@Table(name = "sequence_creditmemo_1")
public class SequenceCreditmemo1 implements Serializable {
  private static final long serialVersionUID = 163445090687222606L;
