...
@Entity
@IdClass(SalesruleCouponAggregatedId.class)
@Table(name = "salesrule_coupon_aggregated")
public class SalesruleCouponAggregated implements Serializable {
  private static final long serialVersionUID = 163445090678912909L;
  ...
  public SalesruleCouponAggregated() {}
