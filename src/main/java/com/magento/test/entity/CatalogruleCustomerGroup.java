...
@Entity
@IdClass(CatalogruleCustomerGroupId.class)
@Table(name = "catalogrule_customer_group")
public class CatalogruleCustomerGroup implements Serializable {
  private static final long serialVersionUID = 163445090457442560L;
