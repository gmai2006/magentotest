...
@Entity
@IdClass(CatalogProductEntityDatetimeId.class)
@Table(name = "catalog_product_entity_datetime")
public class CatalogProductEntityDatetime implements Serializable {
  private static final long serialVersionUID = 163445090364478900L;
