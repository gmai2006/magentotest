...
@Entity
@Table(name = "sequence_shipment_0")
public class SequenceShipment0 implements Serializable {
  private static final long serialVersionUID = 163445090688474931L;
