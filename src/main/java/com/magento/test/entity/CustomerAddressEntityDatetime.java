...
@Entity
@IdClass(CustomerAddressEntityDatetimeId.class)
@Table(name = "customer_address_entity_datetime")
public class CustomerAddressEntityDatetime implements Serializable {
  private static final long serialVersionUID = 163445090481798294L;
