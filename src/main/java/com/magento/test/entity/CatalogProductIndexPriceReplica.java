...
@Entity
@IdClass(CatalogProductIndexPriceReplicaId.class)
@Table(name = "catalog_product_index_price_replica")
public class CatalogProductIndexPriceReplica implements Serializable {
  private static final long serialVersionUID = 163445090424033523L;
  ...
  public CatalogProductIndexPriceReplica() {}
