...
@Entity
@IdClass(SalesInvoicedAggregatedId.class)
@Table(name = "sales_invoiced_aggregated")
public class SalesInvoicedAggregated implements Serializable {
  private static final long serialVersionUID = 163445090636415888L;
