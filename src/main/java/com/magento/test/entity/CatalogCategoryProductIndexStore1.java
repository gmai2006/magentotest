...
@Entity
@IdClass(CatalogCategoryProductIndexStore1Id.class)
@Table(name = "catalog_category_product_index_store1")
public class CatalogCategoryProductIndexStore1 implements Serializable {
  private static final long serialVersionUID = 16344509034822351L;
  ...
  public CatalogCategoryProductIndexStore1() {}
