...
@Entity
@IdClass(CatalogProductEntityVarcharId.class)
@Table(name = "catalog_product_entity_varchar")
public class CatalogProductEntityVarchar implements Serializable {
  private static final long serialVersionUID = 16344509037805448L;
