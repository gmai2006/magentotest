...
/** embeddable class Id for SalesShippingAggregatedOrder. generated on 10/16/2021 from a schema. */
public class SalesShippingAggregatedOrderId implements Serializable {
  private static final long serialVersionUID = 163445090675130046L;
  ...
  /** Constructor: SalesShippingAggregatedOrderId. */
  public SalesShippingAggregatedOrderId() {}
   ...
   * @param period - period.
   * @param id - id.
   * @param shippingDescription - shippingDescription.
   */
  public SalesShippingAggregatedOrderId(
  ...
  public boolean equals(Object obj) {
    ...
    SalesShippingAggregatedOrderId other = (SalesShippingAggregatedOrderId) obj;
    ...
    if (shippingDescription == null) {
      if (other.shippingDescription != null) return false;
    } else if (!shippingDescription.equals(other.shippingDescription)) return false;
