...
@Entity
@Table(name = "sequence_shipment_1")
public class SequenceShipment1 implements Serializable {
  private static final long serialVersionUID = 163445090688715685L;
