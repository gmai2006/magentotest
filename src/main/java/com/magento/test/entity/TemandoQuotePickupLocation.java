...
@Entity
@Table(name = "temando_quote_pickup_location")
public class TemandoQuotePickupLocation implements Serializable {
  private static final long serialVersionUID = 163445090704960852L;
  ...
  public TemandoQuotePickupLocation() {}
