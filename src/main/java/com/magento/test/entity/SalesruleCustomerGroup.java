...
@Entity
@IdClass(SalesruleCustomerGroupId.class)
@Table(name = "salesrule_customer_group")
public class SalesruleCustomerGroup implements Serializable {
  private static final long serialVersionUID = 163445090682935310L;
