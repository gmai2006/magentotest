...
@Entity
@IdClass(CatalogProductEntityDecimalId.class)
@Table(name = "catalog_product_entity_decimal")
public class CatalogProductEntityDecimal implements Serializable {
  private static final long serialVersionUID = 163445090366010062L;
