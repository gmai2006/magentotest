...
@Entity
@Table(name = "sequence_order_1")
public class SequenceOrder1 implements Serializable {
  private static final long serialVersionUID = 163445090688233265L;
