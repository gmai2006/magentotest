...
@Entity
@IdClass(AmazonSalesOrderId.class)
@Table(name = "amazon_sales_order")
public class AmazonSalesOrder implements Serializable {
  private static final long serialVersionUID = 163445090325629776L;
