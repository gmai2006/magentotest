...
@Entity
@IdClass(CatalogCategoryEntityVarcharId.class)
@Table(name = "catalog_category_entity_varchar")
public class CatalogCategoryEntityVarchar implements Serializable {
  private static final long serialVersionUID = 163445090342943398L;
  ...
  public CatalogCategoryEntityVarchar() {}
