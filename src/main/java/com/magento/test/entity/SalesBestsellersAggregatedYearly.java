...
@Entity
@IdClass(SalesBestsellersAggregatedYearlyId.class)
@Table(name = "sales_bestsellers_aggregated_yearly")
public class SalesBestsellersAggregatedYearly implements Serializable {
  private static final long serialVersionUID = 163445090621857064L;
