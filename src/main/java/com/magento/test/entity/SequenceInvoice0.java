...
@Entity
@Table(name = "sequence_invoice_0")
public class SequenceInvoice0 implements Serializable {
  private static final long serialVersionUID = 163445090687537294L;
