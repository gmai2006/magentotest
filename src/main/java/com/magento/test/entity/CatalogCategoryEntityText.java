...
@Entity
@IdClass(CatalogCategoryEntityTextId.class)
@Table(name = "catalog_category_entity_text")
public class CatalogCategoryEntityText implements Serializable {
  private static final long serialVersionUID = 163445090341412597L;
