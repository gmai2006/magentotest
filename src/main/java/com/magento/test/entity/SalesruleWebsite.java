...
@Entity
@IdClass(SalesruleWebsiteId.class)
@Table(name = "salesrule_website")
public class SalesruleWebsite implements Serializable {
  private static final long serialVersionUID = 163445090685240526L;
