...
@Entity
@IdClass(InventorySourceItemId.class)
@Table(name = "inventory_source_item")
public class InventorySourceItem implements Serializable {
  private static final long serialVersionUID = 163445090559065872L;

  /** Description: source_item_id. */
