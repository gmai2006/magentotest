...
@Entity
@IdClass(CatalogCategoryEntityDecimalId.class)
@Table(name = "catalog_category_entity_decimal")
public class CatalogCategoryEntityDecimal implements Serializable {
  private static final long serialVersionUID = 163445090337435063L;
