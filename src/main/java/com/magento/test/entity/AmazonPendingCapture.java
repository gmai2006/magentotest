...
@Entity
@IdClass(AmazonPendingCaptureId.class)
@Table(name = "amazon_pending_capture")
public class AmazonPendingCapture implements Serializable {
  private static final long serialVersionUID = 163445090320563440L;
