...
@Entity
@IdClass(CatalogruleWebsiteId.class)
@Table(name = "catalogrule_website")
public class CatalogruleWebsite implements Serializable {
  private static final long serialVersionUID = 163445090468558874L;
