...
@Entity
@IdClass(CatalogProductIndexPriceFinalIdxId.class)
@Table(name = "catalog_product_index_price_final_idx")
public class CatalogProductIndexPriceFinalIdx implements Serializable {
  private static final long serialVersionUID = 163445090413962573L;
  ...
  public CatalogProductIndexPriceFinalIdx() {}
