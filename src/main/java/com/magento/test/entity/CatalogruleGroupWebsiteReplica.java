...
@Entity
@IdClass(CatalogruleGroupWebsiteReplicaId.class)
@Table(name = "catalogrule_group_website_replica")
public class CatalogruleGroupWebsiteReplica implements Serializable {
  private static final long serialVersionUID = 163445090459985828L;
  ...
  public CatalogruleGroupWebsiteReplica() {}
