...
@Entity
@Table(name = "sales_invoice_comment")
public class SalesInvoiceComment implements Serializable {
  private static final long serialVersionUID = 163445090631420848L;
