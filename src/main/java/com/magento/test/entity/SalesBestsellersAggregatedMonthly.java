...
@Entity
@IdClass(SalesBestsellersAggregatedMonthlyId.class)
@Table(name = "sales_bestsellers_aggregated_monthly")
public class SalesBestsellersAggregatedMonthly implements Serializable {
  private static final long serialVersionUID = 163445090620790487L;
  ...
  public SalesBestsellersAggregatedMonthly() {}
