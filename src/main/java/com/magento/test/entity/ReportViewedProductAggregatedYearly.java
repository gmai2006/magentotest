...
@Entity
@IdClass(ReportViewedProductAggregatedYearlyId.class)
@Table(name = "report_viewed_product_aggregated_yearly")
public class ReportViewedProductAggregatedYearly implements Serializable {
  private static final long serialVersionUID = 163445090613634456L;
