...
@Entity
@IdClass(ReportViewedProductAggregatedDailyId.class)
@Table(name = "report_viewed_product_aggregated_daily")
public class ReportViewedProductAggregatedDaily implements Serializable {
  private static final long serialVersionUID = 163445090611937641L;
  ...
  public ReportViewedProductAggregatedDaily() {}
