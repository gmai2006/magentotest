...
@Entity
@IdClass(CatalogProductIndexEavReplicaId.class)
@Table(name = "catalog_product_index_eav_replica")
public class CatalogProductIndexEavReplica implements Serializable {
  private static final long serialVersionUID = 16344509039093163L;
  ...
  public CatalogProductIndexEavReplica() {}
