...
public class SalesruleCouponAggregatedOrderDaoTestIt {
  static final String inputFile = "SalesruleCouponAggregatedOrder.json";
  static SalesruleCouponAggregatedOrderDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultSalesruleCouponAggregatedOrderDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    SalesruleCouponAggregatedOrder testResult = dao.find(id);
