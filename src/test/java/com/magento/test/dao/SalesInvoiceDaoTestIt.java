...
public class SalesInvoiceDaoTestIt {
  static final String inputFile = "SalesInvoice.json";
  static SalesInvoiceDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultSalesInvoiceDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    SalesInvoice testResult = dao.find(id);
    ...
    org.junit.Assert.assertTrue(
        ...
        this.records[1].getIsUsedForRefund() == testResult.getIsUsedForRefund());
    org.junit.Assert.assertTrue(
    ...
    org.junit.Assert.assertTrue(
        ...
        this.records[1].getCanVoidFlag() == testResult.getCanVoidFlag());
    org.junit.Assert.assertTrue(
