...
public class TaxOrderAggregatedCreatedDaoTestIt {
  static final String inputFile = "TaxOrderAggregatedCreated.json";
  static TaxOrderAggregatedCreatedDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultTaxOrderAggregatedCreatedDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    TaxOrderAggregatedCreated testResult = dao.find(id);
