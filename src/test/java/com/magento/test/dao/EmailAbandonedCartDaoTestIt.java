...
public class EmailAbandonedCartDaoTestIt {
  static final String inputFile = "EmailAbandonedCart.json";
  static EmailAbandonedCartDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultEmailAbandonedCartDao(jpa);
  }
  ...
  public void testSelect() {
    EmailAbandonedCart testResult = dao.find(records[1].getId());
    ...
    org.junit.Assert.assertTrue(
        ...
        this.records[1].getAbandonedCartNumber() == testResult.getAbandonedCartNumber());
    org.junit.Assert.assertTrue(
        "expect equals itemsCount ", this.records[1].getItemsCount() == testResult.getItemsCount());
    org.junit.Assert.assertEquals(
        "expect equals itemsIds ", this.records[1].getItemsIds(), testResult.getItemsIds());
  }
}
