...
public class SignifydCaseDaoTestIt {
  static final String inputFile = "SignifydCase.json";
  static SignifydCaseDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultSignifydCaseDao(jpa);
  }
  ...
  public void testSelect() {
    final SignifydCaseId id =
        new SignifydCaseId(
            this.records[1].getCaseId(),
            this.records[1].getEntityId(),
            this.records[1].getOrderId());
    SignifydCase testResult = dao.find(id);
    assertNotNull("expect result", testResult);
    org.junit.Assert.assertTrue(
        "expect equals guaranteeEligible ",
        this.records[1].getGuaranteeEligible() == testResult.getGuaranteeEligible());
    org.junit.Assert.assertEquals(
        "expect equals guaranteeDisposition ",
        this.records[1].getGuaranteeDisposition(),
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[1].getAssociatedTeam(),
        testResult.getAssociatedTeam());
    org.junit.Assert.assertEquals(
        "expect equals reviewDisposition ",
        this.records[1].getReviewDisposition(),
