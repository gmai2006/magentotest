...
public class SalesShipmentDaoTestIt {
  static final String inputFile = "SalesShipment.json";
  static SalesShipmentDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultSalesShipmentDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    SalesShipment testResult = dao.find(id);
    assertNotNull("expect result", testResult);
    org.junit.Assert.assertEquals(
        "expect equals totalWeight ",
        this.records[1].getTotalWeight(),
    ...
    org.junit.Assert.assertEquals(
        "expect equals packages ", this.records[1].getPackages(), testResult.getPackages());
    org.junit.Assert.assertEquals(
