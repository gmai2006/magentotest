...
public class CataloginventoryStockStatusDaoTestIt {
  static final String inputFile = "CataloginventoryStockStatus.json";
  static CataloginventoryStockStatusDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultCataloginventoryStockStatusDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    CataloginventoryStockStatus testResult = dao.find(id);
