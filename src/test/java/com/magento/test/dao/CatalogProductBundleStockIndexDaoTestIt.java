...
public class CatalogProductBundleStockIndexDaoTestIt {
  static final String inputFile = "CatalogProductBundleStockIndex.json";
  static CatalogProductBundleStockIndexDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultCatalogProductBundleStockIndexDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    CatalogProductBundleStockIndex testResult = dao.find(id);
