...
public class SalesShippingAggregatedDaoTestIt {
  static final String inputFile = "SalesShippingAggregated.json";
  static SalesShippingAggregatedDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultSalesShippingAggregatedDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    SalesShippingAggregated testResult = dao.find(id);
