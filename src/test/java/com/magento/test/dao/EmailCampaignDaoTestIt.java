...
public class EmailCampaignDaoTestIt {
  static final String inputFile = "EmailCampaign.json";
  static EmailCampaignDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultEmailCampaignDao(jpa);
  }
  ...
  public void testSelect() {
    EmailCampaign testResult = dao.find(records[1].getId());
    assertNotNull("expect result", testResult);
    org.junit.Assert.assertTrue(
        "expect equals campaignId ", this.records[1].getCampaignId() == testResult.getCampaignId());
    ...
    org.junit.Assert.assertEquals(
        "expect equals eventName ", this.records[1].getEventName(), testResult.getEventName());
    org.junit.Assert.assertEquals(
        "expect equals sendId ", this.records[1].getSendId(), testResult.getSendId());
    org.junit.Assert.assertTrue(
        "expect equals sendStatus ", this.records[1].getSendStatus() == testResult.getSendStatus());
  }
}
