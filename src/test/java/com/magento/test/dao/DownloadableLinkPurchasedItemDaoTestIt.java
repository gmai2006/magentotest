...
public class DownloadableLinkPurchasedItemDaoTestIt {
  static final String inputFile = "DownloadableLinkPurchasedItem.json";
  static DownloadableLinkPurchasedItemDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultDownloadableLinkPurchasedItemDao(jpa);
  }
  ...
  public void testSelect() {
    DownloadableLinkPurchasedItem testResult = dao.find(records[1].getItemId());
    assertNotNull("expect result", testResult);
    org.junit.Assert.assertTrue(
        "expect equals purchasedId ",
        this.records[1].getPurchasedId() == testResult.getPurchasedId());
    org.junit.Assert.assertTrue(
    ...
    org.junit.Assert.assertEquals(
        "expect equals linkHash ", this.records[1].getLinkHash(), testResult.getLinkHash());
    org.junit.Assert.assertTrue(
        "expect equals numberOfDownloadsBought ",
        this.records[1].getNumberOfDownloadsBought() == testResult.getNumberOfDownloadsBought());
    org.junit.Assert.assertTrue(
        "expect equals numberOfDownloadsUsed ",
        this.records[1].getNumberOfDownloadsUsed() == testResult.getNumberOfDownloadsUsed());
    org.junit.Assert.assertTrue(
        "expect equals linkId ", this.records[1].getLinkId() == testResult.getLinkId());
    org.junit.Assert.assertEquals(
