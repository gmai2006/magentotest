...
public class RatingDaoTestIt {
  static final String inputFile = "Rating.json";
  static RatingDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public void testSelect() {
    final RatingId id =
        new RatingId(this.records[1].getRatingId(), this.records[1].getRatingCode());
    Rating testResult = dao.find(id);
