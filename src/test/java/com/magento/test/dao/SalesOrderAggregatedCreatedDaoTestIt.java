...
public class SalesOrderAggregatedCreatedDaoTestIt {
  static final String inputFile = "SalesOrderAggregatedCreated.json";
  static SalesOrderAggregatedCreatedDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultSalesOrderAggregatedCreatedDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    SalesOrderAggregatedCreated testResult = dao.find(id);
