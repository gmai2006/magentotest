...
public class CustomerEavAttributeWebsiteDaoTestIt {
  static final String inputFile = "CustomerEavAttributeWebsite.json";
  static CustomerEavAttributeWebsiteDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultCustomerEavAttributeWebsiteDao(jpa);
  }
  ...
  public void testSelect() {
    final CustomerEavAttributeWebsiteId id =
        new CustomerEavAttributeWebsiteId(
            this.records[1].getAttributeId(), this.records[1].getWebsiteId());
    CustomerEavAttributeWebsite testResult = dao.find(id);
