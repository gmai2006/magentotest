...
public class CatalogProductBundleSelectionPriceDaoTestIt {
  static final String inputFile = "CatalogProductBundleSelectionPrice.json";
  static CatalogProductBundleSelectionPriceDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultCatalogProductBundleSelectionPriceDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    CatalogProductBundleSelectionPrice testResult = dao.find(id);
