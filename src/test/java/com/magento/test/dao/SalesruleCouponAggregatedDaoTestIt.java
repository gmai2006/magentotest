...
public class SalesruleCouponAggregatedDaoTestIt {
  static final String inputFile = "SalesruleCouponAggregated.json";
  static SalesruleCouponAggregatedDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultSalesruleCouponAggregatedDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    SalesruleCouponAggregated testResult = dao.find(id);
