...
public class CustomerEntityDaoTestIt {
  static final String inputFile = "CustomerEntity.json";
  static CustomerEntityDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultCustomerEntityDao(jpa);
  }
  ...
  public void testSelect() {
    final CustomerEntityId id =
        new CustomerEntityId(
            ...
            this.records[1].getEmail());
    CustomerEntity testResult = dao.find(id);
    ...
    org.junit.Assert.assertTrue(
        ...
        this.records[1].getDisableAutoGroupChange() == testResult.getDisableAutoGroupChange());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertTrue(
        ...
        this.records[1].getDefaultBilling() == testResult.getDefaultBilling());
    org.junit.Assert.assertTrue(
        "expect equals defaultShipping ",
        this.records[1].getDefaultShipping() == testResult.getDefaultShipping());
    org.junit.Assert.assertEquals(
