...
public class NewsletterTemplateDaoTestIt {
  static final String inputFile = "NewsletterTemplate.json";
  static NewsletterTemplateDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultNewsletterTemplateDao(jpa);
  }
  ...
  public void testSelect() {
    NewsletterTemplate testResult = dao.find(records[1].getTemplateId());
    assertNotNull("expect result", testResult);
    org.junit.Assert.assertEquals(
        "expect equals templateCode ",
        this.records[1].getTemplateCode(),
    ...
    org.junit.Assert.assertTrue(
        ...
        this.records[1].getTemplateActual() == testResult.getTemplateActual());
  }
}
