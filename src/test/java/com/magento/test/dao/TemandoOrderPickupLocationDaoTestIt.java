...
public class TemandoOrderPickupLocationDaoTestIt {
  static final String inputFile = "TemandoOrderPickupLocation.json";
  static TemandoOrderPickupLocationDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultTemandoOrderPickupLocationDao(jpa);
  }
  ...
  public void testSelect() {
    TemandoOrderPickupLocation testResult = dao.find(records[1].getRecipientAddressId());
