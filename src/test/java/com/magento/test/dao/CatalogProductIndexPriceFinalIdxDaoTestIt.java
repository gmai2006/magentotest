...
public class CatalogProductIndexPriceFinalIdxDaoTestIt {
  static final String inputFile = "CatalogProductIndexPriceFinalIdx.json";
  static CatalogProductIndexPriceFinalIdxDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultCatalogProductIndexPriceFinalIdxDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    CatalogProductIndexPriceFinalIdx testResult = dao.find(id);
