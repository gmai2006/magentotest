...
public class CatalogProductIndexPriceDownlodIdxDaoTestIt {
  static final String inputFile = "CatalogProductIndexPriceDownlodIdx.json";
  static CatalogProductIndexPriceDownlodIdxDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultCatalogProductIndexPriceDownlodIdxDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    CatalogProductIndexPriceDownlodIdx testResult = dao.find(id);
