...
public class SalesInvoiceItemDaoTestIt {
  static final String inputFile = "SalesInvoiceItem.json";
  static SalesInvoiceItemDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultSalesInvoiceItemDao(jpa);
  }
  ...
  public void testSelect() {
    SalesInvoiceItem testResult = dao.find(records[1].getEntityId());
