...
public class SalesruleCouponAggregatedUpdatedDaoTestIt {
  static final String inputFile = "SalesruleCouponAggregatedUpdated.json";
  static SalesruleCouponAggregatedUpdatedDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultSalesruleCouponAggregatedUpdatedDao(jpa);
  }
  ...
  public void testSelect() {
    final SalesruleCouponAggregatedUpdatedId id =
        new SalesruleCouponAggregatedUpdatedId(
            ...
            this.records[1].getCouponCode(),
            this.records[1].getId());
    SalesruleCouponAggregatedUpdated testResult = dao.find(id);
    assertNotNull("expect result", testResult);
    org.junit.Assert.assertTrue(
        "expect equals couponUses ", this.records[1].getCouponUses() == testResult.getCouponUses());
    org.junit.Assert.assertEquals(
        "expect equals subtotalAmount ",
        this.records[1].getSubtotalAmount(),
