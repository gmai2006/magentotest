...
public class InventoryGeonameDaoTestIt {
  static final String inputFile = "InventoryGeoname.json";
  static InventoryGeonameDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultInventoryGeonameDao(jpa);
  }
  ...
  public void testSelect() {
    InventoryGeoname testResult = dao.find(records[1].getDefaultId());
    assertNotNull("expect result", testResult);
    org.junit.Assert.assertEquals(
        "expect equals countryCode ",
        this.records[1].getCountryCode(),
    ...
    org.junit.Assert.assertEquals(
        "expect equals province ", this.records[1].getProvince(), testResult.getProvince());
