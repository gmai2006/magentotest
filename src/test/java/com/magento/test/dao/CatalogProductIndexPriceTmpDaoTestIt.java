...
public class CatalogProductIndexPriceTmpDaoTestIt {
  static final String inputFile = "CatalogProductIndexPriceTmp.json";
  static CatalogProductIndexPriceTmpDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultCatalogProductIndexPriceTmpDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    CatalogProductIndexPriceTmp testResult = dao.find(id);
