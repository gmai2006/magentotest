...
public class ReportViewedProductIndexDaoTestIt {
  static final String inputFile = "ReportViewedProductIndex.json";
  static ReportViewedProductIndexDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultReportViewedProductIndexDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    ReportViewedProductIndex testResult = dao.find(id);
