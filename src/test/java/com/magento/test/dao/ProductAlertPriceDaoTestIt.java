...
public class ProductAlertPriceDaoTestIt {
  static final String inputFile = "ProductAlertPrice.json";
  static ProductAlertPriceDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultProductAlertPriceDao(jpa);
  }
  ...
  public void testSelect() {
    ProductAlertPrice testResult = dao.find(records[1].getAlertPriceId());
