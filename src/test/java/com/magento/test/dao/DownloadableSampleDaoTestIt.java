...
public class DownloadableSampleDaoTestIt {
  static final String inputFile = "DownloadableSample.json";
  static DownloadableSampleDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultDownloadableSampleDao(jpa);
  }
  ...
  public void testSelect() {
    DownloadableSample testResult = dao.find(records[1].getSampleId());
