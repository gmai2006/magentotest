...
public class ReviewEntitySummaryDaoTestIt {
  static final String inputFile = "ReviewEntitySummary.json";
  static ReviewEntitySummaryDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultReviewEntitySummaryDao(jpa);
  }
  ...
  public void testSelect() {
    ReviewEntitySummary testResult = dao.find(records[1].getPrimaryId());
    assertNotNull("expect result", testResult);
    org.junit.Assert.assertTrue(
        "expect equals entityType ", this.records[1].getEntityType() == testResult.getEntityType());
    org.junit.Assert.assertTrue(
        "expect equals reviewsCount ",
        this.records[1].getReviewsCount() == testResult.getReviewsCount());
    org.junit.Assert.assertTrue(
        "expect equals ratingSummary ",
        this.records[1].getRatingSummary() == testResult.getRatingSummary());
    org.junit.Assert.assertTrue(
