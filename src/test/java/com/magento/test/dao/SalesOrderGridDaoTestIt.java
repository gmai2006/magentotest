...
public class SalesOrderGridDaoTestIt {
  static final String inputFile = "SalesOrderGrid.json";
  static SalesOrderGridDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultSalesOrderGridDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    SalesOrderGrid testResult = dao.find(id);
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[1].getCustomerGroup(),
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[1].getSignifydGuaranteeStatus(),
