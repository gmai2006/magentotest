...
public class StoreDaoTestIt {
  ...
  public void testSelect() {
    final StoreId id = new StoreId(this.records[1].getStoreId(), this.records[1].getCode());
    Store testResult = dao.find(id);
