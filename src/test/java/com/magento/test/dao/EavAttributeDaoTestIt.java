...
public class EavAttributeDaoTestIt {
  static final String inputFile = "EavAttribute.json";
  static EavAttributeDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultEavAttributeDao(jpa);
  }
  ...
  public void testSelect() {
    final EavAttributeId id =
        new EavAttributeId(
            ...
            this.records[1].getEntityTypeId(),
            this.records[1].getAttributeCode());
    EavAttribute testResult = dao.find(id);
    ...
    org.junit.Assert.assertTrue(
        ...
        this.records[1].getIsUserDefined() == testResult.getIsUserDefined());
    org.junit.Assert.assertEquals(
        "expect equals defaultValue ",
        this.records[1].getDefaultValue(),
        testResult.getDefaultValue());
    org.junit.Assert.assertTrue(
        "expect equals isUnique ", this.records[1].getIsUnique() == testResult.getIsUnique());
    org.junit.Assert.assertEquals(
        "expect equals note ", this.records[1].getNote(), testResult.getNote());
  }
}
