...
public class SalesOrderStatusStateDaoTestIt {
  static final String inputFile = "SalesOrderStatusState.json";
  static SalesOrderStatusStateDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultSalesOrderStatusStateDao(jpa);
  }
  ...
  public void testSelect() {
    final SalesOrderStatusStateId id =
        new SalesOrderStatusStateId(this.records[1].getState(), this.records[1].getStatus());
    SalesOrderStatusState testResult = dao.find(id);
    assertNotNull("expect result", testResult);
    org.junit.Assert.assertTrue(
        "expect equals isDefault ", this.records[1].getIsDefault() == testResult.getIsDefault());
    org.junit.Assert.assertTrue(
        "expect equals visibleOnFront ",
        this.records[1].getVisibleOnFront() == testResult.getVisibleOnFront());
  }
}
