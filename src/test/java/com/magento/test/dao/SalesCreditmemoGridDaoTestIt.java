...
public class SalesCreditmemoGridDaoTestIt {
  static final String inputFile = "SalesCreditmemoGrid.json";
  static SalesCreditmemoGridDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultSalesCreditmemoGridDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    SalesCreditmemoGrid testResult = dao.find(id);
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[1].getOrderBaseGrandTotal(),
