...
public class CatalogProductIndexPriceBundleSelTmpDaoTestIt {
  static final String inputFile = "CatalogProductIndexPriceBundleSelTmp.json";
  static CatalogProductIndexPriceBundleSelTmpDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultCatalogProductIndexPriceBundleSelTmpDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    CatalogProductIndexPriceBundleSelTmp testResult = dao.find(id);
