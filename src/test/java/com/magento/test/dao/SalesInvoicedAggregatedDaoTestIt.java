...
public class SalesInvoicedAggregatedDaoTestIt {
  static final String inputFile = "SalesInvoicedAggregated.json";
  static SalesInvoicedAggregatedDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultSalesInvoicedAggregatedDao(jpa);
  }
  ...
  public void testSelect() {
    ...
    SalesInvoicedAggregated testResult = dao.find(id);
