...
public class TemandoQuotePickupLocationDaoTestIt {
  static final String inputFile = "TemandoQuotePickupLocation.json";
  static TemandoQuotePickupLocationDao dao;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void beforeClass() {
    ...
    dao = new DefaultTemandoQuotePickupLocationDao(jpa);
  }
  ...
  public void testSelect() {
    TemandoQuotePickupLocation testResult = dao.find(records[1].getEntityId());
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[1].getPickupLocationId(),
