...
public class CatalogProductIndexPriceCfgOptTmpServiceTest {
  private static DefaultCatalogProductIndexPriceCfgOptTmpService serviceMock;
  private static CatalogProductIndexPriceCfgOptTmp[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultCatalogProductIndexPriceCfgOptTmpService.class);
    String inputFile = "CatalogProductIndexPriceCfgOptTmp.json";
    try {
  ...
  public void testFind_success() {
    final CatalogProductIndexPriceCfgOptTmpId id =
        new CatalogProductIndexPriceCfgOptTmpId(
            records[0].getEntityId(), records[0].getCustomerGroupId(), records[0].getWebsiteId());
    CatalogProductIndexPriceCfgOptTmp testResult = serviceMock.find(id);
