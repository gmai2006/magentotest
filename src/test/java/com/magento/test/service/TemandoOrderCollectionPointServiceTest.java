...
public class TemandoOrderCollectionPointServiceTest {
  private static DefaultTemandoOrderCollectionPointService serviceMock;
  private static TemandoOrderCollectionPoint[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultTemandoOrderCollectionPointService.class);
    String inputFile = "TemandoOrderCollectionPoint.json";
    try {
  ...
  public void testFind_success() {
    TemandoOrderCollectionPoint testResult = serviceMock.find(records[0].getRecipientAddressId());
