...
public class SalesCreditmemoServiceTest {
  private static DefaultSalesCreditmemoService serviceMock;
  private static SalesCreditmemo[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultSalesCreditmemoService.class);
    String inputFile = "SalesCreditmemo.json";
    try {
  ...
  public void testFind_success() {
    final SalesCreditmemoId id =
        new SalesCreditmemoId(
            records[0].getStoreId(), records[0].getIncrementId(), records[0].getEntityId());
    SalesCreditmemo testResult = serviceMock.find(id);
    ...
    org.junit.Assert.assertEquals(
        "expect equals adjustment ", records[0].getAdjustment(), testResult.getAdjustment());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertTrue(
        ...
        records[0].getCreditmemoStatus() == testResult.getCreditmemoStatus());
    org.junit.Assert.assertTrue(
