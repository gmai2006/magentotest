...
public class SalesCreditmemoItemServiceTest {
  private static DefaultSalesCreditmemoItemService serviceMock;
  private static SalesCreditmemoItem[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultSalesCreditmemoItemService.class);
    String inputFile = "SalesCreditmemoItem.json";
    try {
  ...
  public void testFind_success() {
    SalesCreditmemoItem testResult = serviceMock.find(records[0].getEntityId());
