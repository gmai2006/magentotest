...
public class EavEntityServiceTest {
  private static DefaultEavEntityService serviceMock;
  private static EavEntity[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultEavEntityService.class);
    String inputFile = "EavEntity.json";
    try {
      String json = FileUtils.readFileFromResource2String(inputFile, Charset.defaultCharset());
      records = gson.fromJson(json, EavEntity[].class);
  ...
  public void testFind_success() {
    EavEntity testResult = serviceMock.find(records[0].getEntityId());
