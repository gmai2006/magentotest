...
public class CatalogProductIndexPriceServiceTest {
  private static DefaultCatalogProductIndexPriceService serviceMock;
  private static CatalogProductIndexPrice[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultCatalogProductIndexPriceService.class);
    String inputFile = "CatalogProductIndexPrice.json";
    try {
  ...
  public void testFind_success() {
    final CatalogProductIndexPriceId id =
        new CatalogProductIndexPriceId(
            records[0].getEntityId(), records[0].getCustomerGroupId(), records[0].getWebsiteId());
    CatalogProductIndexPrice testResult = serviceMock.find(id);
