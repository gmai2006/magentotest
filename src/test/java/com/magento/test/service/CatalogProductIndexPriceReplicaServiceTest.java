...
public class CatalogProductIndexPriceReplicaServiceTest {
  private static DefaultCatalogProductIndexPriceReplicaService serviceMock;
  private static CatalogProductIndexPriceReplica[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultCatalogProductIndexPriceReplicaService.class);
    String inputFile = "CatalogProductIndexPriceReplica.json";
    try {
  ...
  public void testFind_success() {
    final CatalogProductIndexPriceReplicaId id =
        new CatalogProductIndexPriceReplicaId(
            records[0].getEntityId(), records[0].getCustomerGroupId(), records[0].getWebsiteId());
    CatalogProductIndexPriceReplica testResult = serviceMock.find(id);
