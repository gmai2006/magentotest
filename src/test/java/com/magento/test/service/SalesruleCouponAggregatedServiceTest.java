...
public class SalesruleCouponAggregatedServiceTest {
  private static DefaultSalesruleCouponAggregatedService serviceMock;
  private static SalesruleCouponAggregated[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultSalesruleCouponAggregatedService.class);
    String inputFile = "SalesruleCouponAggregated.json";
    try {
  ...
  public void testFind_success() {
    final SalesruleCouponAggregatedId id =
        new SalesruleCouponAggregatedId(
            ...
            records[0].getCouponCode(),
            records[0].getId());
    SalesruleCouponAggregated testResult = serviceMock.find(id);
