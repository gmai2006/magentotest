...
public class RatingOptionServiceTest {
  private static DefaultRatingOptionService serviceMock;
  private static RatingOption[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultRatingOptionService.class);
    String inputFile = "RatingOption.json";
    try {
  ...
  public void testFind_success() {
    RatingOption testResult = serviceMock.find(records[0].getOptionId());
