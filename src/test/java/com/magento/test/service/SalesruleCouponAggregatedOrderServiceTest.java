...
public class SalesruleCouponAggregatedOrderServiceTest {
  private static DefaultSalesruleCouponAggregatedOrderService serviceMock;
  private static SalesruleCouponAggregatedOrder[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultSalesruleCouponAggregatedOrderService.class);
    String inputFile = "SalesruleCouponAggregatedOrder.json";
    try {
  ...
  public void testFind_success() {
    final SalesruleCouponAggregatedOrderId id =
        new SalesruleCouponAggregatedOrderId(
            ...
            records[0].getCouponCode(),
            records[0].getId());
    SalesruleCouponAggregatedOrder testResult = serviceMock.find(id);
