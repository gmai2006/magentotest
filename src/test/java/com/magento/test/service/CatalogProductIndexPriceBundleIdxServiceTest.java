...
public class CatalogProductIndexPriceBundleIdxServiceTest {
  private static DefaultCatalogProductIndexPriceBundleIdxService serviceMock;
  private static CatalogProductIndexPriceBundleIdx[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultCatalogProductIndexPriceBundleIdxService.class);
    String inputFile = "CatalogProductIndexPriceBundleIdx.json";
    try {
  ...
  public void testFind_success() {
    final CatalogProductIndexPriceBundleIdxId id =
        new CatalogProductIndexPriceBundleIdxId(
            records[0].getEntityId(), records[0].getCustomerGroupId(), records[0].getWebsiteId());
    CatalogProductIndexPriceBundleIdx testResult = serviceMock.find(id);
