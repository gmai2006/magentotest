...
public class SalesInvoicedAggregatedOrderServiceTest {
  private static DefaultSalesInvoicedAggregatedOrderService serviceMock;
  private static SalesInvoicedAggregatedOrder[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultSalesInvoicedAggregatedOrderService.class);
    String inputFile = "SalesInvoicedAggregatedOrder.json";
    try {
  ...
  public void testFind_success() {
    final SalesInvoicedAggregatedOrderId id =
        new SalesInvoicedAggregatedOrderId(
            ...
            records[0].getPeriod(),
            records[0].getId());
    SalesInvoicedAggregatedOrder testResult = serviceMock.find(id);
