...
public class SalesOrderAddressServiceTest {
  private static DefaultSalesOrderAddressService serviceMock;
  private static SalesOrderAddress[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultSalesOrderAddressService.class);
    String inputFile = "SalesOrderAddress.json";
    try {
  ...
  public void testFind_success() {
    SalesOrderAddress testResult = serviceMock.find(records[0].getEntityId());
