...
public class CatalogProductIndexPriceFinalTmpServiceTest {
  private static DefaultCatalogProductIndexPriceFinalTmpService serviceMock;
  private static CatalogProductIndexPriceFinalTmp[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultCatalogProductIndexPriceFinalTmpService.class);
    String inputFile = "CatalogProductIndexPriceFinalTmp.json";
    try {
  ...
  public void testFind_success() {
    final CatalogProductIndexPriceFinalTmpId id =
        new CatalogProductIndexPriceFinalTmpId(
            records[0].getEntityId(), records[0].getCustomerGroupId(), records[0].getWebsiteId());
    CatalogProductIndexPriceFinalTmp testResult = serviceMock.find(id);
