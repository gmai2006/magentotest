...
public class CatalogProductIndexPriceBundleSelIdxServiceTest {
  private static DefaultCatalogProductIndexPriceBundleSelIdxService serviceMock;
  private static CatalogProductIndexPriceBundleSelIdx[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultCatalogProductIndexPriceBundleSelIdxService.class);
    String inputFile = "CatalogProductIndexPriceBundleSelIdx.json";
    try {
  ...
  public void testFind_success() {
    final CatalogProductIndexPriceBundleSelIdxId id =
        new CatalogProductIndexPriceBundleSelIdxId(
            ...
            records[0].getCustomerGroupId(),
            records[0].getWebsiteId());
    CatalogProductIndexPriceBundleSelIdx testResult = serviceMock.find(id);
