...
public class CatalogruleProductReplicaServiceTest {
  private static DefaultCatalogruleProductReplicaService serviceMock;
  private static CatalogruleProductReplica[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultCatalogruleProductReplicaService.class);
    String inputFile = "CatalogruleProductReplica.json";
    try {
  ...
  public void testFind_success() {
    final CatalogruleProductReplicaId id =
        new CatalogruleProductReplicaId(
            ...
            records[0].getSortOrder(),
            records[0].getWebsiteId());
    CatalogruleProductReplica testResult = serviceMock.find(id);
