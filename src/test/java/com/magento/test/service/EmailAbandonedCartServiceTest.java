...
public class EmailAbandonedCartServiceTest {
  private static DefaultEmailAbandonedCartService serviceMock;
  private static EmailAbandonedCart[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultEmailAbandonedCartService.class);
    String inputFile = "EmailAbandonedCart.json";
    try {
  ...
  public void testFind_success() {
    EmailAbandonedCart testResult = serviceMock.find(records[0].getId());
    ...
    org.junit.Assert.assertTrue(
        ...
        records[0].getAbandonedCartNumber() == testResult.getAbandonedCartNumber());
    org.junit.Assert.assertTrue(
        "expect equals itemsCount ", records[0].getItemsCount() == testResult.getItemsCount());
    org.junit.Assert.assertEquals(
        "expect equals itemsIds ", records[0].getItemsIds(), testResult.getItemsIds());
  }
}
