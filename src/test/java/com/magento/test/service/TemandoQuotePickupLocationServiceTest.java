...
public class TemandoQuotePickupLocationServiceTest {
  private static DefaultTemandoQuotePickupLocationService serviceMock;
  private static TemandoQuotePickupLocation[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultTemandoQuotePickupLocationService.class);
    String inputFile = "TemandoQuotePickupLocation.json";
    try {
  ...
  public void testFind_success() {
    TemandoQuotePickupLocation testResult = serviceMock.find(records[0].getEntityId());
