...
public class WeeeTaxServiceTest {
  private static DefaultWeeeTaxService serviceMock;
  private static WeeeTax[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultWeeeTaxService.class);
    String inputFile = "WeeeTax.json";
    try {
  ...
  public void testFind_success() {
    WeeeTax testResult = serviceMock.find(records[0].getValueId());
