...
public class NewsletterTemplateServiceTest {
  private static DefaultNewsletterTemplateService serviceMock;
  private static NewsletterTemplate[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultNewsletterTemplateService.class);
    String inputFile = "NewsletterTemplate.json";
    try {
    ...
    // test data
    when(serviceMock.find(records[0].getTemplateId())).thenReturn(records[0]);
  }

  @Test
  public void testFind_success() {
    NewsletterTemplate testResult = serviceMock.find(records[0].getTemplateId());

    org.junit.Assert.assertNotNull(testResult);
    org.junit.Assert.assertEquals(
        "expect equals templateCode ", records[0].getTemplateCode(), testResult.getTemplateCode());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertTrue(
        ...
        records[0].getTemplateActual() == testResult.getTemplateActual());
  }
}
