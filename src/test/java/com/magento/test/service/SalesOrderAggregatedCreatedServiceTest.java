...
public class SalesOrderAggregatedCreatedServiceTest {
  private static DefaultSalesOrderAggregatedCreatedService serviceMock;
  private static SalesOrderAggregatedCreated[] records;
  static Gson gson =
      new GsonBuilder()
  ...
  public static void setUp() {
    serviceMock = mock(DefaultSalesOrderAggregatedCreatedService.class);
    String inputFile = "SalesOrderAggregatedCreated.json";
    try {
  ...
  public void testFind_success() {
    final SalesOrderAggregatedCreatedId id =
        new SalesOrderAggregatedCreatedId(
            ...
            records[0].getPeriod(),
            records[0].getId());
    SalesOrderAggregatedCreated testResult = serviceMock.find(id);
