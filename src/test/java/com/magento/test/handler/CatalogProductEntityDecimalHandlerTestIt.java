...
import com.magento.test.dao.DefaultCatalogProductEntityDecimalDao;
...
public class CatalogProductEntityDecimalHandlerTestIt {
  static final String inputFile = "CatalogProductEntityDecimal.json";
  static CatalogProductEntityDecimalHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogProductEntityDecimal testResult = jpa.find(CatalogProductEntityDecimal.class, id);
