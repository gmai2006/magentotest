...
import com.magento.test.dao.DefaultEavEntityTextDao;
...
public class EavEntityTextHandlerTestIt {
  static final String inputFile = "EavEntityText.json";
  static EavEntityTextHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    EavEntityText testResult = jpa.find(EavEntityText.class, id);
