...
import com.magento.test.dao.DefaultCatalogProductIndexPriceDownlodIdxDao;
...
public class CatalogProductIndexPriceDownlodIdxHandlerTestIt {
  static final String inputFile = "CatalogProductIndexPriceDownlodIdx.json";
  static CatalogProductIndexPriceDownlodIdxHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private CatalogProductIndexPriceDownlodIdx[] records;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogProductIndexPriceDownlodIdx testResult =
        jpa.find(CatalogProductIndexPriceDownlodIdx.class, id);
    assertEquals(
