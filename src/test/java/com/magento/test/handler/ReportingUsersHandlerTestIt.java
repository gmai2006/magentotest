...
import com.magento.test.dao.DefaultReportingUsersDao;
...
public class ReportingUsersHandlerTestIt {
  static final String inputFile = "ReportingUsers.json";
  static ReportingUsersHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private ReportingUsers[] records;
  ...
  public void testSelect() throws IOException {
    ...
    ReportingUsers testResult = jpa.find(ReportingUsers.class, records[0].getEntityId());
