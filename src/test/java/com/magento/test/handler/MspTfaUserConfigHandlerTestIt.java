...
import com.magento.test.dao.DefaultMspTfaUserConfigDao;
...
public class MspTfaUserConfigHandlerTestIt {
  static final String inputFile = "MspTfaUserConfig.json";
  static MspTfaUserConfigHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private MspTfaUserConfig[] records;
