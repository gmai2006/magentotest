...
import com.magento.test.dao.DefaultEmailOrderDao;
...
public class EmailOrderHandlerTestIt {
  static final String inputFile = "EmailOrder.json";
  static EmailOrderHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    EmailOrder testResult = jpa.find(EmailOrder.class, records[0].getEmailOrderId());
