...
import com.magento.test.dao.DefaultSignifydCaseDao;
...
public class SignifydCaseHandlerTestIt {
  static final String inputFile = "SignifydCase.json";
  static SignifydCaseHandler handler;
