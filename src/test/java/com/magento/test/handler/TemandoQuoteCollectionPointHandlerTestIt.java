...
import com.magento.test.dao.DefaultTemandoQuoteCollectionPointDao;
...
public class TemandoQuoteCollectionPointHandlerTestIt {
  static final String inputFile = "TemandoQuoteCollectionPoint.json";
  static TemandoQuoteCollectionPointHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    TemandoQuoteCollectionPoint testResult =
        jpa.find(TemandoQuoteCollectionPoint.class, records[0].getEntityId());
    ...
    assertEquals(
        ...
        this.records[0].getCollectionPointId(),
