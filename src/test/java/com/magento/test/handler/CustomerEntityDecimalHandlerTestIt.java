...
import com.magento.test.dao.DefaultCustomerEntityDecimalDao;
...
public class CustomerEntityDecimalHandlerTestIt {
  static final String inputFile = "CustomerEntityDecimal.json";
  static CustomerEntityDecimalHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CustomerEntityDecimal testResult = jpa.find(CustomerEntityDecimal.class, id);
