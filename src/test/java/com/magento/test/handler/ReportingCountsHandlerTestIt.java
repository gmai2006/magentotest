...
import com.magento.test.dao.DefaultReportingCountsDao;
...
public class ReportingCountsHandlerTestIt {
  static final String inputFile = "ReportingCounts.json";
  static ReportingCountsHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    ReportingCounts testResult = jpa.find(ReportingCounts.class, records[0].getEntityId());
