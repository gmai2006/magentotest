...
import com.magento.test.dao.DefaultEmailReviewDao;
...
public class EmailReviewHandlerTestIt {
  static final String inputFile = "EmailReview.json";
  static EmailReviewHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, EmailReview[].class);
    assertEquals("match count", count, records.length);
    EmailReview testResult = jpa.find(EmailReview.class, records[0].getId());
    org.junit.Assert.assertEquals(
        "expect equals reviewId ", this.records[0].getReviewId(), testResult.getReviewId());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[0].getReviewImported(),
        testResult.getReviewImported());
