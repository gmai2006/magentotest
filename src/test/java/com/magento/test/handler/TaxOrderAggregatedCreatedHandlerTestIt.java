...
import com.magento.test.dao.DefaultTaxOrderAggregatedCreatedDao;
...
public class TaxOrderAggregatedCreatedHandlerTestIt {
  static final String inputFile = "TaxOrderAggregatedCreated.json";
  static TaxOrderAggregatedCreatedHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private TaxOrderAggregatedCreated[] records;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, TaxOrderAggregatedCreated[].class);
    assertEquals("match count", count, records.length);
    final TaxOrderAggregatedCreatedId id =
        new TaxOrderAggregatedCreatedId(
            this.records[0].getStoreId(),
            this.records[0].getOrderStatus(),
            this.records[0].getPeriod(),
            this.records[0].getCode(),
            this.records[0].getId(),
            this.records[0].getPercent());
    TaxOrderAggregatedCreated testResult = jpa.find(TaxOrderAggregatedCreated.class, id);
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[0].getTaxBaseAmountSum(),
        testResult.getTaxBaseAmountSum());
