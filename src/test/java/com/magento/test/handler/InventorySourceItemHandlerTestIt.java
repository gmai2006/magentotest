...
import com.magento.test.dao.DefaultInventorySourceItemDao;
...
public class InventorySourceItemHandlerTestIt {
  static final String inputFile = "InventorySourceItem.json";
  static InventorySourceItemHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    final InventorySourceItemId id =
        new InventorySourceItemId(
            this.records[0].getSourceItemId(),
            this.records[0].getSku(),
            this.records[0].getSourceCode());
    InventorySourceItem testResult = jpa.find(InventorySourceItem.class, id);
    assertEquals(
