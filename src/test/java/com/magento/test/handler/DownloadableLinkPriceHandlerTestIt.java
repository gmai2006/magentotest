...
import com.magento.test.dao.DefaultDownloadableLinkPriceDao;
...
public class DownloadableLinkPriceHandlerTestIt {
  static final String inputFile = "DownloadableLinkPrice.json";
  static DownloadableLinkPriceHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private DownloadableLinkPrice[] records;
  ...
  public void testSelect() throws IOException {
    ...
    DownloadableLinkPrice testResult =
        jpa.find(DownloadableLinkPrice.class, records[0].getPriceId());
