...
import com.magento.test.dao.DefaultReportViewedProductIndexDao;
...
public class ReportViewedProductIndexHandlerTestIt {
  static final String inputFile = "ReportViewedProductIndex.json";
  static ReportViewedProductIndexHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private ReportViewedProductIndex[] records;
  ...
  public void testSelect() throws IOException {
    ...
    ReportViewedProductIndex testResult = jpa.find(ReportViewedProductIndex.class, id);
