...
import com.magento.test.dao.DefaultCatalogProductBundleSelectionPriceDao;
...
public class CatalogProductBundleSelectionPriceHandlerTestIt {
  static final String inputFile = "CatalogProductBundleSelectionPrice.json";
  static CatalogProductBundleSelectionPriceHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private CatalogProductBundleSelectionPrice[] records;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogProductBundleSelectionPrice testResult =
        jpa.find(CatalogProductBundleSelectionPrice.class, id);
    org.junit.Assert.assertEquals(
        "expect equals selectionPriceType ",
        this.records[0].getSelectionPriceType(),
        testResult.getSelectionPriceType());
    assertEquals(
        "expect equals selectionPriceValue ",
        this.records[0].getSelectionPriceValue(),
