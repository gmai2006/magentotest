...
import com.magento.test.dao.DefaultCatalogProductBundleSelectionDao;
...
public class CatalogProductBundleSelectionHandlerTestIt {
  static final String inputFile = "CatalogProductBundleSelection.json";
  static CatalogProductBundleSelectionHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogProductBundleSelection testResult =
        jpa.find(CatalogProductBundleSelection.class, records[0].getSelectionId());
    ...
    assertEquals(
        ...
        this.records[0].getSelectionQty(),
        testResult.getSelectionQty());
    org.junit.Assert.assertEquals(
        "expect equals selectionCanChangeQty ",
        this.records[0].getSelectionCanChangeQty(),
        testResult.getSelectionCanChangeQty());
