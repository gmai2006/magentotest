...
import com.magento.test.dao.DefaultAdminSystemMessagesDao;
...
public class AdminSystemMessagesHandlerTestIt {
  static final String inputFile = "AdminSystemMessages.json";
  static AdminSystemMessagesHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private AdminSystemMessages[] records;
  ...
  public void testSelect() throws IOException {
    ...
    AdminSystemMessages testResult = jpa.find(AdminSystemMessages.class, records[0].getIdentity());
