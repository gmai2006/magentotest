...
import com.magento.test.dao.DefaultUrlRewriteDao;
...
public class UrlRewriteHandlerTestIt {
  static final String inputFile = "UrlRewrite.json";
  static UrlRewriteHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    final UrlRewriteId id =
        new UrlRewriteId(
            ...
            this.records[0].getRequestPath());
    UrlRewrite testResult = jpa.find(UrlRewrite.class, id);
    assertEquals(
    ...
    assertEquals(
        "expect equals targetPath ", this.records[0].getTargetPath(), testResult.getTargetPath());
    org.junit.Assert.assertEquals(
        "expect equals redirectType ",
        this.records[0].getRedirectType(),
        testResult.getRedirectType());
    assertEquals(
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[0].getIsAutogenerated(),
        testResult.getIsAutogenerated());
    assertEquals(
