...
import com.magento.test.dao.DefaultSalesInvoiceItemDao;
...
public class SalesInvoiceItemHandlerTestIt {
  static final String inputFile = "SalesInvoiceItem.json";
  static SalesInvoiceItemHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private SalesInvoiceItem[] records;
  ...
  public void testSelect() throws IOException {
    ...
    SalesInvoiceItem testResult = jpa.find(SalesInvoiceItem.class, records[0].getEntityId());
