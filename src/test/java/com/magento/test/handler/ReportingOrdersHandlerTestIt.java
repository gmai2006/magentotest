...
import com.magento.test.dao.DefaultReportingOrdersDao;
...
public class ReportingOrdersHandlerTestIt {
  static final String inputFile = "ReportingOrders.json";
  static ReportingOrdersHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private ReportingOrders[] records;
  ...
  public void testSelect() throws IOException {
    ...
    ReportingOrders testResult = jpa.find(ReportingOrders.class, records[0].getEntityId());
    ...
    assertEquals(
        "expect equals totalBase ", this.records[0].getTotalBase(), testResult.getTotalBase());
    org.junit.Assert.assertEquals(
