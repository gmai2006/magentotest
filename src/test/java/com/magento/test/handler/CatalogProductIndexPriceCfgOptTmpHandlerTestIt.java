...
import com.magento.test.dao.DefaultCatalogProductIndexPriceCfgOptTmpDao;
...
public class CatalogProductIndexPriceCfgOptTmpHandlerTestIt {
  static final String inputFile = "CatalogProductIndexPriceCfgOptTmp.json";
  static CatalogProductIndexPriceCfgOptTmpHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogProductIndexPriceCfgOptTmp testResult =
        jpa.find(CatalogProductIndexPriceCfgOptTmp.class, id);
    assertEquals(
