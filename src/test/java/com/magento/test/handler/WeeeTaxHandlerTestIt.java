...
import com.magento.test.dao.DefaultWeeeTaxDao;
...
public class WeeeTaxHandlerTestIt {
  static final String inputFile = "WeeeTax.json";
  static WeeeTaxHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    WeeeTax testResult = jpa.find(WeeeTax.class, records[0].getValueId());
