...
import com.magento.test.dao.DefaultTaxCalculationRuleDao;
...
public class TaxCalculationRuleHandlerTestIt {
  static final String inputFile = "TaxCalculationRule.json";
  static TaxCalculationRuleHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private TaxCalculationRule[] records;
  ...
  public void testSelect() throws IOException {
    ...
    TaxCalculationRule testResult =
        jpa.find(TaxCalculationRule.class, records[0].getTaxCalculationRuleId());
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[0].getCalculateSubtotal(),
        testResult.getCalculateSubtotal());
