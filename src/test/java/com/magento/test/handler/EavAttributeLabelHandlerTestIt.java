...
import com.magento.test.dao.DefaultEavAttributeLabelDao;
...
public class EavAttributeLabelHandlerTestIt {
  static final String inputFile = "EavAttributeLabel.json";
  static EavAttributeLabelHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    EavAttributeLabel testResult =
        jpa.find(EavAttributeLabel.class, records[0].getAttributeLabelId());
