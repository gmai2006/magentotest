...
import com.magento.test.dao.DefaultReportEventDao;
...
public class ReportEventHandlerTestIt {
  static final String inputFile = "ReportEvent.json";
  static ReportEventHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    ReportEvent testResult = jpa.find(ReportEvent.class, records[0].getEventId());
    org.junit.Assert.assertEquals(
        "expect equals eventTypeId ",
        this.records[0].getEventTypeId(),
        testResult.getEventTypeId());
    org.junit.Assert.assertEquals(
        "expect equals objectId ", this.records[0].getObjectId(), testResult.getObjectId());
    org.junit.Assert.assertEquals(
        "expect equals subjectId ", this.records[0].getSubjectId(), testResult.getSubjectId());
    org.junit.Assert.assertEquals(
        "expect equals subtype ", this.records[0].getSubtype(), testResult.getSubtype());
    org.junit.Assert.assertEquals(
