...
import com.magento.test.dao.DefaultSalesOrderTaxDao;
...
public class SalesOrderTaxHandlerTestIt {
  static final String inputFile = "SalesOrderTax.json";
  static SalesOrderTaxHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    SalesOrderTax testResult = jpa.find(SalesOrderTax.class, records[0].getTaxId());
    ...
    assertEquals("expect equals percent ", this.records[0].getPercent(), testResult.getPercent());
    ...
    org.junit.Assert.assertEquals(
        "expect equals process ", this.records[0].getProcess(), testResult.getProcess());
    assertEquals(
        "expect equals baseRealAmount ",
        this.records[0].getBaseRealAmount(),
