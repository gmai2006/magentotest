...
import com.magento.test.dao.DefaultSalesBestsellersAggregatedYearlyDao;
...
public class SalesBestsellersAggregatedYearlyHandlerTestIt {
  static final String inputFile = "SalesBestsellersAggregatedYearly.json";
  static SalesBestsellersAggregatedYearlyHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private SalesBestsellersAggregatedYearly[] records;
  ...
  public void testSelect() throws IOException {
    ...
    SalesBestsellersAggregatedYearly testResult =
        jpa.find(SalesBestsellersAggregatedYearly.class, id);
    assertEquals(
