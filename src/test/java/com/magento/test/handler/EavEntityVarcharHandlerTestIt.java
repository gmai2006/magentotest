...
import com.magento.test.dao.DefaultEavEntityVarcharDao;
...
public class EavEntityVarcharHandlerTestIt {
  static final String inputFile = "EavEntityVarchar.json";
  static EavEntityVarcharHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    EavEntityVarchar testResult = jpa.find(EavEntityVarchar.class, id);
