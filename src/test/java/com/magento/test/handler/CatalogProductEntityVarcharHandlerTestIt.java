...
import com.magento.test.dao.DefaultCatalogProductEntityVarcharDao;
...
public class CatalogProductEntityVarcharHandlerTestIt {
  static final String inputFile = "CatalogProductEntityVarchar.json";
  static CatalogProductEntityVarcharHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogProductEntityVarchar testResult = jpa.find(CatalogProductEntityVarchar.class, id);
