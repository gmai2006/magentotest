...
import com.magento.test.dao.DefaultCustomerEntityDao;
...
public class CustomerEntityHandlerTestIt {
  static final String inputFile = "CustomerEntity.json";
  static CustomerEntityHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private CustomerEntity[] records;
  ...
  public void testSelect() throws IOException {
    ...
    final CustomerEntityId id =
        new CustomerEntityId(
            ...
            this.records[0].getEmail());
    CustomerEntity testResult = jpa.find(CustomerEntity.class, id);
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[0].getDisableAutoGroupChange(),
        testResult.getDisableAutoGroupChange());
    assertEquals(
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[0].getDefaultBilling(),
        testResult.getDefaultBilling());
    org.junit.Assert.assertEquals(
        "expect equals defaultShipping ",
        this.records[0].getDefaultShipping(),
        testResult.getDefaultShipping());
