...
import com.magento.test.dao.DefaultTranslationDao;
...
public class TranslationHandlerTestIt {
  static final String inputFile = "Translation.json";
  static TranslationHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    final TranslationId id =
        new TranslationId(
            ...
            this.records[0].getString(),
            this.records[0].getKeyId(),
            this.records[0].getCrcString(),
            this.records[0].getLocale());
    Translation testResult = jpa.find(Translation.class, id);
    assertEquals(
        "expect equals translate ", this.records[0].getTranslate(), testResult.getTranslate());
