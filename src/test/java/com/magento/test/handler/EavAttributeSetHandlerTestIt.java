...
import com.magento.test.dao.DefaultEavAttributeSetDao;
...
public class EavAttributeSetHandlerTestIt {
  static final String inputFile = "EavAttributeSet.json";
  static EavAttributeSetHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private EavAttributeSet[] records;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, EavAttributeSet[].class);
    assertEquals("match count", count, records.length);
    final EavAttributeSetId id =
        new EavAttributeSetId(
            this.records[0].getAttributeSetName(),
            this.records[0].getAttributeSetId(),
            this.records[0].getEntityTypeId());
    EavAttributeSet testResult = jpa.find(EavAttributeSet.class, id);
