...
import com.magento.test.dao.DefaultSalesShippingAggregatedDao;
...
public class SalesShippingAggregatedHandlerTestIt {
  static final String inputFile = "SalesShippingAggregated.json";
  static SalesShippingAggregatedHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private SalesShippingAggregated[] records;
  ...
  public void testSelect() throws IOException {
    ...
    SalesShippingAggregated testResult = jpa.find(SalesShippingAggregated.class, id);
