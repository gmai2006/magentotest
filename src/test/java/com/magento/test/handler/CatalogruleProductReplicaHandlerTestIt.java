...
import com.magento.test.dao.DefaultCatalogruleProductReplicaDao;
...
public class CatalogruleProductReplicaHandlerTestIt {
  static final String inputFile = "CatalogruleProductReplica.json";
  static CatalogruleProductReplicaHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    final CatalogruleProductReplicaId id =
        new CatalogruleProductReplicaId(
            ...
            this.records[0].getRuleProductId(),
            this.records[0].getProductId(),
            this.records[0].getToTime(),
            this.records[0].getFromTime(),
            this.records[0].getCustomerGroupId(),
            this.records[0].getSortOrder(),
            this.records[0].getWebsiteId());
    CatalogruleProductReplica testResult = jpa.find(CatalogruleProductReplica.class, id);
    assertEquals(
        "expect equals actionOperator ",
        this.records[0].getActionOperator(),
        testResult.getActionOperator());
    assertEquals(
        "expect equals actionAmount ",
        this.records[0].getActionAmount(),
        testResult.getActionAmount());
    org.junit.Assert.assertEquals(
        "expect equals actionStop ", this.records[0].getActionStop(), testResult.getActionStop());
