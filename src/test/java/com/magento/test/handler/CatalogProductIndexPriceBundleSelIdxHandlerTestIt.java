...
import com.magento.test.dao.DefaultCatalogProductIndexPriceBundleSelIdxDao;
...
public class CatalogProductIndexPriceBundleSelIdxHandlerTestIt {
  static final String inputFile = "CatalogProductIndexPriceBundleSelIdx.json";
  static CatalogProductIndexPriceBundleSelIdxHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogProductIndexPriceBundleSelIdx testResult =
        jpa.find(CatalogProductIndexPriceBundleSelIdx.class, id);
