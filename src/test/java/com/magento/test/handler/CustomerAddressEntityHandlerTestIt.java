...
import com.magento.test.dao.DefaultCustomerAddressEntityDao;
...
public class CustomerAddressEntityHandlerTestIt {
  static final String inputFile = "CustomerAddressEntity.json";
  static CustomerAddressEntityHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CustomerAddressEntity testResult =
        jpa.find(CustomerAddressEntity.class, records[0].getEntityId());
    assertEquals(
