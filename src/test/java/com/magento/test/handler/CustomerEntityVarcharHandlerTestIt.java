...
import com.magento.test.dao.DefaultCustomerEntityVarcharDao;
...
public class CustomerEntityVarcharHandlerTestIt {
  static final String inputFile = "CustomerEntityVarchar.json";
  static CustomerEntityVarcharHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CustomerEntityVarchar testResult = jpa.find(CustomerEntityVarchar.class, id);
