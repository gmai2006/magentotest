...
import com.magento.test.dao.DefaultCatalogProductEntityGalleryDao;
...
public class CatalogProductEntityGalleryHandlerTestIt {
  static final String inputFile = "CatalogProductEntityGallery.json";
  static CatalogProductEntityGalleryHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogProductEntityGallery testResult = jpa.find(CatalogProductEntityGallery.class, id);
