...
import com.magento.test.dao.DefaultInventoryStockDao;
...
public class InventoryStockHandlerTestIt {
  static final String inputFile = "InventoryStock.json";
  static InventoryStockHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private InventoryStock[] records;
  ...
  public void testSelect() throws IOException {
    ...
    InventoryStock testResult = jpa.find(InventoryStock.class, records[0].getStockId());
