...
import com.magento.test.dao.DefaultSalesShipmentTrackDao;
...
public class SalesShipmentTrackHandlerTestIt {
  static final String inputFile = "SalesShipmentTrack.json";
  static SalesShipmentTrackHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    SalesShipmentTrack testResult = jpa.find(SalesShipmentTrack.class, records[0].getEntityId());
