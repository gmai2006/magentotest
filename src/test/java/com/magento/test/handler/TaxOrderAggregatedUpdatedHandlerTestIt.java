...
import com.magento.test.dao.DefaultTaxOrderAggregatedUpdatedDao;
...
public class TaxOrderAggregatedUpdatedHandlerTestIt {
  static final String inputFile = "TaxOrderAggregatedUpdated.json";
  static TaxOrderAggregatedUpdatedHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    TaxOrderAggregatedUpdated testResult = jpa.find(TaxOrderAggregatedUpdated.class, id);
