...
import com.magento.test.dao.DefaultCatalogProductBundleStockIndexDao;
...
public class CatalogProductBundleStockIndexHandlerTestIt {
  static final String inputFile = "CatalogProductBundleStockIndex.json";
  static CatalogProductBundleStockIndexHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private CatalogProductBundleStockIndex[] records;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogProductBundleStockIndex testResult = jpa.find(CatalogProductBundleStockIndex.class, id);
