...
import com.magento.test.dao.DefaultProductAlertPriceDao;
...
public class ProductAlertPriceHandlerTestIt {
  static final String inputFile = "ProductAlertPrice.json";
  static ProductAlertPriceHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private ProductAlertPrice[] records;
  ...
  public void testSelect() throws IOException {
    ...
    ProductAlertPrice testResult = jpa.find(ProductAlertPrice.class, records[0].getAlertPriceId());
