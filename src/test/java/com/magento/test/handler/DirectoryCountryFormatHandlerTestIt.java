...
import com.magento.test.dao.DefaultDirectoryCountryFormatDao;
...
public class DirectoryCountryFormatHandlerTestIt {
  static final String inputFile = "DirectoryCountryFormat.json";
  static DirectoryCountryFormatHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private DirectoryCountryFormat[] records;
  ...
  public void testSelect() throws IOException {
    ...
    final DirectoryCountryFormatId id =
        new DirectoryCountryFormatId(
            this.records[0].getCountryFormatId(),
            this.records[0].getType(),
            this.records[0].getCountryId());
    DirectoryCountryFormat testResult = jpa.find(DirectoryCountryFormat.class, id);
