...
import com.magento.test.dao.DefaultCmsPageStoreDao;
...
public class CmsPageStoreHandlerTestIt {
  static final String inputFile = "CmsPageStore.json";
  static CmsPageStoreHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    final CmsPageStoreId id =
        new CmsPageStoreId(this.records[0].getStoreId(), this.records[0].getPageId());
    CmsPageStore testResult = jpa.find(CmsPageStore.class, id);
