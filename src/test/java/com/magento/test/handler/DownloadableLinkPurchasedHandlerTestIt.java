...
import com.magento.test.dao.DefaultDownloadableLinkPurchasedDao;
...
public class DownloadableLinkPurchasedHandlerTestIt {
  static final String inputFile = "DownloadableLinkPurchased.json";
  static DownloadableLinkPurchasedHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private DownloadableLinkPurchased[] records;
  ...
  public void testSelect() throws IOException {
    ...
    DownloadableLinkPurchased testResult =
        jpa.find(DownloadableLinkPurchased.class, records[0].getPurchasedId());
    ...
    assertEquals(
        "expect equals productSku ", this.records[0].getProductSku(), testResult.getProductSku());
    assertEquals(
        "expect equals linkSectionTitle ",
        this.records[0].getLinkSectionTitle(),
