...
import com.magento.test.dao.DefaultWishlistItemDao;
...
public class WishlistItemHandlerTestIt {
  static final String inputFile = "WishlistItem.json";
  static WishlistItemHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    WishlistItem testResult = jpa.find(WishlistItem.class, records[0].getWishlistItemId());
