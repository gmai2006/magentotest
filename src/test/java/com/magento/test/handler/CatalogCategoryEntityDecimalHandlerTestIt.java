...
import com.magento.test.dao.DefaultCatalogCategoryEntityDecimalDao;
...
public class CatalogCategoryEntityDecimalHandlerTestIt {
  static final String inputFile = "CatalogCategoryEntityDecimal.json";
  static CatalogCategoryEntityDecimalHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogCategoryEntityDecimal testResult = jpa.find(CatalogCategoryEntityDecimal.class, id);
