...
import com.magento.test.dao.DefaultStoreWebsiteDao;
...
public class StoreWebsiteHandlerTestIt {
  static final String inputFile = "StoreWebsite.json";
  static StoreWebsiteHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, StoreWebsite[].class);
    assertEquals("match count", count, records.length);
    final StoreWebsiteId id =
        new StoreWebsiteId(this.records[0].getCode(), this.records[0].getWebsiteId());
    StoreWebsite testResult = jpa.find(StoreWebsite.class, id);
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[0].getDefaultGroupId(),
        testResult.getDefaultGroupId());
    org.junit.Assert.assertEquals(
