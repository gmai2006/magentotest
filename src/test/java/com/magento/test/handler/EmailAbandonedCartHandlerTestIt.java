...
import com.magento.test.dao.DefaultEmailAbandonedCartDao;
...
public class EmailAbandonedCartHandlerTestIt {
  static final String inputFile = "EmailAbandonedCart.json";
  static EmailAbandonedCartHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private EmailAbandonedCart[] records;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, EmailAbandonedCart[].class);
    assertEquals("match count", count, records.length);
    EmailAbandonedCart testResult = jpa.find(EmailAbandonedCart.class, records[0].getId());
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[0].getAbandonedCartNumber(),
        testResult.getAbandonedCartNumber());
    org.junit.Assert.assertEquals(
        "expect equals itemsCount ", this.records[0].getItemsCount(), testResult.getItemsCount());
    assertEquals(
        "expect equals itemsIds ", this.records[0].getItemsIds(), testResult.getItemsIds());
