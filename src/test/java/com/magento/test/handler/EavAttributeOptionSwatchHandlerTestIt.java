...
import com.magento.test.dao.DefaultEavAttributeOptionSwatchDao;
...
public class EavAttributeOptionSwatchHandlerTestIt {
  static final String inputFile = "EavAttributeOptionSwatch.json";
  static EavAttributeOptionSwatchHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private EavAttributeOptionSwatch[] records;
  ...
  public void testSelect() throws IOException {
    ...
    final EavAttributeOptionSwatchId id =
        new EavAttributeOptionSwatchId(
            ...
            this.records[0].getSwatchId(),
            this.records[0].getOptionId());
    EavAttributeOptionSwatch testResult = jpa.find(EavAttributeOptionSwatch.class, id);
