...
import com.magento.test.dao.DefaultCatalogProductBundleOptionDao;
...
public class CatalogProductBundleOptionHandlerTestIt {
  static final String inputFile = "CatalogProductBundleOption.json";
  static CatalogProductBundleOptionHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private CatalogProductBundleOption[] records;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, CatalogProductBundleOption[].class);
    assertEquals("match count", count, records.length);
    CatalogProductBundleOption testResult =
        jpa.find(CatalogProductBundleOption.class, records[0].getOptionId());
    org.junit.Assert.assertEquals(
        "expect equals parentId ", this.records[0].getParentId(), testResult.getParentId());
    org.junit.Assert.assertEquals(
        "expect equals required ", this.records[0].getRequired(), testResult.getRequired());
    org.junit.Assert.assertEquals(
