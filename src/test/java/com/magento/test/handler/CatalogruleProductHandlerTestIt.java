...
import com.magento.test.dao.DefaultCatalogruleProductDao;
...
public class CatalogruleProductHandlerTestIt {
  static final String inputFile = "CatalogruleProduct.json";
  static CatalogruleProductHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogruleProduct testResult = jpa.find(CatalogruleProduct.class, id);
    assertEquals(
