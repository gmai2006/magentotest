...
import com.magento.test.dao.DefaultInventorySourceDao;
...
public class InventorySourceHandlerTestIt {
  static final String inputFile = "InventorySource.json";
  static InventorySourceHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    InventorySource testResult = jpa.find(InventorySource.class, records[0].getSourceCode());
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[0].getUseDefaultCarrierConfig(),
        testResult.getUseDefaultCarrierConfig());
