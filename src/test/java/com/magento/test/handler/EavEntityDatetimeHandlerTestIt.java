...
import com.magento.test.dao.DefaultEavEntityDatetimeDao;
...
public class EavEntityDatetimeHandlerTestIt {
  static final String inputFile = "EavEntityDatetime.json";
  static EavEntityDatetimeHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private EavEntityDatetime[] records;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, EavEntityDatetime[].class);
    assertEquals("match count", count, records.length);
    final EavEntityDatetimeId id =
        new EavEntityDatetimeId(
            this.records[0].getStoreId(),
            this.records[0].getAttributeId(),
            this.records[0].getValueId(),
            this.records[0].getEntityId());
    EavEntityDatetime testResult = jpa.find(EavEntityDatetime.class, id);
