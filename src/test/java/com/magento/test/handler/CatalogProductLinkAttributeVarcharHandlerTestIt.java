...
import com.magento.test.dao.DefaultCatalogProductLinkAttributeVarcharDao;
...
public class CatalogProductLinkAttributeVarcharHandlerTestIt {
  static final String inputFile = "CatalogProductLinkAttributeVarchar.json";
  static CatalogProductLinkAttributeVarcharHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private CatalogProductLinkAttributeVarchar[] records;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogProductLinkAttributeVarchar testResult =
        jpa.find(CatalogProductLinkAttributeVarchar.class, id);
