...
import com.magento.test.dao.DefaultQuoteItemOptionDao;
...
public class QuoteItemOptionHandlerTestIt {
  static final String inputFile = "QuoteItemOption.json";
  static QuoteItemOptionHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    QuoteItemOption testResult = jpa.find(QuoteItemOption.class, records[0].getOptionId());
    org.junit.Assert.assertEquals(
        "expect equals itemId ", this.records[0].getItemId(), testResult.getItemId());
    org.junit.Assert.assertEquals(
