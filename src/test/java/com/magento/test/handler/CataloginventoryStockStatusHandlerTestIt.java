...
import com.magento.test.dao.DefaultCataloginventoryStockStatusDao;
...
public class CataloginventoryStockStatusHandlerTestIt {
  static final String inputFile = "CataloginventoryStockStatus.json";
  static CataloginventoryStockStatusHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private CataloginventoryStockStatus[] records;
  ...
  public void testSelect() throws IOException {
    ...
    CataloginventoryStockStatus testResult = jpa.find(CataloginventoryStockStatus.class, id);
