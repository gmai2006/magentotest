...
import com.magento.test.dao.DefaultEavEntityDao;
...
public class EavEntityHandlerTestIt {
  static final String inputFile = "EavEntity.json";
  static EavEntityHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    EavEntity testResult = jpa.find(EavEntity.class, records[0].getEntityId());
