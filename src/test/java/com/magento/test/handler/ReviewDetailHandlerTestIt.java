...
import com.magento.test.dao.DefaultReviewDetailDao;
...
public class ReviewDetailHandlerTestIt {
  static final String inputFile = "ReviewDetail.json";
  static ReviewDetailHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    ReviewDetail testResult = jpa.find(ReviewDetail.class, records[0].getDetailId());
    ...
    assertEquals("expect equals detail ", this.records[0].getDetail(), testResult.getDetail());
    assertEquals(
        "expect equals nickname ", this.records[0].getNickname(), testResult.getNickname());
    org.junit.Assert.assertEquals(
