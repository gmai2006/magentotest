...
import com.magento.test.dao.DefaultStoreGroupDao;
...
public class StoreGroupHandlerTestIt {
  static final String inputFile = "StoreGroup.json";
  static StoreGroupHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, StoreGroup[].class);
    assertEquals("match count", count, records.length);
    final StoreGroupId id =
        new StoreGroupId(this.records[0].getCode(), this.records[0].getGroupId());
    StoreGroup testResult = jpa.find(StoreGroup.class, id);
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[0].getRootCategoryId(),
        testResult.getRootCategoryId());
    org.junit.Assert.assertEquals(
