...
import com.magento.test.dao.DefaultMspTfaCountryCodesDao;
...
public class MspTfaCountryCodesHandlerTestIt {
  static final String inputFile = "MspTfaCountryCodes.json";
  static MspTfaCountryCodesHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private MspTfaCountryCodes[] records;
  ...
  public void testSelect() throws IOException {
    ...
    MspTfaCountryCodes testResult =
        jpa.find(MspTfaCountryCodes.class, records[0].getMspTfaCountryCodesId());
    ...
    assertEquals(
        "expect equals dialCode ", this.records[0].getDialCode(), testResult.getDialCode());
