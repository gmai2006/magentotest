...
import com.magento.test.dao.DefaultWidgetInstanceDao;
...
public class WidgetInstanceHandlerTestIt {
  static final String inputFile = "WidgetInstance.json";
  static WidgetInstanceHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private WidgetInstance[] records;
  ...
  public void testSelect() throws IOException {
    ...
    WidgetInstance testResult = jpa.find(WidgetInstance.class, records[0].getInstanceId());
    assertEquals(
        "expect equals instanceType ",
        this.records[0].getInstanceType(),
        testResult.getInstanceType());
    ...
    assertEquals(
        "expect equals storeIds ", this.records[0].getStoreIds(), testResult.getStoreIds());
    assertEquals(
        "expect equals widgetParameters ",
        this.records[0].getWidgetParameters(),
