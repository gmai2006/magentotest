...
import com.magento.test.dao.DefaultPersistentSessionDao;
...
public class PersistentSessionHandlerTestIt {
  static final String inputFile = "PersistentSession.json";
  static PersistentSessionHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    final PersistentSessionId id =
        new PersistentSessionId(
            this.records[0].getPersistentId(),
            this.records[0].getCustomerId(),
            this.records[0].getKey());
    PersistentSession testResult = jpa.find(PersistentSession.class, id);
