...
import com.magento.test.dao.DefaultSalesInvoiceCommentDao;
...
public class SalesInvoiceCommentHandlerTestIt {
  static final String inputFile = "SalesInvoiceComment.json";
  static SalesInvoiceCommentHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private SalesInvoiceComment[] records;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, SalesInvoiceComment[].class);
    assertEquals("match count", count, records.length);
    SalesInvoiceComment testResult = jpa.find(SalesInvoiceComment.class, records[0].getEntityId());
