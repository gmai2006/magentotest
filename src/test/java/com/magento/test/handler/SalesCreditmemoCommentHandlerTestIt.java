...
import com.magento.test.dao.DefaultSalesCreditmemoCommentDao;
...
public class SalesCreditmemoCommentHandlerTestIt {
  static final String inputFile = "SalesCreditmemoComment.json";
  static SalesCreditmemoCommentHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private SalesCreditmemoComment[] records;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, SalesCreditmemoComment[].class);
    assertEquals("match count", count, records.length);
    SalesCreditmemoComment testResult =
        jpa.find(SalesCreditmemoComment.class, records[0].getEntityId());
