...
import com.magento.test.dao.DefaultEavFormFieldsetLabelDao;
...
public class EavFormFieldsetLabelHandlerTestIt {
  static final String inputFile = "EavFormFieldsetLabel.json";
  static EavFormFieldsetLabelHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    final EavFormFieldsetLabelId id =
        new EavFormFieldsetLabelId(this.records[0].getStoreId(), this.records[0].getFieldsetId());
    EavFormFieldsetLabel testResult = jpa.find(EavFormFieldsetLabel.class, id);
