...
import com.magento.test.dao.DefaultSalesOrderAggregatedUpdatedDao;
...
public class SalesOrderAggregatedUpdatedHandlerTestIt {
  static final String inputFile = "SalesOrderAggregatedUpdated.json";
  static SalesOrderAggregatedUpdatedHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    SalesOrderAggregatedUpdated testResult = jpa.find(SalesOrderAggregatedUpdated.class, id);
