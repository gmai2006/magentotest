...
import com.magento.test.dao.DefaultCatalogProductIndexEavDecimalTmpDao;
...
public class CatalogProductIndexEavDecimalTmpHandlerTestIt {
  static final String inputFile = "CatalogProductIndexEavDecimalTmp.json";
  static CatalogProductIndexEavDecimalTmpHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogProductIndexEavDecimalTmp testResult =
        jpa.find(CatalogProductIndexEavDecimalTmp.class, id);
