...
import com.magento.test.dao.DefaultEavEntityDecimalDao;
...
public class EavEntityDecimalHandlerTestIt {
  static final String inputFile = "EavEntityDecimal.json";
  static EavEntityDecimalHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    EavEntityDecimal testResult = jpa.find(EavEntityDecimal.class, id);
