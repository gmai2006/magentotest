...
import com.magento.test.dao.DefaultCustomerEavAttributeWebsiteDao;
...
public class CustomerEavAttributeWebsiteHandlerTestIt {
  static final String inputFile = "CustomerEavAttributeWebsite.json";
  static CustomerEavAttributeWebsiteHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private CustomerEavAttributeWebsite[] records;
  ...
  public void testSelect() throws IOException {
    ...
    final CustomerEavAttributeWebsiteId id =
        new CustomerEavAttributeWebsiteId(
            this.records[0].getAttributeId(), this.records[0].getWebsiteId());
    CustomerEavAttributeWebsite testResult = jpa.find(CustomerEavAttributeWebsite.class, id);
