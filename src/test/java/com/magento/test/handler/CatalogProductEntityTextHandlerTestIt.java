...
import com.magento.test.dao.DefaultCatalogProductEntityTextDao;
...
public class CatalogProductEntityTextHandlerTestIt {
  static final String inputFile = "CatalogProductEntityText.json";
  static CatalogProductEntityTextHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogProductEntityText testResult = jpa.find(CatalogProductEntityText.class, id);
