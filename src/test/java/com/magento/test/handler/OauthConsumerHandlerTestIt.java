...
import com.magento.test.dao.DefaultOauthConsumerDao;
...
public class OauthConsumerHandlerTestIt {
  static final String inputFile = "OauthConsumer.json";
  static OauthConsumerHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, OauthConsumer[].class);
    assertEquals("match count", count, records.length);
    final OauthConsumerId id =
        new OauthConsumerId(
            this.records[0].getSecret(), this.records[0].getEntityId(), this.records[0].getKey());
    OauthConsumer testResult = jpa.find(OauthConsumer.class, id);
    ...
    assertEquals(
        ...
        this.records[0].getRejectedCallbackUrl(),
        testResult.getRejectedCallbackUrl());
