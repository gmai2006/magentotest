...
import com.magento.test.dao.DefaultSalesruleCustomerDao;
...
public class SalesruleCustomerHandlerTestIt {
  static final String inputFile = "SalesruleCustomer.json";
  static SalesruleCustomerHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private SalesruleCustomer[] records;
  ...
  public void testSelect() throws IOException {
    ...
    SalesruleCustomer testResult =
        jpa.find(SalesruleCustomer.class, records[0].getRuleCustomerId());
    org.junit.Assert.assertEquals(
        "expect equals ruleId ", this.records[0].getRuleId(), testResult.getRuleId());
    org.junit.Assert.assertEquals(
