...
import com.magento.test.dao.DefaultQueueDao;
...
public class QueueHandlerTestIt {
  static final String inputFile = "Queue.json";
  static QueueHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, Queue[].class);
    assertEquals("match count", count, records.length);
    final QueueId id = new QueueId(this.records[0].getName(), this.records[0].getId());
    Queue testResult = jpa.find(Queue.class, id);
