...
import com.magento.test.dao.DefaultProductAlertStockDao;
...
public class ProductAlertStockHandlerTestIt {
  static final String inputFile = "ProductAlertStock.json";
  static ProductAlertStockHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private ProductAlertStock[] records;
  ...
  public void testSelect() throws IOException {
    ...
    ProductAlertStock testResult = jpa.find(ProductAlertStock.class, records[0].getAlertStockId());
    ...
    org.junit.Assert.assertEquals(
        "expect equals sendCount ", this.records[0].getSendCount(), testResult.getSendCount());
    org.junit.Assert.assertEquals(
