...
import com.magento.test.dao.DefaultTemandoOrderPickupLocationDao;
...
public class TemandoOrderPickupLocationHandlerTestIt {
  static final String inputFile = "TemandoOrderPickupLocation.json";
  static TemandoOrderPickupLocationHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private TemandoOrderPickupLocation[] records;
  ...
  public void testSelect() throws IOException {
    ...
    TemandoOrderPickupLocation testResult =
        jpa.find(TemandoOrderPickupLocation.class, records[0].getRecipientAddressId());
    assertEquals(
