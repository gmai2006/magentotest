...
import com.magento.test.dao.DefaultEmailTemplateDao;
...
public class EmailTemplateHandlerTestIt {
  static final String inputFile = "EmailTemplate.json";
  static EmailTemplateHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    final EmailTemplateId id =
        new EmailTemplateId(this.records[0].getTemplateId(), this.records[0].getTemplateCode());
    EmailTemplate testResult = jpa.find(EmailTemplate.class, id);
    assertEquals(
    ...
    assertEquals(
        ...
        this.records[0].getOrigTemplateCode(),
        testResult.getOrigTemplateCode());
    assertEquals(
        "expect equals origTemplateVariables ",
        this.records[0].getOrigTemplateVariables(),
