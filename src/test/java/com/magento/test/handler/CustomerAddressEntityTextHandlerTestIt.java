...
import com.magento.test.dao.DefaultCustomerAddressEntityTextDao;
...
public class CustomerAddressEntityTextHandlerTestIt {
  static final String inputFile = "CustomerAddressEntityText.json";
  static CustomerAddressEntityTextHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CustomerAddressEntityText testResult = jpa.find(CustomerAddressEntityText.class, id);
