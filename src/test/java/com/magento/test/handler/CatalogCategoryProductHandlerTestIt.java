...
import com.magento.test.dao.DefaultCatalogCategoryProductDao;
...
public class CatalogCategoryProductHandlerTestIt {
  static final String inputFile = "CatalogCategoryProduct.json";
  static CatalogCategoryProductHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private CatalogCategoryProduct[] records;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogCategoryProduct testResult = jpa.find(CatalogCategoryProduct.class, id);
