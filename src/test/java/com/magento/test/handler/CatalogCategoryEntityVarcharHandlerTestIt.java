...
import com.magento.test.dao.DefaultCatalogCategoryEntityVarcharDao;
...
public class CatalogCategoryEntityVarcharHandlerTestIt {
  static final String inputFile = "CatalogCategoryEntityVarchar.json";
  static CatalogCategoryEntityVarcharHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogCategoryEntityVarchar testResult = jpa.find(CatalogCategoryEntityVarchar.class, id);
