...
import com.magento.test.dao.DefaultAuthorizationRoleDao;
...
public class AuthorizationRoleHandlerTestIt {
  static final String inputFile = "AuthorizationRole.json";
  static AuthorizationRoleHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    AuthorizationRole testResult = jpa.find(AuthorizationRole.class, records[0].getRoleId());
    org.junit.Assert.assertEquals(
        "expect equals parentId ", this.records[0].getParentId(), testResult.getParentId());
    org.junit.Assert.assertEquals(
        "expect equals treeLevel ", this.records[0].getTreeLevel(), testResult.getTreeLevel());
    org.junit.Assert.assertEquals(
        "expect equals sortOrder ", this.records[0].getSortOrder(), testResult.getSortOrder());
    assertEquals(
        "expect equals roleType ", this.records[0].getRoleType(), testResult.getRoleType());
    org.junit.Assert.assertEquals(
    ...
    assertEquals(
        "expect equals roleName ", this.records[0].getRoleName(), testResult.getRoleName());
