...
import com.magento.test.dao.DefaultEavEntityIntDao;
...
public class EavEntityIntHandlerTestIt {
  static final String inputFile = "EavEntityInt.json";
  static EavEntityIntHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, EavEntityInt[].class);
    assertEquals("match count", count, records.length);
    final EavEntityIntId id =
        new EavEntityIntId(
            this.records[0].getStoreId(),
            this.records[0].getAttributeId(),
            this.records[0].getValueId(),
            this.records[0].getEntityId());
    EavEntityInt testResult = jpa.find(EavEntityInt.class, id);
