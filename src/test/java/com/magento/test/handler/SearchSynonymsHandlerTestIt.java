...
import com.magento.test.dao.DefaultSearchSynonymsDao;
...
public class SearchSynonymsHandlerTestIt {
  static final String inputFile = "SearchSynonyms.json";
  static SearchSynonymsHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private SearchSynonyms[] records;
  ...
  public void testSelect() throws IOException {
    ...
    SearchSynonyms testResult = jpa.find(SearchSynonyms.class, records[0].getGroupId());
    assertEquals(
        "expect equals synonyms ", this.records[0].getSynonyms(), testResult.getSynonyms());
