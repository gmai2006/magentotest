...
import com.magento.test.dao.DefaultCustomerEntityTextDao;
...
public class CustomerEntityTextHandlerTestIt {
  static final String inputFile = "CustomerEntityText.json";
  static CustomerEntityTextHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CustomerEntityText testResult = jpa.find(CustomerEntityText.class, id);
