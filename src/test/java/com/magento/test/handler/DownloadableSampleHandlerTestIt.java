...
import com.magento.test.dao.DefaultDownloadableSampleDao;
...
public class DownloadableSampleHandlerTestIt {
  static final String inputFile = "DownloadableSample.json";
  static DownloadableSampleHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private DownloadableSample[] records;
  ...
  public void testSelect() throws IOException {
    ...
    DownloadableSample testResult = jpa.find(DownloadableSample.class, records[0].getSampleId());
