...
import com.magento.test.dao.DefaultReviewDao;
...
public class ReviewHandlerTestIt {
  static final String inputFile = "Review.json";
  static ReviewHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, Review[].class);
    assertEquals("match count", count, records.length);
    Review testResult = jpa.find(Review.class, records[0].getReviewId());
    org.junit.Assert.assertEquals(
        "expect equals entityId ", this.records[0].getEntityId(), testResult.getEntityId());
    org.junit.Assert.assertEquals(
        "expect equals entityPkValue ",
        this.records[0].getEntityPkValue(),
        testResult.getEntityPkValue());
    org.junit.Assert.assertEquals(
        "expect equals statusId ", this.records[0].getStatusId(), testResult.getStatusId());
