...
import com.magento.test.dao.DefaultTaxCalculationDao;
...
public class TaxCalculationHandlerTestIt {
  static final String inputFile = "TaxCalculation.json";
  static TaxCalculationHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private TaxCalculation[] records;
  ...
  public void testSelect() throws IOException {
    ...
    TaxCalculation testResult = jpa.find(TaxCalculation.class, records[0].getTaxCalculationId());
    org.junit.Assert.assertEquals(
        "expect equals taxCalculationRateId ",
        this.records[0].getTaxCalculationRateId(),
        testResult.getTaxCalculationRateId());
    org.junit.Assert.assertEquals(
        "expect equals taxCalculationRuleId ",
        this.records[0].getTaxCalculationRuleId(),
        testResult.getTaxCalculationRuleId());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[0].getProductTaxClassId(),
        testResult.getProductTaxClassId());
