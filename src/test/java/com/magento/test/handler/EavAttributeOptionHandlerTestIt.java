...
import com.magento.test.dao.DefaultEavAttributeOptionDao;
...
public class EavAttributeOptionHandlerTestIt {
  static final String inputFile = "EavAttributeOption.json";
  static EavAttributeOptionHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private EavAttributeOption[] records;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, EavAttributeOption[].class);
    assertEquals("match count", count, records.length);
    EavAttributeOption testResult = jpa.find(EavAttributeOption.class, records[0].getOptionId());
