...
import com.magento.test.dao.DefaultWishlistItemOptionDao;
...
public class WishlistItemOptionHandlerTestIt {
  static final String inputFile = "WishlistItemOption.json";
  static WishlistItemOptionHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    WishlistItemOption testResult = jpa.find(WishlistItemOption.class, records[0].getOptionId());
    org.junit.Assert.assertEquals(
        "expect equals wishlistItemId ",
        this.records[0].getWishlistItemId(),
        testResult.getWishlistItemId());
    org.junit.Assert.assertEquals(
