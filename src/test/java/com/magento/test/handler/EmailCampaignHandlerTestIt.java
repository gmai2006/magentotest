...
import com.magento.test.dao.DefaultEmailCampaignDao;
...
public class EmailCampaignHandlerTestIt {
  static final String inputFile = "EmailCampaign.json";
  static EmailCampaignHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, EmailCampaign[].class);
    assertEquals("match count", count, records.length);
    EmailCampaign testResult = jpa.find(EmailCampaign.class, records[0].getId());
    org.junit.Assert.assertEquals(
        "expect equals campaignId ", this.records[0].getCampaignId(), testResult.getCampaignId());
    ...
    assertEquals(
        "expect equals eventName ", this.records[0].getEventName(), testResult.getEventName());
    assertEquals("expect equals sendId ", this.records[0].getSendId(), testResult.getSendId());
    org.junit.Assert.assertEquals(
        "expect equals sendStatus ", this.records[0].getSendStatus(), testResult.getSendStatus());
