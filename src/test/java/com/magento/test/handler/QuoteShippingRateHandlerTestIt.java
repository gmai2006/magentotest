...
import com.magento.test.dao.DefaultQuoteShippingRateDao;
...
public class QuoteShippingRateHandlerTestIt {
  static final String inputFile = "QuoteShippingRate.json";
  static QuoteShippingRateHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private QuoteShippingRate[] records;
  ...
  public void testSelect() throws IOException {
    ...
    QuoteShippingRate testResult = jpa.find(QuoteShippingRate.class, records[0].getRateId());
    org.junit.Assert.assertEquals(
        "expect equals addressId ", this.records[0].getAddressId(), testResult.getAddressId());
    assertEquals("expect equals carrier ", this.records[0].getCarrier(), testResult.getCarrier());
    assertEquals(
        "expect equals carrierTitle ",
        this.records[0].getCarrierTitle(),
        testResult.getCarrierTitle());
    ...
    assertEquals(
        ...
        this.records[0].getMethodDescription(),
    ...
    assertEquals(
        ...
        this.records[0].getErrorMessage(),
        testResult.getErrorMessage());
    assertEquals(
        "expect equals methodTitle ",
        this.records[0].getMethodTitle(),
        testResult.getMethodTitle());
