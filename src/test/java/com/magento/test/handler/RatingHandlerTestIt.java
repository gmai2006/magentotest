...
import com.magento.test.dao.DefaultRatingDao;
...
public class RatingHandlerTestIt {
  static final String inputFile = "Rating.json";
  static RatingHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, Rating[].class);
    assertEquals("match count", count, records.length);
    final RatingId id =
        new RatingId(this.records[0].getRatingId(), this.records[0].getRatingCode());
    Rating testResult = jpa.find(Rating.class, id);
