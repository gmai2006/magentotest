...
import com.magento.test.dao.DefaultSalesInvoicedAggregatedOrderDao;
...
public class SalesInvoicedAggregatedOrderHandlerTestIt {
  static final String inputFile = "SalesInvoicedAggregatedOrder.json";
  static SalesInvoicedAggregatedOrderHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    SalesInvoicedAggregatedOrder testResult = jpa.find(SalesInvoicedAggregatedOrder.class, id);
