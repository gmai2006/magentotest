...
import com.magento.test.dao.DefaultCaptchaLogDao;
...
public class CaptchaLogHandlerTestIt {
  static final String inputFile = "CaptchaLog.json";
  static CaptchaLogHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    final CaptchaLogId id = new CaptchaLogId(this.records[0].getType(), this.records[0].getValue());
    CaptchaLog testResult = jpa.find(CaptchaLog.class, id);
