...
import com.magento.test.dao.DefaultVariableDao;
...
public class VariableHandlerTestIt {
  static final String inputFile = "Variable.json";
  static VariableHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    final VariableId id =
        new VariableId(this.records[0].getCode(), this.records[0].getVariableId());
    Variable testResult = jpa.find(Variable.class, id);
