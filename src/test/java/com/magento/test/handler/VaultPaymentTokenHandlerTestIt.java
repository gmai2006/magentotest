...
import com.magento.test.dao.DefaultVaultPaymentTokenDao;
...
public class VaultPaymentTokenHandlerTestIt {
  static final String inputFile = "VaultPaymentToken.json";
  static VaultPaymentTokenHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    final VaultPaymentTokenId id =
        new VaultPaymentTokenId(
            this.records[0].getPaymentMethodCode(),
            this.records[0].getGatewayToken(),
            this.records[0].getEntityId(),
            this.records[0].getCustomerId(),
            this.records[0].getPublicHash());
    VaultPaymentToken testResult = jpa.find(VaultPaymentToken.class, id);
    assertEquals("expect equals type ", this.records[0].getType(), testResult.getType());
    assertEquals("expect equals details ", this.records[0].getDetails(), testResult.getDetails());
