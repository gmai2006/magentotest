...
import com.magento.test.dao.DefaultTemandoOrderCollectionPointDao;
...
public class TemandoOrderCollectionPointHandlerTestIt {
  static final String inputFile = "TemandoOrderCollectionPoint.json";
  static TemandoOrderCollectionPointHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    TemandoOrderCollectionPoint testResult =
        jpa.find(TemandoOrderCollectionPoint.class, records[0].getRecipientAddressId());
    assertEquals(
