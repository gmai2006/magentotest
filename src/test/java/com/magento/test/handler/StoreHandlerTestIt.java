...
import com.magento.test.dao.DefaultStoreDao;
...
public class StoreHandlerTestIt {
  static final String inputFile = "Store.json";
  ...
  public void testSelect() throws IOException {
    ...
    final StoreId id = new StoreId(this.records[0].getStoreId(), this.records[0].getCode());
    Store testResult = jpa.find(Store.class, id);
