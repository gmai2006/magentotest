...
import com.magento.test.dao.DefaultSalesShippingAggregatedOrderDao;
...
public class SalesShippingAggregatedOrderHandlerTestIt {
  static final String inputFile = "SalesShippingAggregatedOrder.json";
  static SalesShippingAggregatedOrderHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private SalesShippingAggregatedOrder[] records;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, SalesShippingAggregatedOrder[].class);
    assertEquals("match count", count, records.length);
    final SalesShippingAggregatedOrderId id =
        new SalesShippingAggregatedOrderId(
    ...
    SalesShippingAggregatedOrder testResult = jpa.find(SalesShippingAggregatedOrder.class, id);
    ...
    assertEquals(
        ...
        this.records[0].getTotalShipping(),
        testResult.getTotalShipping());
    assertEquals(
        "expect equals totalShippingActual ",
        this.records[0].getTotalShippingActual(),
