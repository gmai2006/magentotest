...
import com.magento.test.dao.DefaultCatalogCategoryEntityTextDao;
...
public class CatalogCategoryEntityTextHandlerTestIt {
  static final String inputFile = "CatalogCategoryEntityText.json";
  static CatalogCategoryEntityTextHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogCategoryEntityText testResult = jpa.find(CatalogCategoryEntityText.class, id);
