...
import com.magento.test.dao.DefaultSalesCreditmemoGridDao;
...
public class SalesCreditmemoGridHandlerTestIt {
  static final String inputFile = "SalesCreditmemoGrid.json";
  static SalesCreditmemoGridHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private SalesCreditmemoGrid[] records;
  ...
  public void testSelect() throws IOException {
    ...
    SalesCreditmemoGrid testResult = jpa.find(SalesCreditmemoGrid.class, id);
    ...
    assertEquals(
        ...
        this.records[0].getOrderBaseGrandTotal(),
