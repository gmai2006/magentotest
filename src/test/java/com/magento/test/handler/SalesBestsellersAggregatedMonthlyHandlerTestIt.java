...
import com.magento.test.dao.DefaultSalesBestsellersAggregatedMonthlyDao;
...
public class SalesBestsellersAggregatedMonthlyHandlerTestIt {
  static final String inputFile = "SalesBestsellersAggregatedMonthly.json";
  static SalesBestsellersAggregatedMonthlyHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private SalesBestsellersAggregatedMonthly[] records;
  ...
  public void testSelect() throws IOException {
    ...
    SalesBestsellersAggregatedMonthly testResult =
        jpa.find(SalesBestsellersAggregatedMonthly.class, id);
    assertEquals(
