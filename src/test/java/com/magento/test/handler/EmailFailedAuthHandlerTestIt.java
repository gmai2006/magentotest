...
import com.magento.test.dao.DefaultEmailFailedAuthDao;
...
public class EmailFailedAuthHandlerTestIt {
  static final String inputFile = "EmailFailedAuth.json";
  static EmailFailedAuthHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private EmailFailedAuth[] records;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, EmailFailedAuth[].class);
    assertEquals("match count", count, records.length);
    EmailFailedAuth testResult = jpa.find(EmailFailedAuth.class, records[0].getId());
