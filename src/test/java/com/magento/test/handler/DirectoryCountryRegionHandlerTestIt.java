...
import com.magento.test.dao.DefaultDirectoryCountryRegionDao;
...
public class DirectoryCountryRegionHandlerTestIt {
  static final String inputFile = "DirectoryCountryRegion.json";
  static DirectoryCountryRegionHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private DirectoryCountryRegion[] records;
  ...
  public void testSelect() throws IOException {
    ...
    DirectoryCountryRegion testResult =
        jpa.find(DirectoryCountryRegion.class, records[0].getRegionId());
    assertEquals(
    ...
    assertEquals(
        ...
        this.records[0].getDefaultName(),
        testResult.getDefaultName());
