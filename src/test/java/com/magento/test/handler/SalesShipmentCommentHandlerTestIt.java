...
import com.magento.test.dao.DefaultSalesShipmentCommentDao;
...
public class SalesShipmentCommentHandlerTestIt {
  static final String inputFile = "SalesShipmentComment.json";
  static SalesShipmentCommentHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private SalesShipmentComment[] records;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, SalesShipmentComment[].class);
    assertEquals("match count", count, records.length);
    SalesShipmentComment testResult =
        jpa.find(SalesShipmentComment.class, records[0].getEntityId());
