...
import com.magento.test.dao.DefaultCatalogCategoryEntityDao;
...
public class CatalogCategoryEntityHandlerTestIt {
  static final String inputFile = "CatalogCategoryEntity.json";
  static CatalogCategoryEntityHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    CatalogCategoryEntity testResult =
        jpa.find(CatalogCategoryEntity.class, records[0].getEntityId());
    ...
    assertEquals("expect equals path ", this.records[0].getPath(), testResult.getPath());
    org.junit.Assert.assertEquals(
        "expect equals position ", this.records[0].getPosition(), testResult.getPosition());
    org.junit.Assert.assertEquals(
        "expect equals level ", this.records[0].getLevel(), testResult.getLevel());
    org.junit.Assert.assertEquals(
        "expect equals childrenCount ",
        this.records[0].getChildrenCount(),
        testResult.getChildrenCount());
