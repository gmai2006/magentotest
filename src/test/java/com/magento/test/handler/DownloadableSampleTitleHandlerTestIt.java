...
import com.magento.test.dao.DefaultDownloadableSampleTitleDao;
...
public class DownloadableSampleTitleHandlerTestIt {
  static final String inputFile = "DownloadableSampleTitle.json";
  static DownloadableSampleTitleHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private DownloadableSampleTitle[] records;
  ...
  public void testSelect() throws IOException {
    ...
    final DownloadableSampleTitleId id =
        new DownloadableSampleTitleId(
            ...
            this.records[0].getSampleId(),
            this.records[0].getTitleId());
    DownloadableSampleTitle testResult = jpa.find(DownloadableSampleTitle.class, id);
