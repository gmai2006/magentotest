...
import com.magento.test.dao.DefaultPaypalBillingAgreementDao;
...
public class PaypalBillingAgreementHandlerTestIt {
  static final String inputFile = "PaypalBillingAgreement.json";
  static PaypalBillingAgreementHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private PaypalBillingAgreement[] records;
  ...
  public void testSelect() throws IOException {
    ...
    PaypalBillingAgreement testResult =
        jpa.find(PaypalBillingAgreement.class, records[0].getAgreementId());
    org.junit.Assert.assertEquals(
        "expect equals customerId ", this.records[0].getCustomerId(), testResult.getCustomerId());
    assertEquals(
        "expect equals methodCode ", this.records[0].getMethodCode(), testResult.getMethodCode());
    assertEquals(
        "expect equals referenceId ",
        this.records[0].getReferenceId(),
        testResult.getReferenceId());
    ...
    assertEquals(
        ...
        this.records[0].getAgreementLabel(),
