...
import com.magento.test.dao.DefaultTaxCalculationRateTitleDao;
...
public class TaxCalculationRateTitleHandlerTestIt {
  static final String inputFile = "TaxCalculationRateTitle.json";
  static TaxCalculationRateTitleHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    TaxCalculationRateTitle testResult =
        jpa.find(TaxCalculationRateTitle.class, records[0].getTaxCalculationRateTitleId());
