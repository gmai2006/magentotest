...
import com.magento.test.dao.DefaultTemandoOrderDao;
...
public class TemandoOrderHandlerTestIt {
  static final String inputFile = "TemandoOrder.json";
  static TemandoOrderHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, TemandoOrder[].class);
    assertEquals("match count", count, records.length);
    TemandoOrder testResult = jpa.find(TemandoOrder.class, records[0].getEntityId());
