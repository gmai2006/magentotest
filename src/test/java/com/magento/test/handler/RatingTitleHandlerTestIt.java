...
import com.magento.test.dao.DefaultRatingTitleDao;
...
public class RatingTitleHandlerTestIt {
  static final String inputFile = "RatingTitle.json";
  static RatingTitleHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    final RatingTitleId id =
        new RatingTitleId(this.records[0].getStoreId(), this.records[0].getRatingId());
    RatingTitle testResult = jpa.find(RatingTitle.class, id);
