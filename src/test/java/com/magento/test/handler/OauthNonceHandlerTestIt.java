...
import com.magento.test.dao.DefaultOauthNonceDao;
...
public class OauthNonceHandlerTestIt {
  static final String inputFile = "OauthNonce.json";
  static OauthNonceHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    records = gson.fromJson(json, OauthNonce[].class);
    assertEquals("match count", count, records.length);
    final OauthNonceId id =
        new OauthNonceId(this.records[0].getConsumerId(), this.records[0].getNonce());
    OauthNonce testResult = jpa.find(OauthNonce.class, id);
