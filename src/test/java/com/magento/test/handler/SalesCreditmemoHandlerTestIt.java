...
import com.magento.test.dao.DefaultSalesCreditmemoDao;
...
public class SalesCreditmemoHandlerTestIt {
  static final String inputFile = "SalesCreditmemo.json";
  static SalesCreditmemoHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    SalesCreditmemo testResult = jpa.find(SalesCreditmemo.class, id);
    assertEquals(
    ...
    assertEquals(
        ...
        this.records[0].getBaseAdjustment(),
    ...
    assertEquals(
        "expect equals adjustment ", this.records[0].getAdjustment(), testResult.getAdjustment());
    assertEquals(
    ...
    org.junit.Assert.assertEquals(
        ...
        this.records[0].getCreditmemoStatus(),
        testResult.getCreditmemoStatus());
    org.junit.Assert.assertEquals(
