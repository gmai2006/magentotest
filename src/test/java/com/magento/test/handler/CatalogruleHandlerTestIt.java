...
import com.magento.test.dao.DefaultCatalogruleDao;
...
public class CatalogruleHandlerTestIt {
  static final String inputFile = "Catalogrule.json";
  static CatalogruleHandler handler;
  ...
  public void testSelect() throws IOException {
    ...
    Catalogrule testResult = jpa.find(Catalogrule.class, records[0].getRuleId());
