...
import com.magento.test.dao.DefaultAmazonCustomerDao;
...
public class AmazonCustomerHandlerTestIt {
  static final String inputFile = "AmazonCustomer.json";
  static AmazonCustomerHandler handler;
  ...
  static Gson gson =
      new GsonBuilder()
          ...
          .create();
  private AmazonCustomer[] records;
  ...
  public void testSelect() throws IOException {
    ...
    final AmazonCustomerId id =
        new AmazonCustomerId(
            ...
            this.records[0].getAmazonId());
    AmazonCustomer testResult = jpa.find(AmazonCustomer.class, id);
